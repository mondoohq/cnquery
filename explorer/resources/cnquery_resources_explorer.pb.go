...
func file_cnquery_resources_explorer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_cnquery_resources_explorer_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_cnquery_resources_explorer_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_cnquery_resources_explorer_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_cnquery_resources_explorer_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_cnquery_resources_explorer_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*ListResourcesRes); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
