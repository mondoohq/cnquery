...
type QueryConductor interface {
	...
	StoreResources(context.Context, *StoreResourcesReq) (*Empty, error)
...
func (c *QueryConductorClient) StoreResources(ctx context.Context, in *StoreResourcesReq) (*Empty, error) {
	out := new(Empty)
	err := c.DoClientRequest(ctx, c.httpclient, strings.Join([]string{c.prefix, "/StoreResources"}, ""), in, out)
	return out, err
}
...
func NewQueryConductorServer(handler QueryConductor, opts ...QueryConductorServerOption) http.Handler {
	...
	service := ranger.Service{
		...
		Methods: map[string]ranger.Method{
			...
			"StoreResources":    srv.StoreResources,
...
func (p *QueryConductorServer) StoreResources(ctx context.Context, reqBytes *[]byte) (pb.Message, error) {
	var req StoreResourcesReq
	var err error
	...
	return p.handler.StoreResources(ctx, &req)
}
