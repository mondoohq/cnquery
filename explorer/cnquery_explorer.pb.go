...
// Currently used for multiple scopes - policies and exceptions groups
type Action int32
...
const (
	...
	// Used for policies only
	Action_ACTIVATE Action = 3
	// Used for policies only
	Action_IGNORE Action = 4
	// Used for exception groups only
	Action_OUT_OF_SCOPE Action = 5
	// Used for exception groups only
	Action_FALSE_POSITIVE Action = 6
	// Used for exception groups only
	Action_WORKAROUND Action = 7
	// Used for exception groups only
	Action_RISK_ACCEPTED Action = 8
)
...
const file_cnquery_explorer_proto_rawDesc = "" +
	...
	"\x05value\x18\x01 \x01(\x05R\x05value*\x98\x01\n" +
	"\x06Action\x12\x0f\n" +
	...
	"\fOUT_OF_SCOPE\x10\x05\x12\x12\n" +
	"\x0eFALSE_POSITIVE\x10\x06\x12\x0e\n" +
	"\n" +
	"WORKAROUND\x10\a\x12\x11\n" +
	"\rRISK_ACCEPTED\x10\b*\x96\x01\n" +
