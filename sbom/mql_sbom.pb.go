...
func (Status) Descriptor() protoreflect.EnumDescriptor {
	return file_mql_sbom_proto_enumTypes[0].Descriptor()
}

func (Status) Type() protoreflect.EnumType {
	return &file_mql_sbom_proto_enumTypes[0]
}
...
func (Status) EnumDescriptor() ([]byte, []int) {
	return file_mql_sbom_proto_rawDescGZIP(), []int{0}
}
...
func (ExternalIDType) Descriptor() protoreflect.EnumDescriptor {
	return file_mql_sbom_proto_enumTypes[1].Descriptor()
}

func (ExternalIDType) Type() protoreflect.EnumType {
	return &file_mql_sbom_proto_enumTypes[1]
}
...
func (x *Sbom) Reset() {
	*x = Sbom{}
	mi := &file_mql_sbom_proto_msgTypes[0]
...
func (x *Package) GetInstallDate() string {
	if x != nil {
...
var File_mql_sbom_proto protoreflect.FileDescriptor
...
var (
	file_mql_sbom_proto_rawDescOnce sync.Once
	file_mql_sbom_proto_rawDescData []byte
)

func file_mql_sbom_proto_rawDescGZIP() []byte {
	file_mql_sbom_proto_rawDescOnce.Do(func() {
		file_mql_sbom_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mql_sbom_proto_rawDesc), len(file_mql_sbom_proto_rawDesc)))
	})
...
func file_mql_sbom_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_mql_sbom_proto_goTypes,
		DependencyIndexes: file_mql_sbom_proto_depIdxs,
		EnumInfos:         file_mql_sbom_proto_enumTypes,
		MessageInfos:      file_mql_sbom_proto_msgTypes,
	}.Build()
	File_mql_sbom_proto = out.File
	file_mql_sbom_proto_goTypes = nil
	file_mql_sbom_proto_depIdxs = nil
}
