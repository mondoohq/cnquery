...
func (*RunQueryConfig) Descriptor() ([]byte, []int) {
	return file_mql_proto_rawDescGZIP(), []int{0}
}
...
func (*Empty) Descriptor() ([]byte, []int) {
	return file_mql_proto_rawDescGZIP(), []int{1}
}
...
func (*String) Descriptor() ([]byte, []int) {
	return file_mql_proto_rawDescGZIP(), []int{2}
}
...
var File_mql_proto protoreflect.FileDescriptor
...
var (
	...
	file_mql_proto_rawDescData []byte
)

func file_mql_proto_rawDescGZIP() []byte {
	file_mql_proto_rawDescOnce.Do(func() {
		file_mql_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mql_proto_rawDesc), len(file_mql_proto_rawDesc)))
	})
	return file_mql_proto_rawDescData
}

var file_mql_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_mql_proto_goTypes = []any{
...
var file_mql_proto_depIdxs = []int32{
	3, // 0: proto.RunQueryConfig.inventory:type_name -> cnquery.providers.v1.Inventory
	0, // 1: proto.MqlQuery.RunQuery:input_type -> proto.RunQueryConfig
	2, // 2: proto.OutputHelper.Write:input_type -> proto.String
	1, // 3: proto.MqlQuery.RunQuery:output_type -> proto.Empty
...
func init() { file_mql_proto_init() }
func file_mql_proto_init() {
	if File_mql_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mql_proto_rawDesc), len(file_mql_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   2,
		},
		GoTypes:           file_mql_proto_goTypes,
		DependencyIndexes: file_mql_proto_depIdxs,
		MessageInfos:      file_mql_proto_msgTypes,
	}.Build()
	File_mql_proto = out.File
	file_mql_proto_goTypes = nil
	file_mql_proto_depIdxs = nil
}
