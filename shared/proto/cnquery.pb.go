...
func file_cnquery_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_cnquery_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_cnquery_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
		...
		file_cnquery_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*String); i {
			case 0:
				return &v.state
			case 1:
