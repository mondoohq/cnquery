...
Mondoo makes these [core AWS query packs](https://github.com/mondoohq/mql) available in GitHub:

- [Mondoo AWS Asset Inventory](https://github.com/mondoohq/mql/blob/main/content/mondoo-aws-inventory.mql.yaml) provides information about all your AWS assets and their configuration.
- [Mondoo AWS Incident Response](https://github.com/mondoohq/mql/blob/main/content/mondoo-aws-incident-response.mql.yaml) helps you investigate and minimize damage when a security incident occurs.

To run one of these purpose-built collections of AWS-specific queries:

1. In Mondoo's [cnquery GitHub repo](https://github.com/mondoohq/mql), go to the `content` directory and find the AWS query pack you want to run.
