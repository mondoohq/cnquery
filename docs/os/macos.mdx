...
Mondoo makes these [core macOS query packs](https://github.com/mondoohq/mql) available in GitHub:

- [macOS Inventory Pack](https://github.com/mondoohq/mql/blob/main/content/mondoo-macos-inventory.mql.yaml) provides information about all your macOS assets and their configuration.
- [macOS Incident Response Pack](https://github.com/mondoohq/mql/blob/main/content/mondoo-macos-incident-response.mql.yaml) helps you investigate and minimize damage when a security incident occurs.

To run one of these purpose-built collections of macOS-specific queries:

1. In Mondoo's [cnquery GitHub repo](https://github.com/mondoohq/mql), go to the `content` directory and find the macOS query pack you want to run.
