...
func (r *Resolver) Resolve(ctx context.Context, root *asset.Asset, pCfg *providers.Config, cfn common.CredentialFn, sfn common.QuerySecretFn, userIdDetectors ...providers.PlatformIdDetector) ([]*asset.Asset, error) {
	...
	ded, dockerEngErr := NewPodmanDiscovery()
...
func (k *Resolver) container(ctx context.Context, root *asset.Asset, pCfg *providers.Config, ded *podmanClient) (*asset.Asset, error) {
...
func (k *Resolver) images(ctx context.Context, root *asset.Asset, pCfg *providers.Config, ded *podmanClient, cfn common.CredentialFn, sfn common.QuerySecretFn) ([]*asset.Asset, error) {
