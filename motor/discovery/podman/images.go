...
func (e *podmanClient) imageList() ([]*entities.ImageSummary, error) {
	return images.List(e.conn, &images.ListOptions{})
}

func (e *podmanClient) ListImageShas() ([]string, error) {
...
func (e *podmanClient) ListImages() ([]*asset.Asset, error) {
