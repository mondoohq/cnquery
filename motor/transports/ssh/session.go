...
func sshClientConnection(hostconfig *motorapi.TransportConfig, hostKeyCallback ssh.HostKeyCallback) (*ssh.Client, error) {
...
func authMethods(endpoint *motorapi.TransportConfig) ([]ssh.AuthMethod, error) {
