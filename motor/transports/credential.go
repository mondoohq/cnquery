...
func NewPrivateKeyCredential(user string, pemBytes []byte) *Credential {
	return &Credential{
...
func NewPrivateKeyCredentialFromPath(user string, path string) (*Credential, error) {
	...
	return NewPrivateKeyCredential(user, pemBytes), nil
}
