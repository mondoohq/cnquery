...
func (fo *FileObservable) Type() transports.ObservableType {
	return transports.FileType
}
...
func NewFileRunnable(path string) func(m transports.Transport) (transports.Observable, error) {
