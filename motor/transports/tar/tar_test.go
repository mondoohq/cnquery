...
func TestTarCommand(t *testing.T) {
	...
	tarTransport, err := tar.New(&transports.Endpoint{Backend: "tar", Path: alpineContainerPath})
	assert.Equal(t, nil, err, "should create tar without error")
...
// 	tarTransport, err := tar.New(&transports.Endpoint{Backend: "tar", Path: filepath})
// 	assert.Equal(t, nil, err, "should create tar without error")
...
func TestFilePermissions(t *testing.T) {
	...
	trans, err := tar.New(&transports.Endpoint{Backend: "tar", Path: alpineContainerPath})
	require.NoError(t, err)
