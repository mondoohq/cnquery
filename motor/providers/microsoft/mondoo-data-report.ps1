...
# todo: totally need to parameterize that
$appId = "no"
$tenantId = "no"
$certText= "no"

$cert = New-Object System.Security.Cryptography.X509Certificates.X509Certificate2($certText)
Install-Module -Name ExchangeOnlineManagement -Scope CurrentUser -Force
Import-Module ExchangeOnlineManagement
Connect-ExchangeOnline -Certificate $cert -AppID $AppId -Organization "no" -ShowBanner:$false
