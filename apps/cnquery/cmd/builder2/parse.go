...
func ParseTargetAsset(cmd *cobra.Command, args []string, providerType providers.ProviderType, assetType common.AssetType) *asset.Asset {
	username := ""
	...
	case providers.ProviderType_LOCAL_OS:
		if assetType == common.UnknownAssetType {
			return nil
		} else {
	...
	case providers.ProviderType_TERRAFORM:
		...
		switch assetType {
		case common.TerraformHclAssetType:
			connection.Options["asset-type"] = "hcl"
		case common.TerraformPlanAssetType:
			connection.Options["asset-type"] = "plan"
		case common.TerraformStateAssetType:
	...
	case providers.ProviderType_CONTAINER_REGISTRY:
		switch assetType {
		case common.GcrContainerRegistryAssetType:
			url := args[0]
	...
	case providers.ProviderType_GCP:
		...
		case common.GcpOrganizationAssetType:
			connection.Options["organization-id"] = args[0]
		case common.GcpProjectAssetType:
			connection.Options["project-id"] = args[0]
		case common.GcpFolderAssetType:
	...
	case providers.ProviderType_GITHUB:
		switch assetType {
		case common.GithubOrganizationAssetType:
			connection.Backend = providerType
		...
		case common.GithubUserAssetType:
			connection.Backend = providerType
		...
		case common.GithubRepositoryAssetType:
			connection.Backend = providerType
