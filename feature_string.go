...
func _() {
	...
	_ = x[ResourceRecording-7]
}

const _Feature_name = "MassQueriesPiperCodeBoolAssertionsK8sNodeDiscoveryMQLAssetContextErrorsAsFailuresResourceRecording"

var _Feature_index = [...]uint8{0, 11, 20, 34, 50, 65, 81, 98}
