...
func (x *SendErrorReq) GetPlatform() *PlatformInfo {
	if x != nil {
		return x.Platform
	}
	return nil
...
func (x *PlatformInfo) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *PlatformInfo) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
func (x *PlatformInfo) GetRuntime() string {
	if x != nil {
		return x.Runtime
	}
	return ""
...
const file_errors_proto_rawDesc = "" +
	"\n" +
	"\ferrors.proto\x12\x13go.mondoo.health.v1\"\x8c\x02\n" +
	"\fSendErrorReq\x12.\n" +
	...
	"\x05error\x18\x04 \x01(\v2\x1e.go.mondoo.health.v1.ErrorInfoR\x05error\x12=\n" +
	"\bplatform\x18\x05 \x01(\v2!.go.mondoo.health.v1.PlatformInfoR\bplatform\"Q\n" +
	...
	"\aruntime\x18\x05 \x01(\tR\aruntime\"\x0f\n" +
	"\rSendErrorResp2d\n" +
...
var file_errors_proto_goTypes = []any{
	...
	(*PlatformInfo)(nil),  // 3: go.mondoo.health.v1.PlatformInfo
	(*SendErrorResp)(nil), // 4: go.mondoo.health.v1.SendErrorResp
}
var file_errors_proto_depIdxs = []int32{
	...
	3, // 2: go.mondoo.health.v1.SendErrorReq.platform:type_name -> go.mondoo.health.v1.PlatformInfo
	0, // 3: go.mondoo.health.v1.ErrorReporting.SendError:input_type -> go.mondoo.health.v1.SendErrorReq
	4, // 4: go.mondoo.health.v1.ErrorReporting.SendError:output_type -> go.mondoo.health.v1.SendErrorResp
