...
type EndOfLifeRelease struct {
	...
	EndOfActiveSupport *timestamp.Timestamp `protobuf:"bytes,8,opt,name=end_of_active_support,json=endOfActiveSupport,proto3" json:"end_of_active_support,omitempty"`
	// End Of Life
	EndOfLife *timestamp.Timestamp `protobuf:"bytes,9,opt,name=end_of_life,json=endOfLife,proto3" json:"end_of_life,omitempty"`
	// End Of Extended Support
	EndOfExtendedSupport *timestamp.Timestamp `protobuf:"bytes,10,opt,name=end_of_extended_support,json=endOfExtendedSupport,proto3" json:"end_of_extended_support,omitempty"`
...
func (x *EndOfLifeRelease) GetFirstReleaseDate() *timestamp.Timestamp {
	if x != nil {
...
func (x *EndOfLifeRelease) GetLastReleaseDate() *timestamp.Timestamp {
	if x != nil {
...
func (x *EndOfLifeRelease) GetEndOfActiveSupport() *timestamp.Timestamp {
	if x != nil {
...
func (x *EndOfLifeRelease) GetEndOfLife() *timestamp.Timestamp {
	if x != nil {
		return x.EndOfLife
	}
	return nil
...
func (x *EndOfLifeRelease) GetEndOfExtendedSupport() *timestamp.Timestamp {
	if x != nil {
