...
func TestManagerAmzn1(t *testing.T) {
	...
	mock, err := mock.NewFromToml(&motorapi.TransportConfig{Backend: motorapi.TransportBackend_CONNECTION_MOCK, Path: "./testdata/amzn1.toml"})
	require.NoError(t, err)
	m, err := motor.New(mock)
	require.NoError(t, err)
...
func TestManagerCentos6(t *testing.T) {
	// tests fallback to upstart service
	mock, err := mock.NewFromToml(&motorapi.TransportConfig{Backend: motorapi.TransportBackend_CONNECTION_MOCK, Path: "./testdata/centos6.toml"})
	require.NoError(t, err)
	m, err := motor.New(mock)
	require.NoError(t, err)
...
func TestManagerOpensuse13(t *testing.T) {
	// tests fallback to upstart service
	mock, err := mock.NewFromToml(&motorapi.TransportConfig{Backend: motorapi.TransportBackend_CONNECTION_MOCK, Path: "./testdata/opensuse13.toml"})
	require.NoError(t, err)
	m, err := motor.New(mock)
	require.NoError(t, err)
...
func TestManagerDragonflybsd5(t *testing.T) {
	mock, err := mock.NewFromToml(&motorapi.TransportConfig{Backend: motorapi.TransportBackend_CONNECTION_MOCK, Path: "./testdata/dragonfly5.toml"})
	require.NoError(t, err)
	m, err := motor.New(mock)
	require.NoError(t, err)
...
func TestManagerOpenBsd6(t *testing.T) {
	mock, err := mock.NewFromToml(&motorapi.TransportConfig{Backend: motorapi.TransportBackend_CONNECTION_MOCK, Path: "./testdata/openbsd6.toml"})
	require.NoError(t, err)
	m, err := motor.New(mock)
	require.NoError(t, err)
...
func TestManagerWindows(t *testing.T) {
	mock, err := mock.NewFromToml(&motorapi.TransportConfig{Backend: motorapi.TransportBackend_CONNECTION_MOCK, Path: "./testdata/windows2019.toml"})
	require.NoError(t, err)
	m, err := motor.New(mock)
	require.NoError(t, err)
