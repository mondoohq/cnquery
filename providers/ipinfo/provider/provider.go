...
import (
	...
	"go.mondoo.com/cnquery/v12/providers/ipinfo/resources"
)
...
func (s *Service) connect(req *plugin.ConnectReq, callback plugin.ProviderCallback) (*connection.IpinfoConnection, error) {
	...
	runtime, err := s.AddRuntime(conf, func(connId uint32) (*plugin.Runtime, error) {
		var conn *connection.IpinfoConnection
		var err error

		switch conf.Type {
		default:
			conn, err = connection.NewIpinfoConnection(connId, asset, conf)
		}
		if err != nil {
			return nil, err
		}
	...
	return runtime.Connection.(*connection.IpinfoConnection), nil
}
