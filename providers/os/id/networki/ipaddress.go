...
// NewIPv6WithPrefixLenght generates a new IPAddress using the IP address
// and prefix lenght. It calculates the subnet, CIDR and broadcast address.
func NewIPv6WithPrefixLenght(ip string, prefixLength int) IPAddress {
...
func broadcastAddressFrom(cidr string) string {
	...
	// Check if the IP address is v6, if so, they don't have broadcast
...
// calculateSubnetFromIPv6AndPrefixLength calculates the subnet network address from an IPv6 address and prefix length
