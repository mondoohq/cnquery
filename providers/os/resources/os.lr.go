...
const (
	...
	MondooEolName string = "mondoo.eol"
	PlatformEolName string = "platform.eol"
	...
	PlatformAdvisoriesName string = "platform.advisories"
	PlatformCvesName string = "platform.cves"
	AuditCvssName string = "audit.cvss"
	AuditAdvisoryName string = "audit.advisory"
	AuditCveName string = "audit.cve"
	MachineName string = "machine"
	MachineBiosName string = "machine.bios"
	MachineSystemName string = "machine.system"
	MachineBaseboardName string = "machine.baseboard"
	MachineChassisName string = "machine.chassis"
	OsName string = "os"
	OsUpdateName string = "os.update"
	OsBaseName string = "os.base"
	OsUnixName string = "os.unix"
	OsLinuxName string = "os.linux"
	OsRootCertificatesName string = "os.rootCertificates"
	CommandName string = "command"
	PowershellName string = "powershell"
	FileName string = "file"
	FileContextName string = "file.context"
	FilePermissionsName string = "file.permissions"
	FilesName string = "files"
	FilesFindName string = "files.find"
	ParseIniName string = "parse.ini"
	ParseJsonName string = "parse.json"
	ParseXmlName string = "parse.xml"
	ParsePlistName string = "parse.plist"
	ParseYamlName string = "parse.yaml"
	ParseCertificatesName string = "parse.certificates"
	ParseOpenpgpName string = "parse.openpgp"
	UserName string = "user"
	PrivatekeyName string = "privatekey"
	UsersName string = "users"
	AuthorizedkeysName string = "authorizedkeys"
	AuthorizedkeysEntryName string = "authorizedkeys.entry"
	GroupName string = "group"
	GroupsName string = "groups"
	PackageName string = "package"
	PkgFileInfoName string = "pkgFileInfo"
	PackagesName string = "packages"
	PamConfName string = "pam.conf"
	PamConfServiceEntryName string = "pam.conf.serviceEntry"
	SshdName string = "sshd"
	SshdConfigName string = "sshd.config"
	SshdConfigMatchBlockName string = "sshd.config.matchBlock"
	AuditdConfigName string = "auditd.config"
	AuditdRulesName string = "auditd.rules"
	AuditdRuleName string = "auditd.rule"
	AuditdRuleControlName string = "auditd.rule.control"
	AuditdRuleFileName string = "auditd.rule.file"
	AuditdRuleSyscallName string = "auditd.rule.syscall"
	ServiceName string = "service"
	ServicesName string = "services"
	KernelName string = "kernel"
	KernelModuleName string = "kernel.module"
	DockerName string = "docker"
	DockerFileName string = "docker.file"
	DockerFileStageName string = "docker.file.stage"
	DockerFileUserName string = "docker.file.user"
	DockerFileExposeName string = "docker.file.expose"
	DockerFileFromName string = "docker.file.from"
	DockerFileRunName string = "docker.file.run"
	DockerFileAddName string = "docker.file.add"
	DockerFileCopyName string = "docker.file.copy"
	DockerImageName string = "docker.image"
	DockerContainerName string = "docker.container"
	IptablesName string = "iptables"
	Ip6tablesName string = "ip6tables"
	IptablesEntryName string = "iptables.entry"
	FstabName string = "fstab"
	FstabEntryName string = "fstab.entry"
	ProcessName string = "process"
	ProcessesName string = "processes"
	PortName string = "port"
	PortsName string = "ports"
	AuditpolName string = "auditpol"
	AuditpolEntryName string = "auditpol.entry"
	SecpolName string = "secpol"
	NtpConfName string = "ntp.conf"
	RsyslogConfName string = "rsyslog.conf"
	LogindefsName string = "logindefs"
	LsblkName string = "lsblk"
	LsblkEntryName string = "lsblk.entry"
	MountName string = "mount"
	MountPointName string = "mount.point"
	ShadowName string = "shadow"
	ShadowEntryName string = "shadow.entry"
	YumName string = "yum"
	YumRepoName string = "yum.repo"
	RegistrykeyName string = "registrykey"
	RegistrykeyPropertyName string = "registrykey.property"
	ContainerImageName string = "container.image"
	ContainerRepositoryName string = "container.repository"
	KubeletName string = "kubelet"
	PythonName string = "python"
	PythonPackageName string = "python.package"
	NpmPackagesName string = "npm.packages"
	NpmPackageName string = "npm.package"
	MacosName string = "macos"
	MacosAlfName string = "macos.alf"
	MacosTimemachineName string = "macos.timemachine"
	MacosSystemsetupName string = "macos.systemsetup"
	WindowsName string = "windows"
	MacosSystemExtensionName string = "macos.systemExtension"
	WindowsHotfixName string = "windows.hotfix"
	WindowsFeatureName string = "windows.feature"
	WindowsServerFeatureName string = "windows.serverFeature"
	WindowsOptionalFeatureName string = "windows.optionalFeature"
	WindowsFirewallName string = "windows.firewall"
	WindowsFirewallProfileName string = "windows.firewall.profile"
	WindowsFirewallRuleName string = "windows.firewall.rule"
	WindowsBitlockerName string = "windows.bitlocker"
	WindowsBitlockerVolumeName string = "windows.bitlocker.volume"
	WindowsSecurityName string = "windows.security"
	WindowsSecurityProductName string = "windows.security.product"
	WindowsSecurityHealthName string = "windows.security.health"
	CloudName string = "cloud"
	CloudInstanceName string = "cloudInstance"
	IpAddressName string = "ipAddress"
	NetworkName string = "network"
	NetworkInterfaceName string = "networkInterface"
	UsbName string = "usb"
	UsbDeviceName string = "usb.device"
)
