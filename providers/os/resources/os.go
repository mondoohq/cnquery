...
import (
	...
	"go.mondoo.com/mql/providers/os/resources/reboot"
...
func (s *mqlOsLinux) nftables() (*mqlNftables, error) {
	res, err := CreateResource(s.MqlRuntime, "nftables", map[string]*llx.RawData{})
	if err != nil {
		return nil, err
	}
