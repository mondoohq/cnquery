...
func TestLinuxStatCmd(t *testing.T) {
	...
	// modification time (%Y = 1590418792), not access time (%X = 1590420240)
...
func TestOpenbsdStatCmd(t *testing.T) {
	...
	// modification time (%m = 1591446696), not access time (%a = 1592996018)
	assert.Equal(t, time.Unix(1591446696, 0), fi.ModTime())
