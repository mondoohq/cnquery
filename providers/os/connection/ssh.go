...
import (
	...
	"go.mondoo.com/cnquery/v9/providers/os/connection/ssh/awsinstanceconnect"
	"go.mondoo.com/cnquery/v9/providers/os/connection/ssh/awsssmsession"
	"go.mondoo.com/cnquery/v9/providers/os/connection/ssh/cat"
	"go.mondoo.com/cnquery/v9/providers/os/connection/ssh/scp"
	"go.mondoo.com/cnquery/v9/providers/os/connection/ssh/sftp"
	"go.mondoo.com/cnquery/v9/providers/os/connection/ssh/signers"
