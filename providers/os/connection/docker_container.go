...
import (
	...
	"go.mondoo.com/cnquery/providers/os/connection/container/docker_engine"
	...
	docker_discovery "go.mondoo.com/cnquery/providers/os/resources/discovery/docker_engine"
)
