...
func (u *mqlEolProduct) id() (string, error) {
	return "eol.product:" + u.Name.Data + "/" + u.Version.Data, nil
}

func (m *mqlEolProduct) release() (*mqlEolProductRelease, error) {
	...
	res, err := runtime.CreateResource(runtime, "eol.productRelease", map[string]*llx.RawData{
	...
	return res.(*mqlEolProductRelease), nil
}
