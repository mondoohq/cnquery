...
// Discover returns the assets reachable through this Bitwarden connection.
// The MVP models a single asset per organization (the connected
// organization itself), so there are no child assets to enumerate.
