module go.mondoo.com/mql/providers/claude
...
require (
	github.com/anthropics/anthropic-sdk-go v1.71.0 // pinned: v1.71.0 removes BetaUserProfile.Relationship, which backs claude.userProfile.relationship
