...
const (
	MicrosoftName string = "microsoft"
	MicrosoftIdentityAndAccessAccessReviewsName string = "microsoft.identityAndAccess.accessReviews"
	MicrosoftIdentityAndAccessAccessReviewDefinitionName string = "microsoft.identityAndAccess.accessReviewDefinition"
	MicrosoftIdentityAndAccessAccessReviewDefinitionAccessReviewScheduleSettingsName string = "microsoft.identityAndAccess.accessReviewDefinition.accessReviewScheduleSettings"
	MicrosoftGroupsName string = "microsoft.groups"
	MicrosoftApplicationsName string = "microsoft.applications"
	MicrosoftTenantName string = "microsoft.tenant"
	MicrosoftTenantSettingsName string = "microsoft.tenantSettings"
	MicrosoftTenantFormsSettingsName string = "microsoft.tenantFormsSettings"
	MicrosoftUsersName string = "microsoft.users"
	MicrosoftIdentityAndAccessName string = "microsoft.identityAndAccess"
	MicrosoftIdentityAndAccessRoleEligibilityScheduleInstanceName string = "microsoft.identityAndAccess.roleEligibilityScheduleInstance"
	MicrosoftIdentityAndAccessPolicyName string = "microsoft.identityAndAccess.policy"
	MicrosoftIdentityAndAccessPolicyRuleName string = "microsoft.identityAndAccess.policy.rule"
	MicrosoftIdentityAndAccessPolicyRuleTargetName string = "microsoft.identityAndAccess.policy.ruleTarget"
	MicrosoftIdentityAndAccessIdentityAndSignInName string = "microsoft.identityAndAccess.identityAndSignIn"
	MicrosoftIdentityAndAccessIdentityAndSignInPoliciesName string = "microsoft.identityAndAccess.identityAndSignIn.policies"
	MicrosoftIdentityAndAccessIdentityAndSignInPoliciesIdentitySecurityDefaultsEnforcementPolicyName string = "microsoft.identityAndAccess.identityAndSignIn.policies.identitySecurityDefaultsEnforcementPolicy"
	MicrosoftUserAssignedLicenseName string = "microsoft.user.assignedLicense"
	MicrosoftUserLicenseDetailName string = "microsoft.user.licenseDetail"
	MicrosoftUserLicenseDetailServicePlanInfoName string = "microsoft.user.licenseDetail.servicePlanInfo"
	MicrosoftConditionalAccessName string = "microsoft.conditionalAccess"
	MicrosoftConditionalAccessAuthenticationMethodsPolicyName string = "microsoft.conditionalAccess.authenticationMethodsPolicy"
	MicrosoftConditionalAccessAuthenticationMethodConfigurationName string = "microsoft.conditionalAccess.authenticationMethodConfiguration"
	MicrosoftConditionalAccessNamedLocationsName string = "microsoft.conditionalAccess.namedLocations"
	MicrosoftConditionalAccessPolicyName string = "microsoft.conditionalAccess.policy"
	MicrosoftConditionalAccessPolicyConditionsName string = "microsoft.conditionalAccess.policy.conditions"
	MicrosoftConditionalAccessPolicyConditionsAuthenticationFlowsName string = "microsoft.conditionalAccess.policy.conditions.authenticationFlows"
	MicrosoftConditionalAccessPolicyGrantControlsAuthenticationStrengthName string = "microsoft.conditionalAccess.policy.grantControls.authenticationStrength"
	MicrosoftConditionalAccessPolicySessionControlsSignInFrequencyName string = "microsoft.conditionalAccess.policy.sessionControls.signInFrequency"
	MicrosoftConditionalAccessPolicySessionControlsCloudAppSecurityName string = "microsoft.conditionalAccess.policy.sessionControls.cloudAppSecurity"
	MicrosoftConditionalAccessPolicySessionControlsPersistentBrowserName string = "microsoft.conditionalAccess.policy.sessionControls.persistentBrowser"
	MicrosoftConditionalAccessPolicySessionControlsApplicationEnforcedRestrictionsName string = "microsoft.conditionalAccess.policy.sessionControls.applicationEnforcedRestrictions"
	MicrosoftConditionalAccessPolicyConditionsClientApplicationsName string = "microsoft.conditionalAccess.policy.conditions.clientApplications"
	MicrosoftConditionalAccessPolicyConditionsPlatformsName string = "microsoft.conditionalAccess.policy.conditions.platforms"
	MicrosoftConditionalAccessPolicyConditionsApplicationsName string = "microsoft.conditionalAccess.policy.conditions.applications"
	MicrosoftConditionalAccessPolicyConditionsUsersName string = "microsoft.conditionalAccess.policy.conditions.users"
	MicrosoftConditionalAccessPolicyConditionsLocationsName string = "microsoft.conditionalAccess.policy.conditions.locations"
	MicrosoftConditionalAccessPolicyGrantControlsName string = "microsoft.conditionalAccess.policy.grantControls"
	MicrosoftConditionalAccessPolicySessionControlsName string = "microsoft.conditionalAccess.policy.sessionControls"
	MicrosoftConditionalAccessIpNamedLocationName string = "microsoft.conditionalAccess.ipNamedLocation"
	MicrosoftConditionalAccessCountryNamedLocationName string = "microsoft.conditionalAccess.countryNamedLocation"
	MicrosoftUserName string = "microsoft.user"
	MicrosoftUserAuthenticationRequirementsName string = "microsoft.user.authenticationRequirements"
	MicrosoftUserAuditlogName string = "microsoft.user.auditlog"
	MicrosoftUserIdentityName string = "microsoft.user.identity"
	MicrosoftUserSigninName string = "microsoft.user.signin"
	MicrosoftUserAuthenticationMethodsName string = "microsoft.user.authenticationMethods"
	MicrosoftUserAuthenticationMethodsUserRegistrationDetailsName string = "microsoft.user.authenticationMethods.userRegistrationDetails"
	MicrosoftGroupName string = "microsoft.group"
	MicrosoftGroupLifecyclePolicyName string = "microsoft.groupLifecyclePolicy"
	MicrosoftDevicesName string = "microsoft.devices"
	MicrosoftDeviceName string = "microsoft.device"
	MicrosoftDomainName string = "microsoft.domain"
	MicrosoftDomaindnsrecordName string = "microsoft.domaindnsrecord"
	MicrosoftApplicationName string = "microsoft.application"
	MicrosoftApplicationRoleName string = "microsoft.application.role"
	MicrosoftKeyCredentialName string = "microsoft.keyCredential"
	MicrosoftPasswordCredentialName string = "microsoft.passwordCredential"
	MicrosoftServiceprincipalName string = "microsoft.serviceprincipal"
	MicrosoftServiceprincipalAssignmentName string = "microsoft.serviceprincipal.assignment"
	MicrosoftApplicationPermissionName string = "microsoft.application.permission"
	MicrosoftSecurityName string = "microsoft.security"
	MicrosoftSecuritySecurityscoreName string = "microsoft.security.securityscore"
	MicrosoftSecurityRiskyUserName string = "microsoft.security.riskyUser"
	MicrosoftSecurityExchangeName string = "microsoft.security.exchange"
	MicrosoftSecurityExchangeAntispamName string = "microsoft.security.exchange.antispam"
	MicrosoftSecurityExchangeAntispamHostedConnectionFilterPolicyName string = "microsoft.security.exchange.antispam.hostedConnectionFilterPolicy"
	MicrosoftPoliciesName string = "microsoft.policies"
	MicrosoftPoliciesExternalIdentitiesPolicyName string = "microsoft.policies.externalIdentitiesPolicy"
	MicrosoftPoliciesActivityBasedTimeoutPolicyName string = "microsoft.policies.activityBasedTimeoutPolicy"
	MicrosoftAdminConsentRequestPolicyName string = "microsoft.adminConsentRequestPolicy"
	MicrosoftGraphAccessReviewReviewerScopeName string = "microsoft.graph.accessReviewReviewerScope"
	MicrosoftPoliciesAuthenticationMethodsPolicyName string = "microsoft.policies.authenticationMethodsPolicy"
	MicrosoftPoliciesAuthenticationMethodConfigurationName string = "microsoft.policies.authenticationMethodConfiguration"
	MicrosoftRolesName string = "microsoft.roles"
	MicrosoftRolemanagementName string = "microsoft.rolemanagement"
	MicrosoftRolemanagementRoledefinitionName string = "microsoft.rolemanagement.roledefinition"
	MicrosoftRolemanagementRoleassignmentName string = "microsoft.rolemanagement.roleassignment"
	MicrosoftDevicemanagementName string = "microsoft.devicemanagement"
	MicrosoftDevicemanagementDeviceEnrollmentConfigurationName string = "microsoft.devicemanagement.deviceEnrollmentConfiguration"
	MicrosoftDevicemanagementManageddeviceName string = "microsoft.devicemanagement.manageddevice"
	MicrosoftDevicemanagementDeviceconfigurationName string = "microsoft.devicemanagement.deviceconfiguration"
	MicrosoftDevicemanagementDevicecompliancepolicyName string = "microsoft.devicemanagement.devicecompliancepolicy"
	Ms365ExchangeonlineName string = "ms365.exchangeonline"
	Ms365ExchangeonlineMailboxAuditBypassAssociationName string = "ms365.exchangeonlineMailboxAuditBypassAssociation"
	Ms365ExchangeonlineSecurityAndComplianceName string = "ms365.exchangeonline.securityAndCompliance"
	Ms365ExchangeonlineTeamsProtectionPolicyName string = "ms365.exchangeonline.teamsProtectionPolicy"
	Ms365ExchangeonlineReportSubmissionPolicyName string = "ms365.exchangeonline.reportSubmissionPolicy"
	Ms365ExchangeonlineExternalSenderName string = "ms365.exchangeonline.externalSender"
	Ms365ExchangeonlineExoMailboxName string = "ms365.exchangeonline.exoMailbox"
	Ms365ExchangeonlineMailboxName string = "ms365.exchangeonline.mailbox"
	Ms365SharepointonlineName string = "ms365.sharepointonline"
	Ms365SharepointonlineSiteName string = "ms365.sharepointonline.site"
	Ms365TeamsName string = "ms365.teams"
	Ms365TeamsTenantFederationConfigName string = "ms365.teams.tenantFederationConfig"
	Ms365TeamsTeamsMeetingPolicyConfigName string = "ms365.teams.teamsMeetingPolicyConfig"
	Ms365TeamsTeamsMessagingPolicyConfigName string = "ms365.teams.teamsMessagingPolicyConfig"
)
