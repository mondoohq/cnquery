...
func (g *mqlGcpProjectBigtableService) instances() ([]any, error) {
	...
	creds, err := conn.Credentials("https://www.googleapis.com/auth/bigtable.admin", "https://www.googleapis.com/auth/bigtable.admin.cluster", "https://www.googleapis.com/auth/bigtable.admin.instance", "https://www.googleapis.com/auth/cloud-platform", "https://www.googleapis.com/auth/cloud-platform.read-only")
	if err != nil {
		return nil, err
	}
...
func (g *mqlGcpProjectBigtableServiceInstance) clusters() ([]any, error) {
	...
	conn := g.MqlRuntime.Connection.(*connection.GcpConnection)
	creds, err := conn.Credentials("https://www.googleapis.com/auth/bigtable.admin", "https://www.googleapis.com/auth/cloud-platform")
	if err != nil {
		return nil, err
	}
