...
// NewAcrInstancePlatform returns the platform for a discovered Container
// Registry instance asset.
func NewAcrInstancePlatform(instanceID string) *inventory.Platform {
	return newPlatform("alicloud-acr-instance", "",
