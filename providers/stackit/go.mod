...
require (
	...
	github.com/stackitcloud/stackit-sdk-go/services/serviceaccount v0.21.0 // pinned: v0.21.0 removes ListAccessTokens, which backs stackit.serviceAccount.accessTokens
