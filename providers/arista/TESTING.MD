...
|---|---|---|
| CloudEOS Router (BYOL) | `3gruvlcso4s66wfg2mdzxg8z6` | needs a license from Arista sales; the AMI *is* publicly listed |
| CloudEOS Router (PAYG) | `8xzz74jx7agumduhohu7zful3` | hourly software charge, no license needed |
