				...
				for _, dcConn := range resp.Connections {
					mqlDcConn, err := CreateResource(a.MqlRuntime, ResourceAwsDirectconnectConnection,
						map[string]*llx.RawData{
							...
							"prefixPoolSizeIpv4":             llx.IntDataPtr(dcConn.PrefixPoolSizeIpv4),
							"prefixPoolSizeIpv6":             llx.IntDataPtr(dcConn.PrefixPoolSizeIpv6),
							"prefixPoolUnallocatedCountIpv4": llx.IntDataPtr(dcConn.PrefixPoolUnallocatedCountIpv4),
							"prefixPoolUnallocatedCountIpv6": llx.IntDataPtr(dcConn.PrefixPoolUnallocatedCountIpv6),
...
func newMqlAwsDirectconnectVirtualInterface(runtime *plugin.Runtime, region string, vif dctypes.VirtualInterface) (plugin.Resource, error) {
	...
	mqlVif, err := CreateResource(runtime, ResourceAwsDirectconnectVirtualInterface,
		map[string]*llx.RawData{
			...
			"prefixPoolAllocatedCountIpv4": llx.IntDataPtr(vif.PrefixPoolAllocatedCountIpv4),
			"prefixPoolAllocatedCountIpv6": llx.IntDataPtr(vif.PrefixPoolAllocatedCountIpv6),
