...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("azure.network.watcher.flowlog", newAzureNetworkWatcherFlowlog)
	registry.AddFactory("azure.network.watcher.flowlog.retentionpolicy", newAzureNetworkWatcherFlowlogRetentionpolicy)
	registry.AddFactory("azure.network.watcher.flowlog.analytics", newAzureNetworkWatcherFlowlogAnalytics)
	...
	registry.AddFactory("azure.monitor.activitylog", newAzureMonitorActivitylog)
	registry.AddFactory("azure.monitor.activitylog.alert", newAzureMonitorActivitylogAlert)
	registry.AddFactory("azure.monitor.activitylog.alert.condition", newAzureMonitorActivitylogAlertCondition)
	registry.AddFactory("azure.monitor.activitylog.alert.action", newAzureMonitorActivitylogAlertAction)
...
func newAzureNetworkWatcher(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "flowLogs":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher\", its \"flowLogs\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
func (s *mqlAzureNetworkWatcher) FlowLogs() ([]interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("flowLogs")
		if !ok {
			return nil, errors.New("\"azure.network.watcher\" calculated \"flowLogs\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.network.watcher\" failed to cast field \"flowLogs\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}
...
func (s *mqlAzureNetworkWatcher) ComputeFlowLogs() error {
	var err error
...
// AzureNetworkWatcherFlowlog resource interface
type AzureNetworkWatcherFlowlog interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
	...
	Version() (int64, error)
	Format() (string, error)
	RetentionPolicy() (AzureNetworkWatcherFlowlogRetentionpolicy, error)
	Analytics() (AzureNetworkWatcherFlowlogAnalytics, error)
}

// mqlAzureNetworkWatcherFlowlog for the azure.network.watcher.flowlog resource
type mqlAzureNetworkWatcherFlowlog struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureNetworkWatcherFlowlog) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.network.watcher.flowlog resource
func newAzureNetworkWatcherFlowlog(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureNetworkWatcherFlowlog{runtime.NewResource("azure.network.watcher.flowlog")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "location":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"location\" argument has the wrong type (expected type \"string\")")
			}
		case "tags":
			if _, ok := val.(map[string]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"tags\" argument has the wrong type (expected type \"map[string]interface{}\")")
			}
		case "type":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"type\" argument has the wrong type (expected type \"string\")")
			}
		case "etag":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"etag\" argument has the wrong type (expected type \"string\")")
			}
		case "provisioningState":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"provisioningState\" argument has the wrong type (expected type \"string\")")
			}
		case "enabled":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"enabled\" argument has the wrong type (expected type \"bool\")")
			}
		case "storageAccountId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"storageAccountId\" argument has the wrong type (expected type \"string\")")
			}
		case "targetResourceId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"targetResourceId\" argument has the wrong type (expected type \"string\")")
			}
		case "targetResourceGuid":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"targetResourceGuid\" argument has the wrong type (expected type \"string\")")
			}
		case "version":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"version\" argument has the wrong type (expected type \"int64\")")
			}
		case "format":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"format\" argument has the wrong type (expected type \"string\")")
			}
		case "retentionPolicy":
			if _, ok := val.(AzureNetworkWatcherFlowlogRetentionpolicy); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"retentionPolicy\" argument has the wrong type (expected type \"AzureNetworkWatcherFlowlogRetentionpolicy\")")
			}
		case "analytics":
			if _, ok := val.(AzureNetworkWatcherFlowlogAnalytics); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"analytics\" argument has the wrong type (expected type \"AzureNetworkWatcherFlowlogAnalytics\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.network.watcher.flowlog with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureNetworkWatcherFlowlog) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("location"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"location\". This field is required.")
	}
	if _, ok := s.Cache.Load("tags"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"tags\". This field is required.")
	}
	if _, ok := s.Cache.Load("type"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"type\". This field is required.")
	}
	if _, ok := s.Cache.Load("etag"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"etag\". This field is required.")
	}
	if _, ok := s.Cache.Load("provisioningState"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"provisioningState\". This field is required.")
	}
	if _, ok := s.Cache.Load("enabled"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"enabled\". This field is required.")
	}
	if _, ok := s.Cache.Load("storageAccountId"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"storageAccountId\". This field is required.")
	}
	if _, ok := s.Cache.Load("targetResourceId"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"targetResourceId\". This field is required.")
	}
	if _, ok := s.Cache.Load("targetResourceGuid"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"targetResourceGuid\". This field is required.")
	}
	if _, ok := s.Cache.Load("version"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"version\". This field is required.")
	}
	if _, ok := s.Cache.Load("format"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"format\". This field is required.")
	}
	if _, ok := s.Cache.Load("retentionPolicy"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"retentionPolicy\". This field is required.")
	}
	if _, ok := s.Cache.Load("analytics"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog\" resource without a \"analytics\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.network.watcher.flowlog].Register")
	switch name {
	case "id":
		return nil
	case "name":
	...
	case "analytics":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.network.watcher.flowlog\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.network.watcher.flowlog].Field")
	switch name {
	case "id":
		return s.Id()
	case "name":
	...
	case "analytics":
		return s.Analytics()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.network.watcher.flowlog\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Location accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Location() (string, error) {
	res, ok := s.Cache.Load("location")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"location\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"location\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Tags accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Tags() (map[string]interface{}, error) {
	res, ok := s.Cache.Load("tags")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"tags\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(map[string]interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"tags\" to the right type (map[string]interface{}): %#v", res)
	}
	return tres, nil
}

// Type accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Type() (string, error) {
	res, ok := s.Cache.Load("type")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"type\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"type\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Etag accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Etag() (string, error) {
	res, ok := s.Cache.Load("etag")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"etag\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"etag\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ProvisioningState accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) ProvisioningState() (string, error) {
	res, ok := s.Cache.Load("provisioningState")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"provisioningState\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"provisioningState\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Enabled accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Enabled() (bool, error) {
	res, ok := s.Cache.Load("enabled")
	if !ok || !res.Valid {
		return false, errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"enabled\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"enabled\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// StorageAccountId accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) StorageAccountId() (string, error) {
	res, ok := s.Cache.Load("storageAccountId")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"storageAccountId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"storageAccountId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// TargetResourceId accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) TargetResourceId() (string, error) {
	res, ok := s.Cache.Load("targetResourceId")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"targetResourceId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"targetResourceId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// TargetResourceGuid accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) TargetResourceGuid() (string, error) {
	res, ok := s.Cache.Load("targetResourceGuid")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"targetResourceGuid\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"targetResourceGuid\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Version accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Version() (int64, error) {
	res, ok := s.Cache.Load("version")
	if !ok || !res.Valid {
		return 0, errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"version\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	...
	if !ok {
		return 0, fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"version\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// Format accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Format() (string, error) {
	res, ok := s.Cache.Load("format")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"format\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"format\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// RetentionPolicy accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) RetentionPolicy() (AzureNetworkWatcherFlowlogRetentionpolicy, error) {
	res, ok := s.Cache.Load("retentionPolicy")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"retentionPolicy\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(AzureNetworkWatcherFlowlogRetentionpolicy)
	if !ok {
		return nil, fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"retentionPolicy\" to the right type (AzureNetworkWatcherFlowlogRetentionpolicy): %#v", res)
	}
	return tres, nil
}

// Analytics accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Analytics() (AzureNetworkWatcherFlowlogAnalytics, error) {
	res, ok := s.Cache.Load("analytics")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.network.watcher.flowlog\" failed: no value provided for static field \"analytics\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(AzureNetworkWatcherFlowlogAnalytics)
	if !ok {
		return nil, fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"analytics\" to the right type (AzureNetworkWatcherFlowlogAnalytics): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.network.watcher.flowlog].Compute")
	switch name {
	case "id":
		return nil
	case "name":
...
// AzureNetworkWatcherFlowlogRetentionpolicy resource interface
type AzureNetworkWatcherFlowlogRetentionpolicy interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlAzureNetworkWatcherFlowlogRetentionpolicy for the azure.network.watcher.flowlog.retentionpolicy resource
type mqlAzureNetworkWatcherFlowlogRetentionpolicy struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureNetworkWatcherFlowlogRetentionpolicy) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.network.watcher.flowlog.retentionpolicy resource
func newAzureNetworkWatcherFlowlogRetentionpolicy(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureNetworkWatcherFlowlogRetentionpolicy{runtime.NewResource("azure.network.watcher.flowlog.retentionpolicy")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog.retentionpolicy\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "enabled":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog.retentionpolicy\", its \"enabled\" argument has the wrong type (expected type \"bool\")")
			}
		case "retentionDays":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog.retentionpolicy\", its \"retentionDays\" argument has the wrong type (expected type \"int64\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog.retentionpolicy\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.network.watcher.flowlog.retentionpolicy with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureNetworkWatcherFlowlogRetentionpolicy) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog.retentionpolicy\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("enabled"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog.retentionpolicy\" resource without a \"enabled\". This field is required.")
	}
	if _, ok := s.Cache.Load("retentionDays"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog.retentionpolicy\" resource without a \"retentionDays\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogRetentionpolicy) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.network.watcher.flowlog.retentionpolicy].Register")
	switch name {
	case "id":
		return nil
	case "enabled":
	...
	case "retentionDays":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.network.watcher.flowlog.retentionpolicy\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogRetentionpolicy) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.network.watcher.flowlog.retentionpolicy].Field")
	switch name {
	case "id":
		return s.Id()
	case "enabled":
	...
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.network.watcher.flowlog.retentionpolicy\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogRetentionpolicy) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog.retentionpolicy\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog.retentionpolicy\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Enabled accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogRetentionpolicy) Enabled() (bool, error) {
	res, ok := s.Cache.Load("enabled")
	if !ok || !res.Valid {
		return false, errors.New("\"azure.network.watcher.flowlog.retentionpolicy\" failed: no value provided for static field \"enabled\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"azure.network.watcher.flowlog.retentionpolicy\" failed to cast field \"enabled\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// RetentionDays accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogRetentionpolicy) RetentionDays() (int64, error) {
	res, ok := s.Cache.Load("retentionDays")
	if !ok || !res.Valid {
		return 0, errors.New("\"azure.network.watcher.flowlog.retentionpolicy\" failed: no value provided for static field \"retentionDays\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"azure.network.watcher.flowlog.retentionpolicy\" failed to cast field \"retentionDays\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogRetentionpolicy) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.network.watcher.flowlog.retentionpolicy].Compute")
	switch name {
	case "id":
		return nil
	case "enabled":
...
// AzureNetworkWatcherFlowlogAnalytics resource interface
type AzureNetworkWatcherFlowlogAnalytics interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
	...
	Id() (string, error)
	Enabled() (bool, error)
	AnalyticsInterval() (int64, error)
	WorkspaceId() (string, error)
	WorkspaceRegion() (string, error)
	WorkspaceResourceId() (string, error)
}

// mqlAzureNetworkWatcherFlowlogAnalytics for the azure.network.watcher.flowlog.analytics resource
type mqlAzureNetworkWatcherFlowlogAnalytics struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureNetworkWatcherFlowlogAnalytics) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.network.watcher.flowlog.analytics resource
func newAzureNetworkWatcherFlowlogAnalytics(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureNetworkWatcherFlowlogAnalytics{runtime.NewResource("azure.network.watcher.flowlog.analytics")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog.analytics\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "enabled":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog.analytics\", its \"enabled\" argument has the wrong type (expected type \"bool\")")
			}
		case "analyticsInterval":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog.analytics\", its \"analyticsInterval\" argument has the wrong type (expected type \"int64\")")
			}
		case "workspaceId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog.analytics\", its \"workspaceId\" argument has the wrong type (expected type \"string\")")
			}
		case "workspaceRegion":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog.analytics\", its \"workspaceRegion\" argument has the wrong type (expected type \"string\")")
			}
		case "workspaceResourceId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog.analytics\", its \"workspaceResourceId\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog.analytics\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.network.watcher.flowlog.analytics with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureNetworkWatcherFlowlogAnalytics) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog.analytics\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("enabled"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog.analytics\" resource without a \"enabled\". This field is required.")
	}
	if _, ok := s.Cache.Load("analyticsInterval"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog.analytics\" resource without a \"analyticsInterval\". This field is required.")
	}
	if _, ok := s.Cache.Load("workspaceId"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog.analytics\" resource without a \"workspaceId\". This field is required.")
	}
	if _, ok := s.Cache.Load("workspaceRegion"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog.analytics\" resource without a \"workspaceRegion\". This field is required.")
	}
	if _, ok := s.Cache.Load("workspaceResourceId"); !ok {
		return errors.New("Initialized \"azure.network.watcher.flowlog.analytics\" resource without a \"workspaceResourceId\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogAnalytics) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.network.watcher.flowlog.analytics].Register")
	switch name {
	case "id":
		return nil
	case "enabled":
	...
	case "workspaceResourceId":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.network.watcher.flowlog.analytics\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogAnalytics) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.network.watcher.flowlog.analytics].Field")
	switch name {
	case "id":
		return s.Id()
	case "enabled":
		return s.Enabled()
	case "analyticsInterval":
		return s.AnalyticsInterval()
	case "workspaceId":
		return s.WorkspaceId()
	case "workspaceRegion":
		return s.WorkspaceRegion()
	case "workspaceResourceId":
		return s.WorkspaceResourceId()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.network.watcher.flowlog.analytics\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogAnalytics) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog.analytics\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog.analytics\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Enabled accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogAnalytics) Enabled() (bool, error) {
	res, ok := s.Cache.Load("enabled")
	if !ok || !res.Valid {
		return false, errors.New("\"azure.network.watcher.flowlog.analytics\" failed: no value provided for static field \"enabled\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"azure.network.watcher.flowlog.analytics\" failed to cast field \"enabled\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// AnalyticsInterval accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogAnalytics) AnalyticsInterval() (int64, error) {
	res, ok := s.Cache.Load("analyticsInterval")
	if !ok || !res.Valid {
		return 0, errors.New("\"azure.network.watcher.flowlog.analytics\" failed: no value provided for static field \"analyticsInterval\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"azure.network.watcher.flowlog.analytics\" failed to cast field \"analyticsInterval\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// WorkspaceId accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogAnalytics) WorkspaceId() (string, error) {
	res, ok := s.Cache.Load("workspaceId")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog.analytics\" failed: no value provided for static field \"workspaceId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog.analytics\" failed to cast field \"workspaceId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// WorkspaceRegion accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogAnalytics) WorkspaceRegion() (string, error) {
	res, ok := s.Cache.Load("workspaceRegion")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog.analytics\" failed: no value provided for static field \"workspaceRegion\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog.analytics\" failed to cast field \"workspaceRegion\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// WorkspaceResourceId accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogAnalytics) WorkspaceResourceId() (string, error) {
	res, ok := s.Cache.Load("workspaceResourceId")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher.flowlog.analytics\" failed: no value provided for static field \"workspaceResourceId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher.flowlog.analytics\" failed to cast field \"workspaceResourceId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlogAnalytics) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.network.watcher.flowlog.analytics].Compute")
	switch name {
	case "id":
		return nil
	case "enabled":
...
type AzureMonitor interface {
	...
	DiagnosticSettings() ([]interface{}, error)
	ActivityLog() (AzureMonitorActivitylog, error)
}
...
func newAzureMonitor(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "diagnosticSettings":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor\", its \"diagnosticSettings\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "activityLog":
			if _, ok := val.(AzureMonitorActivitylog); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor\", its \"activityLog\" argument has the wrong type (expected type \"AzureMonitorActivitylog\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
// DiagnosticSettings accessor autogenerated
func (s *mqlAzureMonitor) DiagnosticSettings() ([]interface{}, error) {
	res, ok := s.Cache.Load("diagnosticSettings")
	if !ok || !res.Valid {
		if err := s.ComputeDiagnosticSettings(); err != nil {
			return nil, err
		...
		res, ok = s.Cache.Load("diagnosticSettings")
		if !ok {
			return nil, errors.New("\"azure.monitor\" calculated \"diagnosticSettings\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "diagnosticSettings")
	}
	if res.Error != nil {
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.monitor\" failed to cast field \"diagnosticSettings\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// ActivityLog accessor autogenerated
func (s *mqlAzureMonitor) ActivityLog() (AzureMonitorActivitylog, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("activityLog")
		if !ok {
			return nil, errors.New("\"azure.monitor\" calculated \"activityLog\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.(AzureMonitorActivitylog)
	if !ok {
		return nil, fmt.Errorf("\"azure.monitor\" failed to cast field \"activityLog\" to the right type (AzureMonitorActivitylog): %#v", res)
	}
	return tres, nil
}
...
// ComputeDiagnosticSettings computer autogenerated
func (s *mqlAzureMonitor) ComputeDiagnosticSettings() error {
	var err error
	if _, ok := s.Cache.Load("diagnosticSettings"); ok {
		return nil
	}
...
func (s *mqlAzureMonitor) ComputeActivityLog() error {
	var err error
...
// AzureMonitorActivitylog resource interface
type AzureMonitorActivitylog interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlAzureMonitorActivitylog for the azure.monitor.activitylog resource
type mqlAzureMonitorActivitylog struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureMonitorActivitylog) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.monitor.activitylog resource
func newAzureMonitorActivitylog(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureMonitorActivitylog{runtime.NewResource("azure.monitor.activitylog")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "alerts":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog\", its \"alerts\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.monitor.activitylog with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureMonitorActivitylog) Validate() error {
	// required arguments
	// no required fields found
...
// Register accessor autogenerated
func (s *mqlAzureMonitorActivitylog) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog].Register")
	switch name {
	case "alerts":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.monitor.activitylog\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureMonitorActivitylog) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog].Field")
	switch name {
	case "alerts":
		return s.Alerts()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.monitor.activitylog\" resource")
	}
}

// Alerts accessor autogenerated
func (s *mqlAzureMonitorActivitylog) Alerts() ([]interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("alerts")
		if !ok {
			return nil, errors.New("\"azure.monitor.activitylog\" calculated \"alerts\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.monitor.activitylog\" failed to cast field \"alerts\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureMonitorActivitylog) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog].Compute")
	switch name {
	case "alerts":
...
func (s *mqlAzureMonitorActivitylog) ComputeAlerts() error {
	var err error
...
// AzureMonitorActivitylogAlert resource interface
type AzureMonitorActivitylogAlert interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlAzureMonitorActivitylogAlert for the azure.monitor.activitylog.alert resource
type mqlAzureMonitorActivitylogAlert struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureMonitorActivitylogAlert) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.monitor.activitylog.alert resource
func newAzureMonitorActivitylogAlert(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureMonitorActivitylogAlert{runtime.NewResource("azure.monitor.activitylog.alert")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "type":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert\", its \"type\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "description":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert\", its \"description\" argument has the wrong type (expected type \"string\")")
			}
		case "conditions":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert\", its \"conditions\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "location":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert\", its \"location\" argument has the wrong type (expected type \"string\")")
			}
		case "tags":
			if _, ok := val.(map[string]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert\", its \"tags\" argument has the wrong type (expected type \"map[string]interface{}\")")
			}
		case "actions":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert\", its \"actions\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "scopes":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert\", its \"scopes\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.monitor.activitylog.alert with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureMonitorActivitylogAlert) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("type"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert\" resource without a \"type\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("description"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert\" resource without a \"description\". This field is required.")
	}
	if _, ok := s.Cache.Load("conditions"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert\" resource without a \"conditions\". This field is required.")
	}
	if _, ok := s.Cache.Load("location"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert\" resource without a \"location\". This field is required.")
	}
	if _, ok := s.Cache.Load("tags"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert\" resource without a \"tags\". This field is required.")
	}
	if _, ok := s.Cache.Load("actions"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert\" resource without a \"actions\". This field is required.")
	}
	if _, ok := s.Cache.Load("scopes"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert\" resource without a \"scopes\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlert) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog.alert].Register")
	switch name {
	case "id":
		return nil
	case "type":
	...
	case "scopes":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.monitor.activitylog.alert\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlert) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog.alert].Field")
	switch name {
	case "id":
		return s.Id()
	case "type":
	...
	case "scopes":
		return s.Scopes()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.monitor.activitylog.alert\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlert) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.monitor.activitylog.alert\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.monitor.activitylog.alert\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Type accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlert) Type() (string, error) {
	res, ok := s.Cache.Load("type")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.monitor.activitylog.alert\" failed: no value provided for static field \"type\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.monitor.activitylog.alert\" failed to cast field \"type\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlert) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.monitor.activitylog.alert\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.monitor.activitylog.alert\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Description accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlert) Description() (string, error) {
	res, ok := s.Cache.Load("description")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.monitor.activitylog.alert\" failed: no value provided for static field \"description\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.monitor.activitylog.alert\" failed to cast field \"description\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Conditions accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlert) Conditions() ([]interface{}, error) {
	res, ok := s.Cache.Load("conditions")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.monitor.activitylog.alert\" failed: no value provided for static field \"conditions\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.monitor.activitylog.alert\" failed to cast field \"conditions\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Location accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlert) Location() (string, error) {
	res, ok := s.Cache.Load("location")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.monitor.activitylog.alert\" failed: no value provided for static field \"location\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.monitor.activitylog.alert\" failed to cast field \"location\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Tags accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlert) Tags() (map[string]interface{}, error) {
	res, ok := s.Cache.Load("tags")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.monitor.activitylog.alert\" failed: no value provided for static field \"tags\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(map[string]interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.monitor.activitylog.alert\" failed to cast field \"tags\" to the right type (map[string]interface{}): %#v", res)
	}
	return tres, nil
}

// Actions accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlert) Actions() ([]interface{}, error) {
	res, ok := s.Cache.Load("actions")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.monitor.activitylog.alert\" failed: no value provided for static field \"actions\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.monitor.activitylog.alert\" failed to cast field \"actions\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Scopes accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlert) Scopes() ([]interface{}, error) {
	res, ok := s.Cache.Load("scopes")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.monitor.activitylog.alert\" failed: no value provided for static field \"scopes\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.monitor.activitylog.alert\" failed to cast field \"scopes\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlert) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog.alert].Compute")
	switch name {
	case "id":
		return nil
	case "type":
...
// AzureMonitorActivitylogAlertCondition resource interface
type AzureMonitorActivitylogAlertCondition interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
	...
	ContainsAny() ([]interface{}, error)
	AnyOf() ([]interface{}, error)
}

// mqlAzureMonitorActivitylogAlertCondition for the azure.monitor.activitylog.alert.condition resource
type mqlAzureMonitorActivitylogAlertCondition struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureMonitorActivitylogAlertCondition) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.monitor.activitylog.alert.condition resource
func newAzureMonitorActivitylogAlertCondition(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureMonitorActivitylogAlertCondition{runtime.NewResource("azure.monitor.activitylog.alert.condition")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert.condition\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "equals":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert.condition\", its \"equals\" argument has the wrong type (expected type \"string\")")
			}
		case "fieldName":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert.condition\", its \"fieldName\" argument has the wrong type (expected type \"string\")")
			}
		case "containsAny":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert.condition\", its \"containsAny\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "anyOf":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert.condition\", its \"anyOf\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert.condition\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.monitor.activitylog.alert.condition with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureMonitorActivitylogAlertCondition) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert.condition\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("equals"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert.condition\" resource without a \"equals\". This field is required.")
	}
	if _, ok := s.Cache.Load("fieldName"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert.condition\" resource without a \"fieldName\". This field is required.")
	}
	if _, ok := s.Cache.Load("containsAny"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert.condition\" resource without a \"containsAny\". This field is required.")
	}
	if _, ok := s.Cache.Load("anyOf"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert.condition\" resource without a \"anyOf\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlertCondition) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog.alert.condition].Register")
	switch name {
	case "id":
		return nil
	case "equals":
	...
	case "anyOf":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.monitor.activitylog.alert.condition\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlertCondition) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog.alert.condition].Field")
	switch name {
	case "id":
		return s.Id()
	case "equals":
	...
	case "anyOf":
		return s.AnyOf()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.monitor.activitylog.alert.condition\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlertCondition) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.monitor.activitylog.alert.condition\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.monitor.activitylog.alert.condition\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Equals accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlertCondition) Equals() (string, error) {
	res, ok := s.Cache.Load("equals")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.monitor.activitylog.alert.condition\" failed: no value provided for static field \"equals\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.monitor.activitylog.alert.condition\" failed to cast field \"equals\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// FieldName accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlertCondition) FieldName() (string, error) {
	res, ok := s.Cache.Load("fieldName")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.monitor.activitylog.alert.condition\" failed: no value provided for static field \"fieldName\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.monitor.activitylog.alert.condition\" failed to cast field \"fieldName\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ContainsAny accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlertCondition) ContainsAny() ([]interface{}, error) {
	res, ok := s.Cache.Load("containsAny")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.monitor.activitylog.alert.condition\" failed: no value provided for static field \"containsAny\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.monitor.activitylog.alert.condition\" failed to cast field \"containsAny\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// AnyOf accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlertCondition) AnyOf() ([]interface{}, error) {
	res, ok := s.Cache.Load("anyOf")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.monitor.activitylog.alert.condition\" failed: no value provided for static field \"anyOf\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.monitor.activitylog.alert.condition\" failed to cast field \"anyOf\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlertCondition) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog.alert.condition].Compute")
	switch name {
	case "id":
		return nil
	case "equals":
...
// AzureMonitorActivitylogAlertAction resource interface
type AzureMonitorActivitylogAlertAction interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
	Validate() error
	ActionGroupId() (string, error)
	WebhookProperties() (map[string]interface{}, error)
}

// mqlAzureMonitorActivitylogAlertAction for the azure.monitor.activitylog.alert.action resource
type mqlAzureMonitorActivitylogAlertAction struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureMonitorActivitylogAlertAction) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.monitor.activitylog.alert.action resource
func newAzureMonitorActivitylogAlertAction(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureMonitorActivitylogAlertAction{runtime.NewResource("azure.monitor.activitylog.alert.action")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "actionGroupId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert.action\", its \"actionGroupId\" argument has the wrong type (expected type \"string\")")
			}
		case "webhookProperties":
			if _, ok := val.(map[string]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert.action\", its \"webhookProperties\" argument has the wrong type (expected type \"map[string]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.monitor.activitylog.alert.action\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.monitor.activitylog.alert.action with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureMonitorActivitylogAlertAction) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("actionGroupId"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert.action\" resource without a \"actionGroupId\". This field is required.")
	}
	if _, ok := s.Cache.Load("webhookProperties"); !ok {
		return errors.New("Initialized \"azure.monitor.activitylog.alert.action\" resource without a \"webhookProperties\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlertAction) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog.alert.action].Register")
	switch name {
	case "actionGroupId":
		return nil
	case "webhookProperties":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.monitor.activitylog.alert.action\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlertAction) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog.alert.action].Field")
	switch name {
	case "actionGroupId":
		return s.ActionGroupId()
	case "webhookProperties":
		return s.WebhookProperties()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.monitor.activitylog.alert.action\" resource")
	}
}

// ActionGroupId accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlertAction) ActionGroupId() (string, error) {
	res, ok := s.Cache.Load("actionGroupId")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.monitor.activitylog.alert.action\" failed: no value provided for static field \"actionGroupId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.monitor.activitylog.alert.action\" failed to cast field \"actionGroupId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// WebhookProperties accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlertAction) WebhookProperties() (map[string]interface{}, error) {
	res, ok := s.Cache.Load("webhookProperties")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.monitor.activitylog.alert.action\" failed: no value provided for static field \"webhookProperties\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(map[string]interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.monitor.activitylog.alert.action\" failed to cast field \"webhookProperties\" to the right type (map[string]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlertAction) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog.alert.action].Compute")
	switch name {
	case "actionGroupId":
		return nil
	case "webhookProperties":
