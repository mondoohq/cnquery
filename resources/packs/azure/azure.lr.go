...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("azure.resourcegroup", newAzureResourcegroup)
...
// Compute accessor autogenerated
func (s *mqlAzureResource) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.resource].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// AzureResourcegroup resource interface
type AzureResourcegroup interface {
	MqlResource() (*resources.Resource)
	MqlCompute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlAzureResourcegroup for the azure.resourcegroup resource
type mqlAzureResourcegroup struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureResourcegroup) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.resourcegroup resource
func newAzureResourcegroup(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureResourcegroup{runtime.NewResource("azure.resourcegroup")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.resourcegroup\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.resourcegroup\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "location":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.resourcegroup\", its \"location\" argument has the wrong type (expected type \"string\")")
			}
		case "tags":
			if _, ok := val.(map[string]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.resourcegroup\", its \"tags\" argument has the wrong type (expected type \"map[string]interface{}\")")
			}
		case "type":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.resourcegroup\", its \"type\" argument has the wrong type (expected type \"string\")")
			}
		case "managedBy":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.resourcegroup\", its \"managedBy\" argument has the wrong type (expected type \"string\")")
			}
		case "provisioningState":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.resourcegroup\", its \"provisioningState\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.resourcegroup\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.resourcegroup with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureResourcegroup) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"azure.resourcegroup\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"azure.resourcegroup\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("location"); !ok {
		return errors.New("Initialized \"azure.resourcegroup\" resource without a \"location\". This field is required.")
	}
	if _, ok := s.Cache.Load("tags"); !ok {
		return errors.New("Initialized \"azure.resourcegroup\" resource without a \"tags\". This field is required.")
	}
	if _, ok := s.Cache.Load("type"); !ok {
		return errors.New("Initialized \"azure.resourcegroup\" resource without a \"type\". This field is required.")
	}
	if _, ok := s.Cache.Load("managedBy"); !ok {
		return errors.New("Initialized \"azure.resourcegroup\" resource without a \"managedBy\". This field is required.")
	}
	if _, ok := s.Cache.Load("provisioningState"); !ok {
		return errors.New("Initialized \"azure.resourcegroup\" resource without a \"provisioningState\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlAzureResourcegroup) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.resourcegroup].Register")
	switch name {
	case "id":
		return nil
	case "name":
	...
	case "provisioningState":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.resourcegroup\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureResourcegroup) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.resourcegroup].Field")
	switch name {
	case "id":
		return s.Id()
	case "name":
	...
	case "provisioningState":
		return s.ProvisioningState()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.resourcegroup\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlAzureResourcegroup) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.resourcegroup\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.resourcegroup\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlAzureResourcegroup) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.resourcegroup\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.resourcegroup\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Location accessor autogenerated
func (s *mqlAzureResourcegroup) Location() (string, error) {
	res, ok := s.Cache.Load("location")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.resourcegroup\" failed: no value provided for static field \"location\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.resourcegroup\" failed to cast field \"location\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Tags accessor autogenerated
func (s *mqlAzureResourcegroup) Tags() (map[string]interface{}, error) {
	res, ok := s.Cache.Load("tags")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.resourcegroup\" failed: no value provided for static field \"tags\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(map[string]interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.resourcegroup\" failed to cast field \"tags\" to the right type (map[string]interface{}): %#v", res)
	}
	return tres, nil
}

// Type accessor autogenerated
func (s *mqlAzureResourcegroup) Type() (string, error) {
	res, ok := s.Cache.Load("type")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.resourcegroup\" failed: no value provided for static field \"type\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.resourcegroup\" failed to cast field \"type\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ManagedBy accessor autogenerated
func (s *mqlAzureResourcegroup) ManagedBy() (string, error) {
	res, ok := s.Cache.Load("managedBy")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.resourcegroup\" failed: no value provided for static field \"managedBy\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.resourcegroup\" failed to cast field \"managedBy\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ProvisioningState accessor autogenerated
func (s *mqlAzureResourcegroup) ProvisioningState() (string, error) {
	res, ok := s.Cache.Load("provisioningState")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.resourcegroup\" failed: no value provided for static field \"provisioningState\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.resourcegroup\" failed to cast field \"provisioningState\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureResourcegroup) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.resourcegroup].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureCompute) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.compute].MqlCompute")
	switch name {
	case "vms":
		return s.ComputeVms()
	case "disks":
...
// Compute accessor autogenerated
func (s *mqlAzureComputeVm) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.compute.vm].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureComputeDisk) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.compute.disk].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureNetwork) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.network].MqlCompute")
	switch name {
	case "interfaces":
...
// Compute accessor autogenerated
func (s *mqlAzureNetworkInterface) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.network.interface].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureNetworkSecuritygroup) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.network.securitygroup].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureNetworkSecurityrule) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.network.securityrule].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
func newAzureNetworkWatcher(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "provisioningState":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher\", its \"provisioningState\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
func (s *mqlAzureNetworkWatcher) Validate() error {
	...
	if _, ok := s.Cache.Load("provisioningState"); !ok {
		return errors.New("Initialized \"azure.network.watcher\" resource without a \"provisioningState\". This field is required.")
	}
...
// ProvisioningState accessor autogenerated
func (s *mqlAzureNetworkWatcher) ProvisioningState() (string, error) {
	res, ok := s.Cache.Load("provisioningState")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.network.watcher\" failed: no value provided for static field \"provisioningState\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.network.watcher\" failed to cast field \"provisioningState\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureNetworkWatcher) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.network.watcher].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
func newAzureNetworkWatcherFlowlog(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "retentionPolicy":
			if _, ok := val.(interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"retentionPolicy\" argument has the wrong type (expected type \"interface{}\")")
			}
		case "analytics":
			if _, ok := val.(interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.network.watcher.flowlog\", its \"analytics\" argument has the wrong type (expected type \"interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
func (s *mqlAzureNetworkWatcherFlowlog) RetentionPolicy() (interface{}, error) {
	...
	tres, ok := res.Data.(interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"retentionPolicy\" to the right type (interface{}): %#v", res)
	}
	return tres, nil
}

// Analytics accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) Analytics() (interface{}, error) {
	...
	tres, ok := res.Data.(interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.network.watcher.flowlog\" failed to cast field \"analytics\" to the right type (interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureNetworkWatcherFlowlog) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.network.watcher.flowlog].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureStorage) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage].MqlCompute")
	switch name {
	case "accounts":
...
// Compute accessor autogenerated
func (s *mqlAzureStorageAccount) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.account].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureStorageAccountDataProtection) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.account.dataProtection].MqlCompute")
	switch name {
	case "storageAccountId":
		return nil
	case "blobSoftDeletionEnabled":
...
// Compute accessor autogenerated
func (s *mqlAzureStorageAccountBlobServiceProperties) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.account.blobService.properties].MqlCompute")
	switch name {
	case "id":
		return nil
	case "hourMetrics":
...
// Compute accessor autogenerated
func (s *mqlAzureStorageAccountQueueServiceProperties) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.account.queueService.properties].MqlCompute")
	switch name {
	case "id":
		return nil
	case "hourMetrics":
...
// Compute accessor autogenerated
func (s *mqlAzureStorageAccountTableServiceProperties) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.account.tableService.properties].MqlCompute")
	switch name {
	case "id":
		return nil
	case "hourMetrics":
...
// Compute accessor autogenerated
func (s *mqlAzureStorageAccountServicePropertiesMetrics) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.account.service.properties.metrics].MqlCompute")
	switch name {
	case "id":
		return nil
	case "includeAPIs":
...
// Compute accessor autogenerated
func (s *mqlAzureStorageAccountServicePropertiesRetentionPolicy) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.account.service.properties.retentionPolicy].MqlCompute")
	switch name {
	case "id":
		return nil
	case "retentionDays":
...
// Compute accessor autogenerated
func (s *mqlAzureStorageAccountServicePropertiesLogging) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.account.service.properties.logging].MqlCompute")
	switch name {
	case "id":
		return nil
	case "delete":
...
// Compute accessor autogenerated
func (s *mqlAzureStorageContainer) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.container].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureWeb) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.web].MqlCompute")
	switch name {
	case "apps":
...
// Compute accessor autogenerated
func (s *mqlAzureWebAppsite) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.web.appsite].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureWebAppsiteauthsettings) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.web.appsiteauthsettings].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureWebAppsiteconfig) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.web.appsiteconfig].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureSql) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.sql].MqlCompute")
	switch name {
	case "servers":
...
// Compute accessor autogenerated
func (s *mqlAzureSqlServer) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.sql.server].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureSqlServerVulnerabilityassessmentsettings) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.sql.server.vulnerabilityassessmentsettings].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureSqlServerAdministrator) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.sql.server.administrator].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureSqlDatabase) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.sql.database].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureSqlDatabaseusage) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.sql.databaseusage].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzurePostgresql) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.postgresql].MqlCompute")
	switch name {
	case "servers":
		return s.ComputeServers()
	default:
...
// Compute accessor autogenerated
func (s *mqlAzurePostgresqlServer) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.postgresql.server].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzurePostgresqlDatabase) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.postgresql.database].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureMysql) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.mysql].MqlCompute")
	switch name {
	case "servers":
		return s.ComputeServers()
	case "flexibleServers":
...
// Compute accessor autogenerated
func (s *mqlAzureMysqlServer) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.mysql.server].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureMysqlDatabase) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.mysql.database].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureMysqlFlexibleServer) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.mysql.flexibleServer].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureMariadb) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.mariadb].MqlCompute")
	switch name {
	case "servers":
		return s.ComputeServers()
	default:
...
// Compute accessor autogenerated
func (s *mqlAzureMariadbServer) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.mariadb.server].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureMariadbDatabase) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.mariadb.database].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureSqlConfiguration) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.sql.configuration].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureSqlFirewallrule) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.sql.firewallrule].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureKeyvault) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.keyvault].MqlCompute")
	switch name {
	case "vaults":
...
// Compute accessor autogenerated
func (s *mqlAzureKeyvaultVault) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.keyvault.vault].MqlCompute")
	switch name {
	case "id":
		return nil
	case "vaultName":
...
// Compute accessor autogenerated
func (s *mqlAzureKeyvaultKey) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.keyvault.key].MqlCompute")
	switch name {
	case "kid":
		return nil
	case "tags":
...
// Compute accessor autogenerated
func (s *mqlAzureKeyvaultCertificate) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.keyvault.certificate].MqlCompute")
	switch name {
	case "id":
		return nil
	case "tags":
...
// Compute accessor autogenerated
func (s *mqlAzureKeyvaultSecret) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.keyvault.secret].MqlCompute")
	switch name {
	case "id":
		return nil
	case "tags":
...
// Compute accessor autogenerated
func (s *mqlAzureMonitor) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.monitor].MqlCompute")
	switch name {
	case "logProfiles":
...
// Compute accessor autogenerated
func (s *mqlAzureMonitorActivitylog) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog].MqlCompute")
	switch name {
	case "alerts":
...
// Compute accessor autogenerated
func (s *mqlAzureMonitorActivitylogAlert) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.monitor.activitylog.alert].MqlCompute")
	switch name {
	case "id":
		return nil
	case "type":
...
// Compute accessor autogenerated
func (s *mqlAzureMonitorLogprofile) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.monitor.logprofile].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureMonitorDiagnosticsetting) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.monitor.diagnosticsetting].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
func newAzureCloudDefender(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "defenderForServers":
			if _, ok := val.(interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.cloudDefender\", its \"defenderForServers\" argument has the wrong type (expected type \"interface{}\")")
			}
		case "defenderForContainers":
			if _, ok := val.(interface{}); !ok {
				return nil, errors.New("Failed to initialize \"azure.cloudDefender\", its \"defenderForContainers\" argument has the wrong type (expected type \"interface{}\")")
			}
...
func (s *mqlAzureCloudDefender) DefenderForServers() (interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("defenderForServers")
		if !ok {
			return nil, errors.New("\"azure.cloudDefender\" calculated \"defenderForServers\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.(interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.cloudDefender\" failed to cast field \"defenderForServers\" to the right type (interface{}): %#v", res)
	}
	return tres, nil
}

// DefenderForContainers accessor autogenerated
func (s *mqlAzureCloudDefender) DefenderForContainers() (interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("defenderForContainers")
		if !ok {
			return nil, errors.New("\"azure.cloudDefender\" calculated \"defenderForContainers\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.(interface{})
	if !ok {
		return nil, fmt.Errorf("\"azure.cloudDefender\" failed to cast field \"defenderForContainers\" to the right type (interface{}): %#v", res)
	}
	return tres, nil
}
...
// Compute accessor autogenerated
func (s *mqlAzureCloudDefender) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.cloudDefender].MqlCompute")
	switch name {
	case "monitoringAgentAutoProvision":
...
func (s *mqlAzureCloudDefender) ComputeDefenderForServers() error {
	var err error
...
func (s *mqlAzureCloudDefender) ComputeDefenderForContainers() error {
	var err error
...
// Compute accessor autogenerated
func (s *mqlAzureCloudDefenderSecurityContact) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.cloudDefender.securityContact].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlAzureAuthorization) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.authorization].MqlCompute")
	switch name {
	case "roleDefinitions":
...
// Compute accessor autogenerated
func (s *mqlAzureAuthorizationRoleDefinition) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.authorization.roleDefinition].MqlCompute")
	switch name {
	case "id":
		return nil
	case "description":
...
// Compute accessor autogenerated
func (s *mqlAzureAuthorizationRoleDefinitionPermission) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.authorization.roleDefinition.permission].MqlCompute")
	switch name {
	case "id":
		return nil
	case "allowedActions":
