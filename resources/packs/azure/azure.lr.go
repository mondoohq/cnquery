...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("azure.storage.blobService.properties", newAzureStorageBlobServiceProperties)
	registry.AddFactory("azure.storage.queueService.properties", newAzureStorageQueueServiceProperties)
	registry.AddFactory("azure.storage.tableService.properties", newAzureStorageTableServiceProperties)
	registry.AddFactory("azure.storage.service.properties.metrics", newAzureStorageServicePropertiesMetrics)
	registry.AddFactory("azure.storage.service.properties.retentionPolicy", newAzureStorageServicePropertiesRetentionPolicy)
	registry.AddFactory("azure.storage.service.properties.logging", newAzureStorageServicePropertiesLogging)
...
type AzureStorageAccount interface {
	...
	QueueProperties() (AzureStorageQueueServiceProperties, error)
	TableProperties() (AzureStorageTableServiceProperties, error)
	BlobProperties() (AzureStorageBlobServiceProperties, error)
}
...
func newAzureStorageAccount(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "queueProperties":
			if _, ok := val.(AzureStorageQueueServiceProperties); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.account\", its \"queueProperties\" argument has the wrong type (expected type \"AzureStorageQueueServiceProperties\")")
			}
		case "tableProperties":
			if _, ok := val.(AzureStorageTableServiceProperties); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.account\", its \"tableProperties\" argument has the wrong type (expected type \"AzureStorageTableServiceProperties\")")
			}
		case "blobProperties":
			if _, ok := val.(AzureStorageBlobServiceProperties); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.account\", its \"blobProperties\" argument has the wrong type (expected type \"AzureStorageBlobServiceProperties\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
func (s *mqlAzureStorageAccount) QueueProperties() (AzureStorageQueueServiceProperties, error) {
	...
	tres, ok := res.Data.(AzureStorageQueueServiceProperties)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.account\" failed to cast field \"queueProperties\" to the right type (AzureStorageQueueServiceProperties): %#v", res)
	}
	return tres, nil
}

// TableProperties accessor autogenerated
func (s *mqlAzureStorageAccount) TableProperties() (AzureStorageTableServiceProperties, error) {
	...
	tres, ok := res.Data.(AzureStorageTableServiceProperties)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.account\" failed to cast field \"tableProperties\" to the right type (AzureStorageTableServiceProperties): %#v", res)
	}
	return tres, nil
}

// BlobProperties accessor autogenerated
func (s *mqlAzureStorageAccount) BlobProperties() (AzureStorageBlobServiceProperties, error) {
	...
	tres, ok := res.Data.(AzureStorageBlobServiceProperties)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.account\" failed to cast field \"blobProperties\" to the right type (AzureStorageBlobServiceProperties): %#v", res)
	}
	return tres, nil
}
...
// AzureStorageBlobServiceProperties resource interface
type AzureStorageBlobServiceProperties interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
	Validate() error
	Id() (string, error)
	HourMetrics() (AzureStorageServicePropertiesMetrics, error)
	MinuteMetrics() (AzureStorageServicePropertiesMetrics, error)
	Logging() (AzureStorageServicePropertiesLogging, error)
}

// mqlAzureStorageBlobServiceProperties for the azure.storage.blobService.properties resource
type mqlAzureStorageBlobServiceProperties struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureStorageBlobServiceProperties) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.storage.blobService.properties resource
func newAzureStorageBlobServiceProperties(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureStorageBlobServiceProperties{runtime.NewResource("azure.storage.blobService.properties")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.blobService.properties\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "hourMetrics":
			if _, ok := val.(AzureStorageServicePropertiesMetrics); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.blobService.properties\", its \"hourMetrics\" argument has the wrong type (expected type \"AzureStorageServicePropertiesMetrics\")")
			}
		case "minuteMetrics":
			if _, ok := val.(AzureStorageServicePropertiesMetrics); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.blobService.properties\", its \"minuteMetrics\" argument has the wrong type (expected type \"AzureStorageServicePropertiesMetrics\")")
			}
		case "logging":
			if _, ok := val.(AzureStorageServicePropertiesLogging); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.blobService.properties\", its \"logging\" argument has the wrong type (expected type \"AzureStorageServicePropertiesLogging\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.blobService.properties\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.storage.blobService.properties with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureStorageBlobServiceProperties) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"azure.storage.blobService.properties\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("hourMetrics"); !ok {
		return errors.New("Initialized \"azure.storage.blobService.properties\" resource without a \"hourMetrics\". This field is required.")
	}
	if _, ok := s.Cache.Load("minuteMetrics"); !ok {
		return errors.New("Initialized \"azure.storage.blobService.properties\" resource without a \"minuteMetrics\". This field is required.")
	}
	if _, ok := s.Cache.Load("logging"); !ok {
		return errors.New("Initialized \"azure.storage.blobService.properties\" resource without a \"logging\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlAzureStorageBlobServiceProperties) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.blobService.properties].Register")
	switch name {
	case "id":
		return nil
	case "hourMetrics":
	...
	case "logging":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.storage.blobService.properties\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureStorageBlobServiceProperties) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.storage.blobService.properties].Field")
	switch name {
	case "id":
		return s.Id()
	case "hourMetrics":
	...
	case "logging":
		return s.Logging()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.storage.blobService.properties\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlAzureStorageBlobServiceProperties) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.storage.blobService.properties\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.storage.blobService.properties\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// HourMetrics accessor autogenerated
func (s *mqlAzureStorageBlobServiceProperties) HourMetrics() (AzureStorageServicePropertiesMetrics, error) {
	res, ok := s.Cache.Load("hourMetrics")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.storage.blobService.properties\" failed: no value provided for static field \"hourMetrics\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(AzureStorageServicePropertiesMetrics)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.blobService.properties\" failed to cast field \"hourMetrics\" to the right type (AzureStorageServicePropertiesMetrics): %#v", res)
	}
	return tres, nil
}

// MinuteMetrics accessor autogenerated
func (s *mqlAzureStorageBlobServiceProperties) MinuteMetrics() (AzureStorageServicePropertiesMetrics, error) {
	res, ok := s.Cache.Load("minuteMetrics")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.storage.blobService.properties\" failed: no value provided for static field \"minuteMetrics\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(AzureStorageServicePropertiesMetrics)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.blobService.properties\" failed to cast field \"minuteMetrics\" to the right type (AzureStorageServicePropertiesMetrics): %#v", res)
	}
	return tres, nil
}

// Logging accessor autogenerated
func (s *mqlAzureStorageBlobServiceProperties) Logging() (AzureStorageServicePropertiesLogging, error) {
	res, ok := s.Cache.Load("logging")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.storage.blobService.properties\" failed: no value provided for static field \"logging\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(AzureStorageServicePropertiesLogging)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.blobService.properties\" failed to cast field \"logging\" to the right type (AzureStorageServicePropertiesLogging): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureStorageBlobServiceProperties) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.blobService.properties].Compute")
	switch name {
	case "id":
		return nil
	case "hourMetrics":
...
// AzureStorageQueueServiceProperties resource interface
type AzureStorageQueueServiceProperties interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlAzureStorageQueueServiceProperties for the azure.storage.queueService.properties resource
type mqlAzureStorageQueueServiceProperties struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureStorageQueueServiceProperties) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.storage.queueService.properties resource
func newAzureStorageQueueServiceProperties(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureStorageQueueServiceProperties{runtime.NewResource("azure.storage.queueService.properties")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.queueService.properties\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "hourMetrics":
			if _, ok := val.(AzureStorageServicePropertiesMetrics); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.queueService.properties\", its \"hourMetrics\" argument has the wrong type (expected type \"AzureStorageServicePropertiesMetrics\")")
			}
		case "minuteMetrics":
			if _, ok := val.(AzureStorageServicePropertiesMetrics); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.queueService.properties\", its \"minuteMetrics\" argument has the wrong type (expected type \"AzureStorageServicePropertiesMetrics\")")
			}
		case "logging":
			if _, ok := val.(AzureStorageServicePropertiesLogging); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.queueService.properties\", its \"logging\" argument has the wrong type (expected type \"AzureStorageServicePropertiesLogging\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.queueService.properties\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.storage.queueService.properties with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureStorageQueueServiceProperties) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"azure.storage.queueService.properties\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("hourMetrics"); !ok {
		return errors.New("Initialized \"azure.storage.queueService.properties\" resource without a \"hourMetrics\". This field is required.")
	}
	if _, ok := s.Cache.Load("minuteMetrics"); !ok {
		return errors.New("Initialized \"azure.storage.queueService.properties\" resource without a \"minuteMetrics\". This field is required.")
	}
	if _, ok := s.Cache.Load("logging"); !ok {
		return errors.New("Initialized \"azure.storage.queueService.properties\" resource without a \"logging\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlAzureStorageQueueServiceProperties) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.queueService.properties].Register")
	switch name {
	case "id":
		return nil
	case "hourMetrics":
	...
	case "logging":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.storage.queueService.properties\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureStorageQueueServiceProperties) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.storage.queueService.properties].Field")
	switch name {
	case "id":
		return s.Id()
	case "hourMetrics":
	...
	case "logging":
		return s.Logging()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.storage.queueService.properties\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlAzureStorageQueueServiceProperties) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.storage.queueService.properties\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.storage.queueService.properties\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// HourMetrics accessor autogenerated
func (s *mqlAzureStorageQueueServiceProperties) HourMetrics() (AzureStorageServicePropertiesMetrics, error) {
	res, ok := s.Cache.Load("hourMetrics")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.storage.queueService.properties\" failed: no value provided for static field \"hourMetrics\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(AzureStorageServicePropertiesMetrics)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.queueService.properties\" failed to cast field \"hourMetrics\" to the right type (AzureStorageServicePropertiesMetrics): %#v", res)
	}
	return tres, nil
}

// MinuteMetrics accessor autogenerated
func (s *mqlAzureStorageQueueServiceProperties) MinuteMetrics() (AzureStorageServicePropertiesMetrics, error) {
	res, ok := s.Cache.Load("minuteMetrics")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.storage.queueService.properties\" failed: no value provided for static field \"minuteMetrics\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(AzureStorageServicePropertiesMetrics)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.queueService.properties\" failed to cast field \"minuteMetrics\" to the right type (AzureStorageServicePropertiesMetrics): %#v", res)
	}
	return tres, nil
}

// Logging accessor autogenerated
func (s *mqlAzureStorageQueueServiceProperties) Logging() (AzureStorageServicePropertiesLogging, error) {
	res, ok := s.Cache.Load("logging")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.storage.queueService.properties\" failed: no value provided for static field \"logging\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(AzureStorageServicePropertiesLogging)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.queueService.properties\" failed to cast field \"logging\" to the right type (AzureStorageServicePropertiesLogging): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureStorageQueueServiceProperties) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.queueService.properties].Compute")
	switch name {
	case "id":
		return nil
	case "hourMetrics":
...
// AzureStorageTableServiceProperties resource interface
type AzureStorageTableServiceProperties interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlAzureStorageTableServiceProperties for the azure.storage.tableService.properties resource
type mqlAzureStorageTableServiceProperties struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureStorageTableServiceProperties) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.storage.tableService.properties resource
func newAzureStorageTableServiceProperties(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureStorageTableServiceProperties{runtime.NewResource("azure.storage.tableService.properties")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.tableService.properties\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "hourMetrics":
			if _, ok := val.(AzureStorageServicePropertiesMetrics); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.tableService.properties\", its \"hourMetrics\" argument has the wrong type (expected type \"AzureStorageServicePropertiesMetrics\")")
			}
		case "minuteMetrics":
			if _, ok := val.(AzureStorageServicePropertiesMetrics); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.tableService.properties\", its \"minuteMetrics\" argument has the wrong type (expected type \"AzureStorageServicePropertiesMetrics\")")
			}
		case "logging":
			if _, ok := val.(AzureStorageServicePropertiesLogging); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.tableService.properties\", its \"logging\" argument has the wrong type (expected type \"AzureStorageServicePropertiesLogging\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.tableService.properties\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.storage.tableService.properties with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureStorageTableServiceProperties) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"azure.storage.tableService.properties\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("hourMetrics"); !ok {
		return errors.New("Initialized \"azure.storage.tableService.properties\" resource without a \"hourMetrics\". This field is required.")
	}
	if _, ok := s.Cache.Load("minuteMetrics"); !ok {
		return errors.New("Initialized \"azure.storage.tableService.properties\" resource without a \"minuteMetrics\". This field is required.")
	}
	if _, ok := s.Cache.Load("logging"); !ok {
		return errors.New("Initialized \"azure.storage.tableService.properties\" resource without a \"logging\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlAzureStorageTableServiceProperties) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.tableService.properties].Register")
	switch name {
	case "id":
		return nil
	case "hourMetrics":
	...
	case "logging":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.storage.tableService.properties\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureStorageTableServiceProperties) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.storage.tableService.properties].Field")
	switch name {
	case "id":
		return s.Id()
	case "hourMetrics":
	...
	case "logging":
		return s.Logging()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.storage.tableService.properties\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlAzureStorageTableServiceProperties) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.storage.tableService.properties\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.storage.tableService.properties\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// HourMetrics accessor autogenerated
func (s *mqlAzureStorageTableServiceProperties) HourMetrics() (AzureStorageServicePropertiesMetrics, error) {
	res, ok := s.Cache.Load("hourMetrics")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.storage.tableService.properties\" failed: no value provided for static field \"hourMetrics\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(AzureStorageServicePropertiesMetrics)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.tableService.properties\" failed to cast field \"hourMetrics\" to the right type (AzureStorageServicePropertiesMetrics): %#v", res)
	}
	return tres, nil
}

// MinuteMetrics accessor autogenerated
func (s *mqlAzureStorageTableServiceProperties) MinuteMetrics() (AzureStorageServicePropertiesMetrics, error) {
	res, ok := s.Cache.Load("minuteMetrics")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.storage.tableService.properties\" failed: no value provided for static field \"minuteMetrics\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(AzureStorageServicePropertiesMetrics)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.tableService.properties\" failed to cast field \"minuteMetrics\" to the right type (AzureStorageServicePropertiesMetrics): %#v", res)
	}
	return tres, nil
}

// Logging accessor autogenerated
func (s *mqlAzureStorageTableServiceProperties) Logging() (AzureStorageServicePropertiesLogging, error) {
	res, ok := s.Cache.Load("logging")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.storage.tableService.properties\" failed: no value provided for static field \"logging\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(AzureStorageServicePropertiesLogging)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.tableService.properties\" failed to cast field \"logging\" to the right type (AzureStorageServicePropertiesLogging): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureStorageTableServiceProperties) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.tableService.properties].Compute")
	switch name {
	case "id":
		return nil
	case "hourMetrics":
...
// AzureStorageServicePropertiesMetrics resource interface
type AzureStorageServicePropertiesMetrics interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
	...
	RetentionPolicy() (AzureStorageServicePropertiesRetentionPolicy, error)
	Enabled() (bool, error)
	Version() (string, error)
}

// mqlAzureStorageServicePropertiesMetrics for the azure.storage.service.properties.metrics resource
type mqlAzureStorageServicePropertiesMetrics struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureStorageServicePropertiesMetrics) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.storage.service.properties.metrics resource
func newAzureStorageServicePropertiesMetrics(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureStorageServicePropertiesMetrics{runtime.NewResource("azure.storage.service.properties.metrics")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.metrics\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "includeAPIs":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.metrics\", its \"includeAPIs\" argument has the wrong type (expected type \"bool\")")
			}
		case "retentionPolicy":
			if _, ok := val.(AzureStorageServicePropertiesRetentionPolicy); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.metrics\", its \"retentionPolicy\" argument has the wrong type (expected type \"AzureStorageServicePropertiesRetentionPolicy\")")
			}
		case "enabled":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.metrics\", its \"enabled\" argument has the wrong type (expected type \"bool\")")
			}
		case "version":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.metrics\", its \"version\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.metrics\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.storage.service.properties.metrics with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureStorageServicePropertiesMetrics) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.metrics\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("includeAPIs"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.metrics\" resource without a \"includeAPIs\". This field is required.")
	}
	if _, ok := s.Cache.Load("retentionPolicy"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.metrics\" resource without a \"retentionPolicy\". This field is required.")
	}
	if _, ok := s.Cache.Load("enabled"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.metrics\" resource without a \"enabled\". This field is required.")
	}
	if _, ok := s.Cache.Load("version"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.metrics\" resource without a \"version\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlAzureStorageServicePropertiesMetrics) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.service.properties.metrics].Register")
	switch name {
	case "id":
		return nil
	case "includeAPIs":
	...
	case "version":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.storage.service.properties.metrics\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureStorageServicePropertiesMetrics) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.storage.service.properties.metrics].Field")
	switch name {
	case "id":
		return s.Id()
	case "includeAPIs":
	...
	case "version":
		return s.Version()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.storage.service.properties.metrics\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlAzureStorageServicePropertiesMetrics) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.storage.service.properties.metrics\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.storage.service.properties.metrics\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// IncludeAPIs accessor autogenerated
func (s *mqlAzureStorageServicePropertiesMetrics) IncludeAPIs() (bool, error) {
	res, ok := s.Cache.Load("includeAPIs")
	if !ok || !res.Valid {
		return false, errors.New("\"azure.storage.service.properties.metrics\" failed: no value provided for static field \"includeAPIs\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"azure.storage.service.properties.metrics\" failed to cast field \"includeAPIs\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// RetentionPolicy accessor autogenerated
func (s *mqlAzureStorageServicePropertiesMetrics) RetentionPolicy() (AzureStorageServicePropertiesRetentionPolicy, error) {
	res, ok := s.Cache.Load("retentionPolicy")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.storage.service.properties.metrics\" failed: no value provided for static field \"retentionPolicy\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(AzureStorageServicePropertiesRetentionPolicy)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.service.properties.metrics\" failed to cast field \"retentionPolicy\" to the right type (AzureStorageServicePropertiesRetentionPolicy): %#v", res)
	}
	return tres, nil
}

// Enabled accessor autogenerated
func (s *mqlAzureStorageServicePropertiesMetrics) Enabled() (bool, error) {
	res, ok := s.Cache.Load("enabled")
	if !ok || !res.Valid {
		return false, errors.New("\"azure.storage.service.properties.metrics\" failed: no value provided for static field \"enabled\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"azure.storage.service.properties.metrics\" failed to cast field \"enabled\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// Version accessor autogenerated
func (s *mqlAzureStorageServicePropertiesMetrics) Version() (string, error) {
	res, ok := s.Cache.Load("version")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.storage.service.properties.metrics\" failed: no value provided for static field \"version\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.storage.service.properties.metrics\" failed to cast field \"version\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureStorageServicePropertiesMetrics) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.service.properties.metrics].Compute")
	switch name {
	case "id":
		return nil
	case "includeAPIs":
...
// AzureStorageServicePropertiesRetentionPolicy resource interface
type AzureStorageServicePropertiesRetentionPolicy interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlAzureStorageServicePropertiesRetentionPolicy for the azure.storage.service.properties.retentionPolicy resource
type mqlAzureStorageServicePropertiesRetentionPolicy struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureStorageServicePropertiesRetentionPolicy) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.storage.service.properties.retentionPolicy resource
func newAzureStorageServicePropertiesRetentionPolicy(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureStorageServicePropertiesRetentionPolicy{runtime.NewResource("azure.storage.service.properties.retentionPolicy")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.retentionPolicy\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "retentionDays":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.retentionPolicy\", its \"retentionDays\" argument has the wrong type (expected type \"int64\")")
			}
		case "enabled":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.retentionPolicy\", its \"enabled\" argument has the wrong type (expected type \"bool\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.retentionPolicy\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.storage.service.properties.retentionPolicy with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureStorageServicePropertiesRetentionPolicy) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.retentionPolicy\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("retentionDays"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.retentionPolicy\" resource without a \"retentionDays\". This field is required.")
	}
	if _, ok := s.Cache.Load("enabled"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.retentionPolicy\" resource without a \"enabled\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlAzureStorageServicePropertiesRetentionPolicy) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.service.properties.retentionPolicy].Register")
	switch name {
	case "id":
		return nil
	case "retentionDays":
	...
	case "enabled":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.storage.service.properties.retentionPolicy\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureStorageServicePropertiesRetentionPolicy) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.storage.service.properties.retentionPolicy].Field")
	switch name {
	case "id":
		return s.Id()
	case "retentionDays":
	...
	case "enabled":
		return s.Enabled()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.storage.service.properties.retentionPolicy\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlAzureStorageServicePropertiesRetentionPolicy) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.storage.service.properties.retentionPolicy\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.storage.service.properties.retentionPolicy\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// RetentionDays accessor autogenerated
func (s *mqlAzureStorageServicePropertiesRetentionPolicy) RetentionDays() (int64, error) {
	res, ok := s.Cache.Load("retentionDays")
	if !ok || !res.Valid {
		return 0, errors.New("\"azure.storage.service.properties.retentionPolicy\" failed: no value provided for static field \"retentionDays\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	...
	if !ok {
		return 0, fmt.Errorf("\"azure.storage.service.properties.retentionPolicy\" failed to cast field \"retentionDays\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// Enabled accessor autogenerated
func (s *mqlAzureStorageServicePropertiesRetentionPolicy) Enabled() (bool, error) {
	res, ok := s.Cache.Load("enabled")
	if !ok || !res.Valid {
		return false, errors.New("\"azure.storage.service.properties.retentionPolicy\" failed: no value provided for static field \"enabled\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"azure.storage.service.properties.retentionPolicy\" failed to cast field \"enabled\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureStorageServicePropertiesRetentionPolicy) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.service.properties.retentionPolicy].Compute")
	switch name {
	case "id":
		return nil
	case "retentionDays":
...
// AzureStorageServicePropertiesLogging resource interface
type AzureStorageServicePropertiesLogging interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlAzureStorageServicePropertiesLogging for the azure.storage.service.properties.logging resource
type mqlAzureStorageServicePropertiesLogging struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlAzureStorageServicePropertiesLogging) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the azure.storage.service.properties.logging resource
func newAzureStorageServicePropertiesLogging(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlAzureStorageServicePropertiesLogging{runtime.NewResource("azure.storage.service.properties.logging")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.logging\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "delete":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.logging\", its \"delete\" argument has the wrong type (expected type \"bool\")")
			}
		case "read":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.logging\", its \"read\" argument has the wrong type (expected type \"bool\")")
			}
		case "write":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.logging\", its \"write\" argument has the wrong type (expected type \"bool\")")
			}
		case "version":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.logging\", its \"version\" argument has the wrong type (expected type \"string\")")
			}
		case "retentionPolicy":
			if _, ok := val.(AzureStorageServicePropertiesRetentionPolicy); !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.logging\", its \"retentionPolicy\" argument has the wrong type (expected type \"AzureStorageServicePropertiesRetentionPolicy\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"azure.storage.service.properties.logging\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized azure.storage.service.properties.logging with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlAzureStorageServicePropertiesLogging) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.logging\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("delete"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.logging\" resource without a \"delete\". This field is required.")
	}
	if _, ok := s.Cache.Load("read"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.logging\" resource without a \"read\". This field is required.")
	}
	if _, ok := s.Cache.Load("write"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.logging\" resource without a \"write\". This field is required.")
	}
	if _, ok := s.Cache.Load("version"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.logging\" resource without a \"version\". This field is required.")
	}
	if _, ok := s.Cache.Load("retentionPolicy"); !ok {
		return errors.New("Initialized \"azure.storage.service.properties.logging\" resource without a \"retentionPolicy\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlAzureStorageServicePropertiesLogging) Register(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.service.properties.logging].Register")
	switch name {
	case "id":
		return nil
	case "delete":
	...
	case "retentionPolicy":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"azure.storage.service.properties.logging\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlAzureStorageServicePropertiesLogging) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[azure.storage.service.properties.logging].Field")
	switch name {
	case "id":
		return s.Id()
	case "delete":
	...
	case "retentionPolicy":
		return s.RetentionPolicy()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"azure.storage.service.properties.logging\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlAzureStorageServicePropertiesLogging) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.storage.service.properties.logging\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.storage.service.properties.logging\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Delete accessor autogenerated
func (s *mqlAzureStorageServicePropertiesLogging) Delete() (bool, error) {
	res, ok := s.Cache.Load("delete")
	if !ok || !res.Valid {
		return false, errors.New("\"azure.storage.service.properties.logging\" failed: no value provided for static field \"delete\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"azure.storage.service.properties.logging\" failed to cast field \"delete\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// Read accessor autogenerated
func (s *mqlAzureStorageServicePropertiesLogging) Read() (bool, error) {
	res, ok := s.Cache.Load("read")
	if !ok || !res.Valid {
		return false, errors.New("\"azure.storage.service.properties.logging\" failed: no value provided for static field \"read\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"azure.storage.service.properties.logging\" failed to cast field \"read\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// Write accessor autogenerated
func (s *mqlAzureStorageServicePropertiesLogging) Write() (bool, error) {
	res, ok := s.Cache.Load("write")
	if !ok || !res.Valid {
		return false, errors.New("\"azure.storage.service.properties.logging\" failed: no value provided for static field \"write\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"azure.storage.service.properties.logging\" failed to cast field \"write\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// Version accessor autogenerated
func (s *mqlAzureStorageServicePropertiesLogging) Version() (string, error) {
	res, ok := s.Cache.Load("version")
	if !ok || !res.Valid {
		return "", errors.New("\"azure.storage.service.properties.logging\" failed: no value provided for static field \"version\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"azure.storage.service.properties.logging\" failed to cast field \"version\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// RetentionPolicy accessor autogenerated
func (s *mqlAzureStorageServicePropertiesLogging) RetentionPolicy() (AzureStorageServicePropertiesRetentionPolicy, error) {
	res, ok := s.Cache.Load("retentionPolicy")
	if !ok || !res.Valid {
		return nil, errors.New("\"azure.storage.service.properties.logging\" failed: no value provided for static field \"retentionPolicy\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(AzureStorageServicePropertiesRetentionPolicy)
	if !ok {
		return nil, fmt.Errorf("\"azure.storage.service.properties.logging\" failed to cast field \"retentionPolicy\" to the right type (AzureStorageServicePropertiesRetentionPolicy): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlAzureStorageServicePropertiesLogging) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[azure.storage.service.properties.logging].Compute")
	switch name {
	case "id":
		return nil
	case "delete":
