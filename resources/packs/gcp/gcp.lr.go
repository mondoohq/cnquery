...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("gcp.project.cloudrun", newGcpProjectCloudrun)
	registry.AddFactory("gcp.project.cloudrun.operation", newGcpProjectCloudrunOperation)
}
...
type GcpProject interface {
	...
	Cloudrun() (GcpProjectCloudrun, error)
}
...
func newGcpProject(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "cloudrun":
			if _, ok := val.(GcpProjectCloudrun); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project\", its \"cloudrun\" argument has the wrong type (expected type \"GcpProjectCloudrun\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
func (s *mqlGcpProject) Cloudrun() (GcpProjectCloudrun, error) {
	...
	tres, ok := res.Data.(GcpProjectCloudrun)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project\" failed to cast field \"cloudrun\" to the right type (GcpProjectCloudrun): %#v", res)
	}
	return tres, nil
}
...
// GcpProjectCloudrun resource interface
type GcpProjectCloudrun interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcpProjectCloudrun for the gcp.project.cloudrun resource
type mqlGcpProjectCloudrun struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectCloudrun) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.cloudrun resource
func newGcpProjectCloudrun(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectCloudrun{runtime.NewResource("gcp.project.cloudrun")}
	var existing GcpProjectCloudrun
	args, existing, err = res.init(args)
	if err != nil {
		return nil, err
	}
	...
	for name, val := range *args {
		...
		case "projectId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.cloudrun\", its \"projectId\" argument has the wrong type (expected type \"string\")")
			}
		case "operations":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.cloudrun\", its \"operations\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.cloudrun\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.cloudrun with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectCloudrun) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("projectId"); !ok {
		return errors.New("Initialized \"gcp.project.cloudrun\" resource without a \"projectId\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectCloudrun) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.cloudrun].Register")
	switch name {
	case "projectId":
		return nil
	case "operations":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.cloudrun\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectCloudrun) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.cloudrun].Field")
	switch name {
	case "projectId":
		return s.ProjectId()
	case "operations":
		return s.Operations()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.cloudrun\" resource")
	}
}

// ProjectId accessor autogenerated
func (s *mqlGcpProjectCloudrun) ProjectId() (string, error) {
	res, ok := s.Cache.Load("projectId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.cloudrun\" failed: no value provided for static field \"projectId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.cloudrun\" failed to cast field \"projectId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Operations accessor autogenerated
func (s *mqlGcpProjectCloudrun) Operations() ([]interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("operations")
		if !ok {
			return nil, errors.New("\"gcp.project.cloudrun\" calculated \"operations\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.cloudrun\" failed to cast field \"operations\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectCloudrun) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.cloudrun].Compute")
	switch name {
	case "projectId":
		return nil
	case "operations":
...
func (s *mqlGcpProjectCloudrun) ComputeOperations() error {
	var err error
...
// GcpProjectCloudrunOperation resource interface
type GcpProjectCloudrunOperation interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcpProjectCloudrunOperation for the gcp.project.cloudrun.operation resource
type mqlGcpProjectCloudrunOperation struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectCloudrunOperation) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.cloudrun.operation resource
func newGcpProjectCloudrunOperation(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectCloudrunOperation{runtime.NewResource("gcp.project.cloudrun.operation")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.cloudrun.operation\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "projectId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.cloudrun.operation\", its \"projectId\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.cloudrun.operation\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.cloudrun.operation\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.cloudrun.operation with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectCloudrunOperation) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcp.project.cloudrun.operation\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("projectId"); !ok {
		return errors.New("Initialized \"gcp.project.cloudrun.operation\" resource without a \"projectId\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"gcp.project.cloudrun.operation\" resource without a \"name\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectCloudrunOperation) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.cloudrun.operation].Register")
	switch name {
	case "id":
		return nil
	case "projectId":
	...
	case "name":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.cloudrun.operation\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectCloudrunOperation) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.cloudrun.operation].Field")
	switch name {
	case "id":
		return s.Id()
	case "projectId":
	...
	case "name":
		return s.Name()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.cloudrun.operation\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcpProjectCloudrunOperation) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.cloudrun.operation\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.cloudrun.operation\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ProjectId accessor autogenerated
func (s *mqlGcpProjectCloudrunOperation) ProjectId() (string, error) {
	res, ok := s.Cache.Load("projectId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.cloudrun.operation\" failed: no value provided for static field \"projectId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.cloudrun.operation\" failed to cast field \"projectId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlGcpProjectCloudrunOperation) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.cloudrun.operation\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.cloudrun.operation\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectCloudrunOperation) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.cloudrun.operation].Compute")
	switch name {
	case "id":
		return nil
	case "projectId":
