...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("gcp.project.loggingservices", newGcpProjectLoggingservices)
	registry.AddFactory("gcp.project.loggingservices.bucket", newGcpProjectLoggingservicesBucket)
	registry.AddFactory("gcp.project.loggingservices.bucket.cmekSettings", newGcpProjectLoggingservicesBucketCmekSettings)
	registry.AddFactory("gcp.project.loggingservices.bucket.indexConfig", newGcpProjectLoggingservicesBucketIndexConfig)
}
...
type GcpProject interface {
	...
	Logging() (GcpProjectLoggingservices, error)
}
...
func newGcpProject(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "logging":
			if _, ok := val.(GcpProjectLoggingservices); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project\", its \"logging\" argument has the wrong type (expected type \"GcpProjectLoggingservices\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
func (s *mqlGcpProject) Logging() (GcpProjectLoggingservices, error) {
	...
	tres, ok := res.Data.(GcpProjectLoggingservices)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project\" failed to cast field \"logging\" to the right type (GcpProjectLoggingservices): %#v", res)
	}
	return tres, nil
}
...
// Compute accessor autogenerated
func (s *mqlGcpProjectApiKeyRestrictions) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.apiKey.restrictions].Compute")
	switch name {
	case "parentResourcePath":
		return nil
	case "androidKeyRestrictions":
...
// GcpProjectLoggingservices resource interface
type GcpProjectLoggingservices interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcpProjectLoggingservices for the gcp.project.loggingservices resource
type mqlGcpProjectLoggingservices struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectLoggingservices) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.loggingservices resource
func newGcpProjectLoggingservices(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectLoggingservices{runtime.NewResource("gcp.project.loggingservices")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "projectId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices\", its \"projectId\" argument has the wrong type (expected type \"string\")")
			}
		case "buckets":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices\", its \"buckets\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.loggingservices with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectLoggingservices) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("projectId"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices\" resource without a \"projectId\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectLoggingservices) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservices].Register")
	switch name {
	case "projectId":
		return nil
	case "buckets":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.loggingservices\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectLoggingservices) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservices].Field")
	switch name {
	case "projectId":
		return s.ProjectId()
	case "buckets":
		return s.Buckets()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.loggingservices\" resource")
	}
}

// ProjectId accessor autogenerated
func (s *mqlGcpProjectLoggingservices) ProjectId() (string, error) {
	res, ok := s.Cache.Load("projectId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservices\" failed: no value provided for static field \"projectId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservices\" failed to cast field \"projectId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Buckets accessor autogenerated
func (s *mqlGcpProjectLoggingservices) Buckets() ([]interface{}, error) {
	res, ok := s.Cache.Load("buckets")
	if !ok || !res.Valid {
		if err := s.ComputeBuckets(); err != nil {
			return nil, err
		...
		res, ok = s.Cache.Load("buckets")
		if !ok {
			return nil, errors.New("\"gcp.project.loggingservices\" calculated \"buckets\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "buckets")
	}
	if res.Error != nil {
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.loggingservices\" failed to cast field \"buckets\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectLoggingservices) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservices].Compute")
	switch name {
	case "projectId":
		return nil
	case "buckets":
...
// ComputeBuckets computer autogenerated
func (s *mqlGcpProjectLoggingservices) ComputeBuckets() error {
	var err error
	if _, ok := s.Cache.Load("buckets"); ok {
		return nil
	}
...
// GcpProjectLoggingservicesBucket resource interface
type GcpProjectLoggingservicesBucket interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
	Validate() error
	Id() (string, error)
	CmekSettings() (GcpProjectLoggingservicesBucketCmekSettings, error)
	Created() (*time.Time, error)
	Description() (string, error)
...
// mqlGcpProjectLoggingservicesBucket for the gcp.project.loggingservices.bucket resource
type mqlGcpProjectLoggingservicesBucket struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectLoggingservicesBucket) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.loggingservices.bucket resource
func newGcpProjectLoggingservicesBucket(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectLoggingservicesBucket{runtime.NewResource("gcp.project.loggingservices.bucket")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "cmekSettings":
			if _, ok := val.(GcpProjectLoggingservicesBucketCmekSettings); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket\", its \"cmekSettings\" argument has the wrong type (expected type \"GcpProjectLoggingservicesBucketCmekSettings\")")
			}
		case "created":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket\", its \"created\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "description":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket\", its \"description\" argument has the wrong type (expected type \"string\")")
			}
		case "indexConfigs":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket\", its \"indexConfigs\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "lifecycleState":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket\", its \"lifecycleState\" argument has the wrong type (expected type \"string\")")
			}
		case "locked":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket\", its \"locked\" argument has the wrong type (expected type \"bool\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "restrictedFields":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket\", its \"restrictedFields\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "retentionDays":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket\", its \"retentionDays\" argument has the wrong type (expected type \"int64\")")
			}
		case "updated":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket\", its \"updated\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.loggingservices.bucket with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectLoggingservicesBucket) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("cmekSettings"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket\" resource without a \"cmekSettings\". This field is required.")
	}
	if _, ok := s.Cache.Load("created"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket\" resource without a \"created\". This field is required.")
	}
	if _, ok := s.Cache.Load("description"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket\" resource without a \"description\". This field is required.")
	}
	if _, ok := s.Cache.Load("indexConfigs"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket\" resource without a \"indexConfigs\". This field is required.")
	}
	if _, ok := s.Cache.Load("lifecycleState"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket\" resource without a \"lifecycleState\". This field is required.")
	}
	if _, ok := s.Cache.Load("locked"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket\" resource without a \"locked\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("restrictedFields"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket\" resource without a \"restrictedFields\". This field is required.")
	}
	if _, ok := s.Cache.Load("retentionDays"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket\" resource without a \"retentionDays\". This field is required.")
	}
	if _, ok := s.Cache.Load("updated"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket\" resource without a \"updated\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservices.bucket].Register")
	switch name {
	case "id":
		return nil
	case "cmekSettings":
	...
	case "updated":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.loggingservices.bucket\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservices.bucket].Field")
	switch name {
	case "id":
		return s.Id()
	case "cmekSettings":
	...
	case "updated":
		return s.Updated()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.loggingservices.bucket\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservices.bucket\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservices.bucket\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// CmekSettings accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) CmekSettings() (GcpProjectLoggingservicesBucketCmekSettings, error) {
	res, ok := s.Cache.Load("cmekSettings")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.loggingservices.bucket\" failed: no value provided for static field \"cmekSettings\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(GcpProjectLoggingservicesBucketCmekSettings)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.loggingservices.bucket\" failed to cast field \"cmekSettings\" to the right type (GcpProjectLoggingservicesBucketCmekSettings): %#v", res)
	}
	return tres, nil
}

// Created accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) Created() (*time.Time, error) {
	res, ok := s.Cache.Load("created")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.loggingservices.bucket\" failed: no value provided for static field \"created\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.loggingservices.bucket\" failed to cast field \"created\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Description accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) Description() (string, error) {
	res, ok := s.Cache.Load("description")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservices.bucket\" failed: no value provided for static field \"description\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservices.bucket\" failed to cast field \"description\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// IndexConfigs accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) IndexConfigs() ([]interface{}, error) {
	res, ok := s.Cache.Load("indexConfigs")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.loggingservices.bucket\" failed: no value provided for static field \"indexConfigs\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.loggingservices.bucket\" failed to cast field \"indexConfigs\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// LifecycleState accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) LifecycleState() (string, error) {
	res, ok := s.Cache.Load("lifecycleState")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservices.bucket\" failed: no value provided for static field \"lifecycleState\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservices.bucket\" failed to cast field \"lifecycleState\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Locked accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) Locked() (bool, error) {
	res, ok := s.Cache.Load("locked")
	if !ok || !res.Valid {
		return false, errors.New("\"gcp.project.loggingservices.bucket\" failed: no value provided for static field \"locked\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"gcp.project.loggingservices.bucket\" failed to cast field \"locked\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservices.bucket\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservices.bucket\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// RestrictedFields accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) RestrictedFields() ([]interface{}, error) {
	res, ok := s.Cache.Load("restrictedFields")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.loggingservices.bucket\" failed: no value provided for static field \"restrictedFields\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.loggingservices.bucket\" failed to cast field \"restrictedFields\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// RetentionDays accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) RetentionDays() (int64, error) {
	res, ok := s.Cache.Load("retentionDays")
	if !ok || !res.Valid {
		return 0, errors.New("\"gcp.project.loggingservices.bucket\" failed: no value provided for static field \"retentionDays\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"gcp.project.loggingservices.bucket\" failed to cast field \"retentionDays\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// Updated accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) Updated() (*time.Time, error) {
	res, ok := s.Cache.Load("updated")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.loggingservices.bucket\" failed: no value provided for static field \"updated\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.loggingservices.bucket\" failed to cast field \"updated\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucket) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservices.bucket].Compute")
	switch name {
	case "id":
		return nil
	case "cmekSettings":
...
// GcpProjectLoggingservicesBucketCmekSettings resource interface
type GcpProjectLoggingservicesBucketCmekSettings interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
	...
	Name() (string, error)
	ServiceAccountId() (string, error)
}

// mqlGcpProjectLoggingservicesBucketCmekSettings for the gcp.project.loggingservices.bucket.cmekSettings resource
type mqlGcpProjectLoggingservicesBucketCmekSettings struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectLoggingservicesBucketCmekSettings) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.loggingservices.bucket.cmekSettings resource
func newGcpProjectLoggingservicesBucketCmekSettings(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectLoggingservicesBucketCmekSettings{runtime.NewResource("gcp.project.loggingservices.bucket.cmekSettings")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket.cmekSettings\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "kmsKeyName":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket.cmekSettings\", its \"kmsKeyName\" argument has the wrong type (expected type \"string\")")
			}
		case "kmsKeyVersionName":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket.cmekSettings\", its \"kmsKeyVersionName\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket.cmekSettings\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "serviceAccountId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket.cmekSettings\", its \"serviceAccountId\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket.cmekSettings\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.loggingservices.bucket.cmekSettings with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectLoggingservicesBucketCmekSettings) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket.cmekSettings\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("kmsKeyName"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket.cmekSettings\" resource without a \"kmsKeyName\". This field is required.")
	}
	if _, ok := s.Cache.Load("kmsKeyVersionName"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket.cmekSettings\" resource without a \"kmsKeyVersionName\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket.cmekSettings\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("serviceAccountId"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket.cmekSettings\" resource without a \"serviceAccountId\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketCmekSettings) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservices.bucket.cmekSettings].Register")
	switch name {
	case "id":
		return nil
	case "kmsKeyName":
	...
	case "serviceAccountId":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.loggingservices.bucket.cmekSettings\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketCmekSettings) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservices.bucket.cmekSettings].Field")
	switch name {
	case "id":
		return s.Id()
	case "kmsKeyName":
	...
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.loggingservices.bucket.cmekSettings\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketCmekSettings) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservices.bucket.cmekSettings\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservices.bucket.cmekSettings\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// KmsKeyName accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketCmekSettings) KmsKeyName() (string, error) {
	res, ok := s.Cache.Load("kmsKeyName")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservices.bucket.cmekSettings\" failed: no value provided for static field \"kmsKeyName\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservices.bucket.cmekSettings\" failed to cast field \"kmsKeyName\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// KmsKeyVersionName accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketCmekSettings) KmsKeyVersionName() (string, error) {
	res, ok := s.Cache.Load("kmsKeyVersionName")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservices.bucket.cmekSettings\" failed: no value provided for static field \"kmsKeyVersionName\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservices.bucket.cmekSettings\" failed to cast field \"kmsKeyVersionName\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketCmekSettings) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservices.bucket.cmekSettings\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservices.bucket.cmekSettings\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ServiceAccountId accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketCmekSettings) ServiceAccountId() (string, error) {
	res, ok := s.Cache.Load("serviceAccountId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservices.bucket.cmekSettings\" failed: no value provided for static field \"serviceAccountId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservices.bucket.cmekSettings\" failed to cast field \"serviceAccountId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketCmekSettings) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservices.bucket.cmekSettings].Compute")
	switch name {
	case "id":
		return nil
	case "kmsKeyName":
...
// GcpProjectLoggingservicesBucketIndexConfig resource interface
type GcpProjectLoggingservicesBucketIndexConfig interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcpProjectLoggingservicesBucketIndexConfig for the gcp.project.loggingservices.bucket.indexConfig resource
type mqlGcpProjectLoggingservicesBucketIndexConfig struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectLoggingservicesBucketIndexConfig) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.loggingservices.bucket.indexConfig resource
func newGcpProjectLoggingservicesBucketIndexConfig(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectLoggingservicesBucketIndexConfig{runtime.NewResource("gcp.project.loggingservices.bucket.indexConfig")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket.indexConfig\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "created":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket.indexConfig\", its \"created\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "fieldPath":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket.indexConfig\", its \"fieldPath\" argument has the wrong type (expected type \"string\")")
			}
		case "type":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket.indexConfig\", its \"type\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservices.bucket.indexConfig\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.loggingservices.bucket.indexConfig with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectLoggingservicesBucketIndexConfig) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket.indexConfig\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("created"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket.indexConfig\" resource without a \"created\". This field is required.")
	}
	if _, ok := s.Cache.Load("fieldPath"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket.indexConfig\" resource without a \"fieldPath\". This field is required.")
	}
	if _, ok := s.Cache.Load("type"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservices.bucket.indexConfig\" resource without a \"type\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketIndexConfig) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservices.bucket.indexConfig].Register")
	switch name {
	case "id":
		return nil
	case "created":
	...
	case "type":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.loggingservices.bucket.indexConfig\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketIndexConfig) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservices.bucket.indexConfig].Field")
	switch name {
	case "id":
		return s.Id()
	case "created":
	...
	case "type":
		return s.Type()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.loggingservices.bucket.indexConfig\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketIndexConfig) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservices.bucket.indexConfig\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservices.bucket.indexConfig\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Created accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketIndexConfig) Created() (*time.Time, error) {
	res, ok := s.Cache.Load("created")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.loggingservices.bucket.indexConfig\" failed: no value provided for static field \"created\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.loggingservices.bucket.indexConfig\" failed to cast field \"created\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// FieldPath accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketIndexConfig) FieldPath() (string, error) {
	res, ok := s.Cache.Load("fieldPath")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservices.bucket.indexConfig\" failed: no value provided for static field \"fieldPath\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservices.bucket.indexConfig\" failed to cast field \"fieldPath\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Type accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketIndexConfig) Type() (string, error) {
	res, ok := s.Cache.Load("type")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservices.bucket.indexConfig\" failed: no value provided for static field \"type\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservices.bucket.indexConfig\" failed to cast field \"type\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectLoggingservicesBucketIndexConfig) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservices.bucket.indexConfig].Compute")
	switch name {
	case "id":
		return nil
	case "created":
