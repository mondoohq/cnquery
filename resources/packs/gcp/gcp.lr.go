...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("gcp.project.kmsservices", newGcpProjectKmsservices)
	registry.AddFactory("gcp.project.kmsservices.keyring", newGcpProjectKmsservicesKeyring)
	registry.AddFactory("gcp.project.kmsservices.keyring.cryptokey", newGcpProjectKmsservicesKeyringCryptokey)
	registry.AddFactory("gcp.project.kmsservices.keyring.cryptokey.version", newGcpProjectKmsservicesKeyringCryptokeyVersion)
	registry.AddFactory("gcp.project.kmsservices.keyring.cryptokey.version.attestation", newGcpProjectKmsservicesKeyringCryptokeyVersionAttestation)
	registry.AddFactory("gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains", newGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains)
	registry.AddFactory("gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions", newGcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions)
}
...
type GcpProject interface {
	...
	Kms() (GcpProjectKmsservices, error)
}
...
func newGcpProject(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "kms":
			if _, ok := val.(GcpProjectKmsservices); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project\", its \"kms\" argument has the wrong type (expected type \"GcpProjectKmsservices\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
func (s *mqlGcpProject) Kms() (GcpProjectKmsservices, error) {
	...
	tres, ok := res.Data.(GcpProjectKmsservices)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project\" failed to cast field \"kms\" to the right type (GcpProjectKmsservices): %#v", res)
	}
	return tres, nil
}
...
// GcpProjectKmsservices resource interface
type GcpProjectKmsservices interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcpProjectKmsservices for the gcp.project.kmsservices resource
type mqlGcpProjectKmsservices struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectKmsservices) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.kmsservices resource
func newGcpProjectKmsservices(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectKmsservices{runtime.NewResource("gcp.project.kmsservices")}
	var existing GcpProjectKmsservices
	args, existing, err = res.init(args)
	if err != nil {
		return nil, err
	}
	...
	for name, val := range *args {
		...
		case "projectId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices\", its \"projectId\" argument has the wrong type (expected type \"string\")")
			}
		case "locations":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices\", its \"locations\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "keyrings":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices\", its \"keyrings\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.kmsservices with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectKmsservices) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("projectId"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices\" resource without a \"projectId\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectKmsservices) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices].Register")
	switch name {
	case "projectId":
		return nil
	case "locations":
	...
	case "keyrings":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.kmsservices\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectKmsservices) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices].Field")
	switch name {
	case "projectId":
		return s.ProjectId()
	case "locations":
	...
	case "keyrings":
		return s.Keyrings()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.kmsservices\" resource")
	}
}

// ProjectId accessor autogenerated
func (s *mqlGcpProjectKmsservices) ProjectId() (string, error) {
	res, ok := s.Cache.Load("projectId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices\" failed: no value provided for static field \"projectId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices\" failed to cast field \"projectId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Locations accessor autogenerated
func (s *mqlGcpProjectKmsservices) Locations() ([]interface{}, error) {
	res, ok := s.Cache.Load("locations")
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("locations")
		if !ok {
			return nil, errors.New("\"gcp.project.kmsservices\" calculated \"locations\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices\" failed to cast field \"locations\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Keyrings accessor autogenerated
func (s *mqlGcpProjectKmsservices) Keyrings() ([]interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("keyrings")
		if !ok {
			return nil, errors.New("\"gcp.project.kmsservices\" calculated \"keyrings\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices\" failed to cast field \"keyrings\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectKmsservices) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices].Compute")
	switch name {
	case "projectId":
		return nil
	case "locations":
...
func (s *mqlGcpProjectKmsservices) ComputeLocations() error {
	var err error
	if _, ok := s.Cache.Load("locations"); ok {
		return nil
	}
...
func (s *mqlGcpProjectKmsservices) ComputeKeyrings() error {
	var err error
...
// GcpProjectKmsservicesKeyring resource interface
type GcpProjectKmsservicesKeyring interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcpProjectKmsservicesKeyring for the gcp.project.kmsservices.keyring resource
type mqlGcpProjectKmsservicesKeyring struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectKmsservicesKeyring) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.kmsservices.keyring resource
func newGcpProjectKmsservicesKeyring(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectKmsservicesKeyring{runtime.NewResource("gcp.project.kmsservices.keyring")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "projectId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring\", its \"projectId\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "created":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring\", its \"created\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "location":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring\", its \"location\" argument has the wrong type (expected type \"string\")")
			}
		case "cryptokeys":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring\", its \"cryptokeys\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.kmsservices.keyring with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectKmsservicesKeyring) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("projectId"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring\" resource without a \"projectId\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("created"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring\" resource without a \"created\". This field is required.")
	}
	if _, ok := s.Cache.Load("location"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring\" resource without a \"location\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyring) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring].Register")
	switch name {
	case "id":
		return nil
	case "projectId":
	...
	case "cryptokeys":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.kmsservices.keyring\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyring) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring].Field")
	switch name {
	case "id":
		return s.Id()
	case "projectId":
	...
	case "cryptokeys":
		return s.Cryptokeys()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.kmsservices.keyring\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyring) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ProjectId accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyring) ProjectId() (string, error) {
	res, ok := s.Cache.Load("projectId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring\" failed: no value provided for static field \"projectId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring\" failed to cast field \"projectId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyring) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Created accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyring) Created() (*time.Time, error) {
	res, ok := s.Cache.Load("created")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.kmsservices.keyring\" failed: no value provided for static field \"created\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring\" failed to cast field \"created\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Location accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyring) Location() (string, error) {
	res, ok := s.Cache.Load("location")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring\" failed: no value provided for static field \"location\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring\" failed to cast field \"location\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Cryptokeys accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyring) Cryptokeys() ([]interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("cryptokeys")
		if !ok {
			return nil, errors.New("\"gcp.project.kmsservices.keyring\" calculated \"cryptokeys\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring\" failed to cast field \"cryptokeys\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyring) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring].Compute")
	switch name {
	case "id":
		return nil
	case "projectId":
...
func (s *mqlGcpProjectKmsservicesKeyring) ComputeCryptokeys() error {
	var err error
...
// GcpProjectKmsservicesKeyringCryptokey resource interface
type GcpProjectKmsservicesKeyringCryptokey interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
	...
	Id() (string, error)
	Name() (string, error)
	Primary() (GcpProjectKmsservicesKeyringCryptokeyVersion, error)
	Purpose() (string, error)
	Versions() ([]interface{}, error)
}

// mqlGcpProjectKmsservicesKeyringCryptokey for the gcp.project.kmsservices.keyring.cryptokey resource
type mqlGcpProjectKmsservicesKeyringCryptokey struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectKmsservicesKeyringCryptokey) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.kmsservices.keyring.cryptokey resource
func newGcpProjectKmsservicesKeyringCryptokey(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectKmsservicesKeyringCryptokey{runtime.NewResource("gcp.project.kmsservices.keyring.cryptokey")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "primary":
			if _, ok := val.(GcpProjectKmsservicesKeyringCryptokeyVersion); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey\", its \"primary\" argument has the wrong type (expected type \"GcpProjectKmsservicesKeyringCryptokeyVersion\")")
			}
		case "purpose":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey\", its \"purpose\" argument has the wrong type (expected type \"string\")")
			}
		case "versions":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey\", its \"versions\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.kmsservices.keyring.cryptokey with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectKmsservicesKeyringCryptokey) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("primary"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey\" resource without a \"primary\". This field is required.")
	}
	if _, ok := s.Cache.Load("purpose"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey\" resource without a \"purpose\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokey) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey].Register")
	switch name {
	case "id":
		return nil
	case "name":
	...
	case "versions":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.kmsservices.keyring.cryptokey\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokey) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey].Field")
	switch name {
	case "id":
		return s.Id()
	case "name":
	...
	case "versions":
		return s.Versions()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.kmsservices.keyring.cryptokey\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokey) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokey) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Primary accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokey) Primary() (GcpProjectKmsservicesKeyringCryptokeyVersion, error) {
	res, ok := s.Cache.Load("primary")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.kmsservices.keyring.cryptokey\" failed: no value provided for static field \"primary\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(GcpProjectKmsservicesKeyringCryptokeyVersion)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey\" failed to cast field \"primary\" to the right type (GcpProjectKmsservicesKeyringCryptokeyVersion): %#v", res)
	}
	return tres, nil
}

// Purpose accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokey) Purpose() (string, error) {
	res, ok := s.Cache.Load("purpose")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey\" failed: no value provided for static field \"purpose\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey\" failed to cast field \"purpose\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Versions accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokey) Versions() ([]interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("versions")
		if !ok {
			return nil, errors.New("\"gcp.project.kmsservices.keyring.cryptokey\" calculated \"versions\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey\" failed to cast field \"versions\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokey) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey].Compute")
	switch name {
	case "id":
		return nil
	case "name":
...
func (s *mqlGcpProjectKmsservicesKeyringCryptokey) ComputeVersions() error {
	var err error
...
// GcpProjectKmsservicesKeyringCryptokeyVersion resource interface
type GcpProjectKmsservicesKeyringCryptokeyVersion interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
	...
	Attestation() (GcpProjectKmsservicesKeyringCryptokeyVersionAttestation, error)
	Created() (*time.Time, error)
	...
	ExternalProtectionLevelOptions() (GcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions, error)
	ReimportEligible() (bool, error)
}

// mqlGcpProjectKmsservicesKeyringCryptokeyVersion for the gcp.project.kmsservices.keyring.cryptokey.version resource
type mqlGcpProjectKmsservicesKeyringCryptokeyVersion struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.kmsservices.keyring.cryptokey.version resource
func newGcpProjectKmsservicesKeyringCryptokeyVersion(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectKmsservicesKeyringCryptokeyVersion{runtime.NewResource("gcp.project.kmsservices.keyring.cryptokey.version")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "state":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"state\" argument has the wrong type (expected type \"string\")")
			}
		case "protectionLevel":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"protectionLevel\" argument has the wrong type (expected type \"string\")")
			}
		case "algorithm":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"algorithm\" argument has the wrong type (expected type \"string\")")
			}
		case "attestation":
			if _, ok := val.(GcpProjectKmsservicesKeyringCryptokeyVersionAttestation); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"attestation\" argument has the wrong type (expected type \"GcpProjectKmsservicesKeyringCryptokeyVersionAttestation\")")
			}
		case "created":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"created\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "generated":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"generated\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "destroyed":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"destroyed\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "destroyEventTime":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"destroyEventTime\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "importJob":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"importJob\" argument has the wrong type (expected type \"string\")")
			}
		case "importTime":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"importTime\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "importFailureReason":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"importFailureReason\" argument has the wrong type (expected type \"string\")")
			}
		case "externalProtectionLevelOptions":
			if _, ok := val.(GcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"externalProtectionLevelOptions\" argument has the wrong type (expected type \"GcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions\")")
			}
		case "reimportEligible":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"reimportEligible\" argument has the wrong type (expected type \"bool\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.kmsservices.keyring.cryptokey.version with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("state"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"state\". This field is required.")
	}
	if _, ok := s.Cache.Load("protectionLevel"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"protectionLevel\". This field is required.")
	}
	if _, ok := s.Cache.Load("algorithm"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"algorithm\". This field is required.")
	}
	if _, ok := s.Cache.Load("attestation"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"attestation\". This field is required.")
	}
	if _, ok := s.Cache.Load("created"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"created\". This field is required.")
	}
	if _, ok := s.Cache.Load("generated"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"generated\". This field is required.")
	}
	if _, ok := s.Cache.Load("destroyed"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"destroyed\". This field is required.")
	}
	if _, ok := s.Cache.Load("destroyEventTime"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"destroyEventTime\". This field is required.")
	}
	if _, ok := s.Cache.Load("importJob"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"importJob\". This field is required.")
	}
	if _, ok := s.Cache.Load("importTime"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"importTime\". This field is required.")
	}
	if _, ok := s.Cache.Load("importFailureReason"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"importFailureReason\". This field is required.")
	}
	if _, ok := s.Cache.Load("externalProtectionLevelOptions"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"externalProtectionLevelOptions\". This field is required.")
	}
	if _, ok := s.Cache.Load("reimportEligible"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version\" resource without a \"reimportEligible\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey.version].Register")
	switch name {
	case "id":
		return nil
	case "name":
	...
	case "reimportEligible":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.kmsservices.keyring.cryptokey.version\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey.version].Field")
	switch name {
	case "id":
		return s.Id()
	case "name":
	...
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.kmsservices.keyring.cryptokey.version\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// State accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) State() (string, error) {
	res, ok := s.Cache.Load("state")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"state\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"state\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ProtectionLevel accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) ProtectionLevel() (string, error) {
	res, ok := s.Cache.Load("protectionLevel")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"protectionLevel\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"protectionLevel\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Algorithm accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) Algorithm() (string, error) {
	res, ok := s.Cache.Load("algorithm")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"algorithm\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"algorithm\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Attestation accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) Attestation() (GcpProjectKmsservicesKeyringCryptokeyVersionAttestation, error) {
	res, ok := s.Cache.Load("attestation")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"attestation\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(GcpProjectKmsservicesKeyringCryptokeyVersionAttestation)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"attestation\" to the right type (GcpProjectKmsservicesKeyringCryptokeyVersionAttestation): %#v", res)
	}
	return tres, nil
}

// Created accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) Created() (*time.Time, error) {
	res, ok := s.Cache.Load("created")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"created\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"created\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Generated accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) Generated() (*time.Time, error) {
	res, ok := s.Cache.Load("generated")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"generated\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"generated\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Destroyed accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) Destroyed() (*time.Time, error) {
	res, ok := s.Cache.Load("destroyed")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"destroyed\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"destroyed\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// DestroyEventTime accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) DestroyEventTime() (*time.Time, error) {
	res, ok := s.Cache.Load("destroyEventTime")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"destroyEventTime\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"destroyEventTime\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// ImportJob accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) ImportJob() (string, error) {
	res, ok := s.Cache.Load("importJob")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"importJob\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"importJob\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ImportTime accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) ImportTime() (*time.Time, error) {
	res, ok := s.Cache.Load("importTime")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"importTime\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"importTime\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// ImportFailureReason accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) ImportFailureReason() (string, error) {
	res, ok := s.Cache.Load("importFailureReason")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"importFailureReason\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"importFailureReason\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ExternalProtectionLevelOptions accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) ExternalProtectionLevelOptions() (GcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions, error) {
	res, ok := s.Cache.Load("externalProtectionLevelOptions")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"externalProtectionLevelOptions\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(GcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"externalProtectionLevelOptions\" to the right type (GcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions): %#v", res)
	}
	return tres, nil
}

// ReimportEligible accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) ReimportEligible() (bool, error) {
	res, ok := s.Cache.Load("reimportEligible")
	if !ok || !res.Valid {
		return false, errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed: no value provided for static field \"reimportEligible\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version\" failed to cast field \"reimportEligible\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersion) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey.version].Compute")
	switch name {
	case "id":
		return nil
	case "name":
...
// GcpProjectKmsservicesKeyringCryptokeyVersionAttestation resource interface
type GcpProjectKmsservicesKeyringCryptokeyVersionAttestation interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
	...
	Id() (string, error)
	Format() (string, error)
	CertificateChains() (GcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains, error)
}

// mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestation for the gcp.project.kmsservices.keyring.cryptokey.version.attestation resource
type mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestation struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestation) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.kmsservices.keyring.cryptokey.version.attestation resource
func newGcpProjectKmsservicesKeyringCryptokeyVersionAttestation(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestation{runtime.NewResource("gcp.project.kmsservices.keyring.cryptokey.version.attestation")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version.attestation\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "format":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version.attestation\", its \"format\" argument has the wrong type (expected type \"string\")")
			}
		case "certificateChains":
			if _, ok := val.(GcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version.attestation\", its \"certificateChains\" argument has the wrong type (expected type \"GcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version.attestation\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.kmsservices.keyring.cryptokey.version.attestation with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestation) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version.attestation\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("format"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version.attestation\" resource without a \"format\". This field is required.")
	}
	if _, ok := s.Cache.Load("certificateChains"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version.attestation\" resource without a \"certificateChains\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestation) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey.version.attestation].Register")
	switch name {
	case "id":
		return nil
	case "format":
	...
	case "certificateChains":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.kmsservices.keyring.cryptokey.version.attestation\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestation) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey.version.attestation].Field")
	switch name {
	case "id":
		return s.Id()
	case "format":
	...
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.kmsservices.keyring.cryptokey.version.attestation\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestation) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Format accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestation) Format() (string, error) {
	res, ok := s.Cache.Load("format")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation\" failed: no value provided for static field \"format\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation\" failed to cast field \"format\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// CertificateChains accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestation) CertificateChains() (GcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains, error) {
	res, ok := s.Cache.Load("certificateChains")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation\" failed: no value provided for static field \"certificateChains\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(GcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation\" failed to cast field \"certificateChains\" to the right type (GcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestation) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey.version.attestation].Compute")
	switch name {
	case "id":
		return nil
	case "format":
...
// GcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains resource interface
type GcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains for the gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains resource
type mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains resource
func newGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains{runtime.NewResource("gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "caviumCerts":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\", its \"caviumCerts\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "googleCardCerts":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\", its \"googleCardCerts\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "googlePartitionCerts":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\", its \"googlePartitionCerts\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("caviumCerts"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" resource without a \"caviumCerts\". This field is required.")
	}
	if _, ok := s.Cache.Load("googleCardCerts"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" resource without a \"googleCardCerts\". This field is required.")
	}
	if _, ok := s.Cache.Load("googlePartitionCerts"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" resource without a \"googlePartitionCerts\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains].Register")
	switch name {
	case "id":
		return nil
	case "caviumCerts":
	...
	case "googlePartitionCerts":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains].Field")
	switch name {
	case "id":
		return s.Id()
	case "caviumCerts":
	...
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// CaviumCerts accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains) CaviumCerts() ([]interface{}, error) {
	res, ok := s.Cache.Load("caviumCerts")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" failed: no value provided for static field \"caviumCerts\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" failed to cast field \"caviumCerts\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// GoogleCardCerts accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains) GoogleCardCerts() ([]interface{}, error) {
	res, ok := s.Cache.Load("googleCardCerts")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" failed: no value provided for static field \"googleCardCerts\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" failed to cast field \"googleCardCerts\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// GooglePartitionCerts accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains) GooglePartitionCerts() ([]interface{}, error) {
	res, ok := s.Cache.Load("googlePartitionCerts")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" failed: no value provided for static field \"googlePartitionCerts\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains\" failed to cast field \"googlePartitionCerts\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionAttestationCertificatechains) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey.version.attestation.certificatechains].Compute")
	switch name {
	case "id":
		return nil
	case "caviumCerts":
...
// GcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions resource interface
type GcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions for the gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions resource
type mqlGcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions resource
func newGcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions{runtime.NewResource("gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "externalKeyUri":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\", its \"externalKeyUri\" argument has the wrong type (expected type \"string\")")
			}
		case "ekmConnectionKeyPath":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\", its \"ekmConnectionKeyPath\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("externalKeyUri"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\" resource without a \"externalKeyUri\". This field is required.")
	}
	if _, ok := s.Cache.Load("ekmConnectionKeyPath"); !ok {
		return errors.New("Initialized \"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\" resource without a \"ekmConnectionKeyPath\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions].Register")
	switch name {
	case "id":
		return nil
	case "externalKeyUri":
	...
	case "ekmConnectionKeyPath":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions].Field")
	switch name {
	case "id":
		return s.Id()
	case "externalKeyUri":
	...
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ExternalKeyUri accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions) ExternalKeyUri() (string, error) {
	res, ok := s.Cache.Load("externalKeyUri")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\" failed: no value provided for static field \"externalKeyUri\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\" failed to cast field \"externalKeyUri\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// EkmConnectionKeyPath accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions) EkmConnectionKeyPath() (string, error) {
	res, ok := s.Cache.Load("ekmConnectionKeyPath")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\" failed: no value provided for static field \"ekmConnectionKeyPath\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions\" failed to cast field \"ekmConnectionKeyPath\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectKmsservicesKeyringCryptokeyVersionExternalProtectionLevelOptions) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.kmsservices.keyring.cryptokey.version.externalProtectionLevelOptions].Compute")
	switch name {
	case "id":
		return nil
	case "externalKeyUri":
