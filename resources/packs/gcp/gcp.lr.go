...
// Compute accessor autogenerated
func (s *mqlGcpSql) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.sql].MqlCompute")
	switch name {
	case "instances":
		return s.ComputeInstances()
	default:
...
// Compute accessor autogenerated
func (s *mqlGcpSqlInstance) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.sql.instance].MqlCompute")
	switch name {
	case "name":
		return nil
	case "backendType":
