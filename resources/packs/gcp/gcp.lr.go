...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("gcp.contact", newGcpContact)
}
...
func newGcpProject(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "contacts":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project\", its \"contacts\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
// Contacts accessor autogenerated
func (s *mqlGcpProject) Contacts() ([]interface{}, error) {
	res, ok := s.Cache.Load("contacts")
	if !ok || !res.Valid {
		if err := s.ComputeContacts(); err != nil {
			return nil, err
		}
		res, ok = s.Cache.Load("contacts")
		if !ok {
			return nil, errors.New("\"gcp.project\" calculated \"contacts\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "contacts")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.project\" failed to cast field \"contacts\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}
...
// ComputeContacts computer autogenerated
func (s *mqlGcpProject) ComputeContacts() error {
	var err error
	if _, ok := s.Cache.Load("contacts"); ok {
		return nil
	}
	vres, err := s.GetContacts()
	if _, ok := err.(resources.NotReadyError); ok {
		return err
	}
	s.Cache.Store("contacts", &resources.CacheEntry{Data: vres, Valid: true, Error: err, Timestamp: time.Now().Unix()})
	return nil
}
...
// GcpContact resource interface
type GcpContact interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcpContact for the gcp.contact resource
type mqlGcpContact struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpContact) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.contact resource
func newGcpContact(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpContact{runtime.NewResource("gcp.contact")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "resourcePath":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.contact\", its \"resourcePath\" argument has the wrong type (expected type \"string\")")
			}
		case "email":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.contact\", its \"email\" argument has the wrong type (expected type \"string\")")
			}
		case "languageTag":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.contact\", its \"languageTag\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.contact\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "notificationCategorySubscriptions":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.contact\", its \"notificationCategorySubscriptions\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "validated":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcp.contact\", its \"validated\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "validationState":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.contact\", its \"validationState\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.contact\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.contact with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpContact) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("resourcePath"); !ok {
		return errors.New("Initialized \"gcp.contact\" resource without a \"resourcePath\". This field is required.")
	}
	if _, ok := s.Cache.Load("email"); !ok {
		return errors.New("Initialized \"gcp.contact\" resource without a \"email\". This field is required.")
	}
	if _, ok := s.Cache.Load("languageTag"); !ok {
		return errors.New("Initialized \"gcp.contact\" resource without a \"languageTag\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"gcp.contact\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("notificationCategorySubscriptions"); !ok {
		return errors.New("Initialized \"gcp.contact\" resource without a \"notificationCategorySubscriptions\". This field is required.")
	}
	if _, ok := s.Cache.Load("validated"); !ok {
		return errors.New("Initialized \"gcp.contact\" resource without a \"validated\". This field is required.")
	}
	if _, ok := s.Cache.Load("validationState"); !ok {
		return errors.New("Initialized \"gcp.contact\" resource without a \"validationState\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpContact) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.contact].Register")
	switch name {
	case "resourcePath":
		return nil
	case "email":
	...
	case "validationState":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.contact\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpContact) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.contact].Field")
	switch name {
	case "resourcePath":
		return s.ResourcePath()
	case "email":
	...
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.contact\" resource")
	}
}

// ResourcePath accessor autogenerated
func (s *mqlGcpContact) ResourcePath() (string, error) {
	res, ok := s.Cache.Load("resourcePath")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.contact\" failed: no value provided for static field \"resourcePath\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.contact\" failed to cast field \"resourcePath\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Email accessor autogenerated
func (s *mqlGcpContact) Email() (string, error) {
	res, ok := s.Cache.Load("email")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.contact\" failed: no value provided for static field \"email\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.contact\" failed to cast field \"email\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// LanguageTag accessor autogenerated
func (s *mqlGcpContact) LanguageTag() (string, error) {
	res, ok := s.Cache.Load("languageTag")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.contact\" failed: no value provided for static field \"languageTag\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.contact\" failed to cast field \"languageTag\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlGcpContact) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.contact\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.contact\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// NotificationCategorySubscriptions accessor autogenerated
func (s *mqlGcpContact) NotificationCategorySubscriptions() ([]interface{}, error) {
	res, ok := s.Cache.Load("notificationCategorySubscriptions")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.contact\" failed: no value provided for static field \"notificationCategorySubscriptions\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.contact\" failed to cast field \"notificationCategorySubscriptions\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Validated accessor autogenerated
func (s *mqlGcpContact) Validated() (*time.Time, error) {
	res, ok := s.Cache.Load("validated")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.contact\" failed: no value provided for static field \"validated\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcp.contact\" failed to cast field \"validated\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// ValidationState accessor autogenerated
func (s *mqlGcpContact) ValidationState() (string, error) {
	res, ok := s.Cache.Load("validationState")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.contact\" failed: no value provided for static field \"validationState\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.contact\" failed to cast field \"validationState\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpContact) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.contact].Compute")
	switch name {
	case "resourcePath":
		return nil
	case "email":
