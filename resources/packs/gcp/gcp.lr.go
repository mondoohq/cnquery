...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("gcp.project.loggingservice.bucket.cmekSettings", newGcpProjectLoggingserviceBucketCmekSettings)
...
// Compute accessor autogenerated
func (s *mqlGcpProjectLoggingservice) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservice].Compute")
	switch name {
	case "projectId":
		return nil
	case "buckets":
...
type GcpProjectLoggingserviceBucket interface {
	...
	Validate() error
	ProjectId() (string, error)
	CmekSettings() (GcpProjectLoggingserviceBucketCmekSettings, error)
	Created() (*time.Time, error)
	Description() (string, error)
...
func newGcpProjectLoggingserviceBucket(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "cmekSettings":
			if _, ok := val.(GcpProjectLoggingserviceBucketCmekSettings); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservice.bucket\", its \"cmekSettings\" argument has the wrong type (expected type \"GcpProjectLoggingserviceBucketCmekSettings\")")
			}
		case "created":
			if _, ok := val.(*time.Time); !ok {
...
func (s *mqlGcpProjectLoggingserviceBucket) CmekSettings() (GcpProjectLoggingserviceBucketCmekSettings, error) {
	...
	tres, ok := res.Data.(GcpProjectLoggingserviceBucketCmekSettings)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.loggingservice.bucket\" failed to cast field \"cmekSettings\" to the right type (GcpProjectLoggingserviceBucketCmekSettings): %#v", res)
	}
	return tres, nil
}
...
// Compute accessor autogenerated
func (s *mqlGcpProjectLoggingserviceBucket) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservice.bucket].Compute")
	switch name {
	case "projectId":
		return nil
	case "cmekSettings":
...
// GcpProjectLoggingserviceBucketCmekSettings resource interface
type GcpProjectLoggingserviceBucketCmekSettings interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcpProjectLoggingserviceBucketCmekSettings for the gcp.project.loggingservice.bucket.cmekSettings resource
type mqlGcpProjectLoggingserviceBucketCmekSettings struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectLoggingserviceBucketCmekSettings) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.loggingservice.bucket.cmekSettings resource
func newGcpProjectLoggingserviceBucketCmekSettings(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectLoggingserviceBucketCmekSettings{runtime.NewResource("gcp.project.loggingservice.bucket.cmekSettings")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "projectId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservice.bucket.cmekSettings\", its \"projectId\" argument has the wrong type (expected type \"string\")")
			}
		case "bucketName":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservice.bucket.cmekSettings\", its \"bucketName\" argument has the wrong type (expected type \"string\")")
			}
		case "kmsKeyName":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservice.bucket.cmekSettings\", its \"kmsKeyName\" argument has the wrong type (expected type \"string\")")
			}
		case "kmsKeyVersionName":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservice.bucket.cmekSettings\", its \"kmsKeyVersionName\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservice.bucket.cmekSettings\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "serviceAccountId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservice.bucket.cmekSettings\", its \"serviceAccountId\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.loggingservice.bucket.cmekSettings\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.loggingservice.bucket.cmekSettings with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectLoggingserviceBucketCmekSettings) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("projectId"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservice.bucket.cmekSettings\" resource without a \"projectId\". This field is required.")
	}
	if _, ok := s.Cache.Load("bucketName"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservice.bucket.cmekSettings\" resource without a \"bucketName\". This field is required.")
	}
	if _, ok := s.Cache.Load("kmsKeyName"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservice.bucket.cmekSettings\" resource without a \"kmsKeyName\". This field is required.")
	}
	if _, ok := s.Cache.Load("kmsKeyVersionName"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservice.bucket.cmekSettings\" resource without a \"kmsKeyVersionName\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservice.bucket.cmekSettings\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("serviceAccountId"); !ok {
		return errors.New("Initialized \"gcp.project.loggingservice.bucket.cmekSettings\" resource without a \"serviceAccountId\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectLoggingserviceBucketCmekSettings) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservice.bucket.cmekSettings].Register")
	switch name {
	case "projectId":
		return nil
	case "bucketName":
	...
	case "serviceAccountId":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.loggingservice.bucket.cmekSettings\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectLoggingserviceBucketCmekSettings) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservice.bucket.cmekSettings].Field")
	switch name {
	case "projectId":
		return s.ProjectId()
	case "bucketName":
	...
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.loggingservice.bucket.cmekSettings\" resource")
	}
}

// ProjectId accessor autogenerated
func (s *mqlGcpProjectLoggingserviceBucketCmekSettings) ProjectId() (string, error) {
	res, ok := s.Cache.Load("projectId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservice.bucket.cmekSettings\" failed: no value provided for static field \"projectId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservice.bucket.cmekSettings\" failed to cast field \"projectId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// BucketName accessor autogenerated
func (s *mqlGcpProjectLoggingserviceBucketCmekSettings) BucketName() (string, error) {
	res, ok := s.Cache.Load("bucketName")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservice.bucket.cmekSettings\" failed: no value provided for static field \"bucketName\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservice.bucket.cmekSettings\" failed to cast field \"bucketName\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// KmsKeyName accessor autogenerated
func (s *mqlGcpProjectLoggingserviceBucketCmekSettings) KmsKeyName() (string, error) {
	res, ok := s.Cache.Load("kmsKeyName")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservice.bucket.cmekSettings\" failed: no value provided for static field \"kmsKeyName\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservice.bucket.cmekSettings\" failed to cast field \"kmsKeyName\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// KmsKeyVersionName accessor autogenerated
func (s *mqlGcpProjectLoggingserviceBucketCmekSettings) KmsKeyVersionName() (string, error) {
	res, ok := s.Cache.Load("kmsKeyVersionName")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservice.bucket.cmekSettings\" failed: no value provided for static field \"kmsKeyVersionName\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservice.bucket.cmekSettings\" failed to cast field \"kmsKeyVersionName\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlGcpProjectLoggingserviceBucketCmekSettings) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservice.bucket.cmekSettings\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservice.bucket.cmekSettings\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ServiceAccountId accessor autogenerated
func (s *mqlGcpProjectLoggingserviceBucketCmekSettings) ServiceAccountId() (string, error) {
	res, ok := s.Cache.Load("serviceAccountId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.loggingservice.bucket.cmekSettings\" failed: no value provided for static field \"serviceAccountId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.loggingservice.bucket.cmekSettings\" failed to cast field \"serviceAccountId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectLoggingserviceBucketCmekSettings) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservice.bucket.cmekSettings].Compute")
	switch name {
	case "projectId":
		return nil
	case "bucketName":
...
// Compute accessor autogenerated
func (s *mqlGcpProjectLoggingserviceBucketIndexConfig) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.loggingservice.bucket.indexConfig].Compute")
	switch name {
	case "id":
		return nil
	case "created":
