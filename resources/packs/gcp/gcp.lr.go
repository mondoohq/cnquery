...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("gcp.project.pubsub.snapshot", newGcpProjectPubsubSnapshot)
}
...
func newGcpProjectPubsub(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "snapshots":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.pubsub\", its \"snapshots\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
// Snapshots accessor autogenerated
func (s *mqlGcpProjectPubsub) Snapshots() ([]interface{}, error) {
	res, ok := s.Cache.Load("snapshots")
	if !ok || !res.Valid {
		if err := s.ComputeSnapshots(); err != nil {
			return nil, err
		...
		res, ok = s.Cache.Load("snapshots")
		if !ok {
			return nil, errors.New("\"gcp.project.pubsub\" calculated \"snapshots\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "snapshots")
	}
	if res.Error != nil {
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.pubsub\" failed to cast field \"snapshots\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}
...
// ComputeSnapshots computer autogenerated
func (s *mqlGcpProjectPubsub) ComputeSnapshots() error {
	var err error
	if _, ok := s.Cache.Load("snapshots"); ok {
		return nil
	}
...
// GcpProjectPubsubSnapshot resource interface
type GcpProjectPubsubSnapshot interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcpProjectPubsubSnapshot for the gcp.project.pubsub.snapshot resource
type mqlGcpProjectPubsubSnapshot struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcpProjectPubsubSnapshot) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcp.project.pubsub.snapshot resource
func newGcpProjectPubsubSnapshot(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcpProjectPubsubSnapshot{runtime.NewResource("gcp.project.pubsub.snapshot")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.pubsub.snapshot\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "projectId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.pubsub.snapshot\", its \"projectId\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.pubsub.snapshot\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "topic":
			if _, ok := val.(GcpProjectPubsubTopic); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.pubsub.snapshot\", its \"topic\" argument has the wrong type (expected type \"GcpProjectPubsubTopic\")")
			}
		case "expiration":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.pubsub.snapshot\", its \"expiration\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcp.project.pubsub.snapshot\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcp.project.pubsub.snapshot with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcpProjectPubsubSnapshot) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcp.project.pubsub.snapshot\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("projectId"); !ok {
		return errors.New("Initialized \"gcp.project.pubsub.snapshot\" resource without a \"projectId\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"gcp.project.pubsub.snapshot\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("topic"); !ok {
		return errors.New("Initialized \"gcp.project.pubsub.snapshot\" resource without a \"topic\". This field is required.")
	}
	if _, ok := s.Cache.Load("expiration"); !ok {
		return errors.New("Initialized \"gcp.project.pubsub.snapshot\" resource without a \"expiration\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcpProjectPubsubSnapshot) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.pubsub.snapshot].Register")
	switch name {
	case "id":
		return nil
	case "projectId":
	...
	case "expiration":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcp.project.pubsub.snapshot\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcpProjectPubsubSnapshot) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcp.project.pubsub.snapshot].Field")
	switch name {
	case "id":
		return s.Id()
	case "projectId":
	...
	case "expiration":
		return s.Expiration()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcp.project.pubsub.snapshot\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcpProjectPubsubSnapshot) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.pubsub.snapshot\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.pubsub.snapshot\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ProjectId accessor autogenerated
func (s *mqlGcpProjectPubsubSnapshot) ProjectId() (string, error) {
	res, ok := s.Cache.Load("projectId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.pubsub.snapshot\" failed: no value provided for static field \"projectId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.pubsub.snapshot\" failed to cast field \"projectId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlGcpProjectPubsubSnapshot) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.project.pubsub.snapshot\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.project.pubsub.snapshot\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Topic accessor autogenerated
func (s *mqlGcpProjectPubsubSnapshot) Topic() (GcpProjectPubsubTopic, error) {
	res, ok := s.Cache.Load("topic")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.pubsub.snapshot\" failed: no value provided for static field \"topic\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(GcpProjectPubsubTopic)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.pubsub.snapshot\" failed to cast field \"topic\" to the right type (GcpProjectPubsubTopic): %#v", res)
	}
	return tres, nil
}

// Expiration accessor autogenerated
func (s *mqlGcpProjectPubsubSnapshot) Expiration() (*time.Time, error) {
	res, ok := s.Cache.Load("expiration")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.project.pubsub.snapshot\" failed: no value provided for static field \"expiration\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcp.project.pubsub.snapshot\" failed to cast field \"expiration\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcpProjectPubsubSnapshot) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.pubsub.snapshot].Compute")
	switch name {
	case "id":
		return nil
	case "projectId":
