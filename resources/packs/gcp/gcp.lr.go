...
// Compute accessor autogenerated
func (s *mqlGcpProjectDataprocServiceClusterMetrics) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcp.project.dataprocService.cluster.metrics].Compute")
	switch name {
	case "parentResourcePath":
		return nil
	default:
