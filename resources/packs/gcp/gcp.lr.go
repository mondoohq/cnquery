...
func newGcpComputeNetwork(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "subnetworkUrls":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcp.compute.network\", its \"subnetworkUrls\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "subnetworks":
			if _, ok := val.([]interface{}); !ok {
...
func (s *mqlGcpComputeNetwork) Validate() error {
	...
	if _, ok := s.Cache.Load("subnetworkUrls"); !ok {
		return errors.New("Initialized \"gcp.compute.network\" resource without a \"subnetworkUrls\". This field is required.")
	}
...
func (s *mqlGcpComputeNetwork) SubnetworkUrls() ([]interface{}, error) {
	res, ok := s.Cache.Load("subnetworkUrls")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcp.compute.network\" failed: no value provided for static field \"subnetworkUrls\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcp.compute.network\" failed to cast field \"subnetworkUrls\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}
...
func newGcpComputeSubnetwork(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "projectId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.compute.subnetwork\", its \"projectId\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
		...
		case "regionUrl":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcp.compute.subnetwork\", its \"regionUrl\" argument has the wrong type (expected type \"string\")")
			}
		case "role":
			if _, ok := val.(string); !ok {
...
func (s *mqlGcpComputeSubnetwork) Validate() error {
	...
	if _, ok := s.Cache.Load("projectId"); !ok {
		return errors.New("Initialized \"gcp.compute.subnetwork\" resource without a \"projectId\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
	...
	if _, ok := s.Cache.Load("regionUrl"); !ok {
		return errors.New("Initialized \"gcp.compute.subnetwork\" resource without a \"regionUrl\". This field is required.")
	}
	if _, ok := s.Cache.Load("role"); !ok {
...
// ProjectId accessor autogenerated
func (s *mqlGcpComputeSubnetwork) ProjectId() (string, error) {
	res, ok := s.Cache.Load("projectId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.compute.subnetwork\" failed: no value provided for static field \"projectId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.compute.subnetwork\" failed to cast field \"projectId\" to the right type (string): %#v", res)
	}
	return tres, nil
}
...
func (s *mqlGcpComputeSubnetwork) Region() (GcpComputeRegion, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("region")
		if !ok {
			return nil, errors.New("\"gcp.compute.subnetwork\" calculated \"region\" but didn't find its value in cache.")
		}
...
func (s *mqlGcpComputeSubnetwork) RegionUrl() (string, error) {
	res, ok := s.Cache.Load("regionUrl")
	if !ok || !res.Valid {
		return "", errors.New("\"gcp.compute.subnetwork\" failed: no value provided for static field \"regionUrl\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcp.compute.subnetwork\" failed to cast field \"regionUrl\" to the right type (string): %#v", res)
	}
	return tres, nil
}
...
func (s *mqlGcpComputeSubnetwork) ComputeRegion() error {
	var err error
