...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("gcloud.compute.disk", newGcloudComputeDisk)
	registry.AddFactory("gcloud.compute.zone", newGcloudComputeZone)
	...
	registry.AddFactory("gcloud.bigquery", newGcloudBigquery)
	registry.AddFactory("gcloud.bigquery.dataset", newGcloudBigqueryDataset)
	registry.AddFactory("gcloud.bigquery.table", newGcloudBigqueryTable)
	registry.AddFactory("gcloud.bigquery.model", newGcloudBigqueryModel)
	registry.AddFactory("gcloud.bigquery.routine", newGcloudBigqueryRoutine)
}
...
func newGcloudCompute(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "disks":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute\", its \"disks\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
func (s *mqlGcloudCompute) Disks() ([]interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("disks")
		if !ok {
			return nil, errors.New("\"gcloud.compute\" calculated \"disks\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcloud.compute\" failed to cast field \"disks\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}
...
func (s *mqlGcloudCompute) ComputeDisks() error {
	var err error
...
// GcloudComputeDisk resource interface
type GcloudComputeDisk interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
	...
	SizeGb() (int64, error)
	Status() (string, error)
	Zone() (GcloudComputeZone, error)
}

// mqlGcloudComputeDisk for the gcloud.compute.disk resource
type mqlGcloudComputeDisk struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcloudComputeDisk) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcloud.compute.disk resource
func newGcloudComputeDisk(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcloudComputeDisk{runtime.NewResource("gcloud.compute.disk")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.disk\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.disk\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "architecture":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.disk\", its \"architecture\" argument has the wrong type (expected type \"string\")")
			}
		case "description":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.disk\", its \"description\" argument has the wrong type (expected type \"string\")")
			}
		case "labels":
			if _, ok := val.(map[string]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.disk\", its \"labels\" argument has the wrong type (expected type \"map[string]interface{}\")")
			}
		case "locationHint":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.disk\", its \"locationHint\" argument has the wrong type (expected type \"string\")")
			}
		case "physicalBlockSizeBytes":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.disk\", its \"physicalBlockSizeBytes\" argument has the wrong type (expected type \"int64\")")
			}
		case "provisionedIops":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.disk\", its \"provisionedIops\" argument has the wrong type (expected type \"int64\")")
			}
		case "sizeGb":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.disk\", its \"sizeGb\" argument has the wrong type (expected type \"int64\")")
			}
		case "status":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.disk\", its \"status\" argument has the wrong type (expected type \"string\")")
			}
		case "zone":
			if _, ok := val.(GcloudComputeZone); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.disk\", its \"zone\" argument has the wrong type (expected type \"GcloudComputeZone\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.disk\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcloud.compute.disk with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcloudComputeDisk) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcloud.compute.disk\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"gcloud.compute.disk\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("architecture"); !ok {
		return errors.New("Initialized \"gcloud.compute.disk\" resource without a \"architecture\". This field is required.")
	}
	if _, ok := s.Cache.Load("description"); !ok {
		return errors.New("Initialized \"gcloud.compute.disk\" resource without a \"description\". This field is required.")
	}
	if _, ok := s.Cache.Load("labels"); !ok {
		return errors.New("Initialized \"gcloud.compute.disk\" resource without a \"labels\". This field is required.")
	}
	if _, ok := s.Cache.Load("locationHint"); !ok {
		return errors.New("Initialized \"gcloud.compute.disk\" resource without a \"locationHint\". This field is required.")
	}
	if _, ok := s.Cache.Load("physicalBlockSizeBytes"); !ok {
		return errors.New("Initialized \"gcloud.compute.disk\" resource without a \"physicalBlockSizeBytes\". This field is required.")
	}
	if _, ok := s.Cache.Load("provisionedIops"); !ok {
		return errors.New("Initialized \"gcloud.compute.disk\" resource without a \"provisionedIops\". This field is required.")
	}
	if _, ok := s.Cache.Load("sizeGb"); !ok {
		return errors.New("Initialized \"gcloud.compute.disk\" resource without a \"sizeGb\". This field is required.")
	}
	if _, ok := s.Cache.Load("status"); !ok {
		return errors.New("Initialized \"gcloud.compute.disk\" resource without a \"status\". This field is required.")
	}
	if _, ok := s.Cache.Load("zone"); !ok {
		return errors.New("Initialized \"gcloud.compute.disk\" resource without a \"zone\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcloudComputeDisk) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.compute.disk].Register")
	switch name {
	case "id":
		return nil
	case "name":
	...
	case "zone":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcloud.compute.disk\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcloudComputeDisk) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcloud.compute.disk].Field")
	switch name {
	case "id":
		return s.Id()
	case "name":
	...
	case "zone":
		return s.Zone()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcloud.compute.disk\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcloudComputeDisk) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.compute.disk\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.compute.disk\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlGcloudComputeDisk) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.compute.disk\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.compute.disk\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Architecture accessor autogenerated
func (s *mqlGcloudComputeDisk) Architecture() (string, error) {
	res, ok := s.Cache.Load("architecture")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.compute.disk\" failed: no value provided for static field \"architecture\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.compute.disk\" failed to cast field \"architecture\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Description accessor autogenerated
func (s *mqlGcloudComputeDisk) Description() (string, error) {
	res, ok := s.Cache.Load("description")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.compute.disk\" failed: no value provided for static field \"description\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.compute.disk\" failed to cast field \"description\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Labels accessor autogenerated
func (s *mqlGcloudComputeDisk) Labels() (map[string]interface{}, error) {
	res, ok := s.Cache.Load("labels")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.compute.disk\" failed: no value provided for static field \"labels\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(map[string]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcloud.compute.disk\" failed to cast field \"labels\" to the right type (map[string]interface{}): %#v", res)
	}
	return tres, nil
}

// LocationHint accessor autogenerated
func (s *mqlGcloudComputeDisk) LocationHint() (string, error) {
	res, ok := s.Cache.Load("locationHint")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.compute.disk\" failed: no value provided for static field \"locationHint\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.compute.disk\" failed to cast field \"locationHint\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// PhysicalBlockSizeBytes accessor autogenerated
func (s *mqlGcloudComputeDisk) PhysicalBlockSizeBytes() (int64, error) {
	res, ok := s.Cache.Load("physicalBlockSizeBytes")
	if !ok || !res.Valid {
		return 0, errors.New("\"gcloud.compute.disk\" failed: no value provided for static field \"physicalBlockSizeBytes\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	...
	if !ok {
		return 0, fmt.Errorf("\"gcloud.compute.disk\" failed to cast field \"physicalBlockSizeBytes\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// ProvisionedIops accessor autogenerated
func (s *mqlGcloudComputeDisk) ProvisionedIops() (int64, error) {
	res, ok := s.Cache.Load("provisionedIops")
	if !ok || !res.Valid {
		return 0, errors.New("\"gcloud.compute.disk\" failed: no value provided for static field \"provisionedIops\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"gcloud.compute.disk\" failed to cast field \"provisionedIops\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// SizeGb accessor autogenerated
func (s *mqlGcloudComputeDisk) SizeGb() (int64, error) {
	res, ok := s.Cache.Load("sizeGb")
	if !ok || !res.Valid {
		return 0, errors.New("\"gcloud.compute.disk\" failed: no value provided for static field \"sizeGb\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"gcloud.compute.disk\" failed to cast field \"sizeGb\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// Status accessor autogenerated
func (s *mqlGcloudComputeDisk) Status() (string, error) {
	res, ok := s.Cache.Load("status")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.compute.disk\" failed: no value provided for static field \"status\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.compute.disk\" failed to cast field \"status\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Zone accessor autogenerated
func (s *mqlGcloudComputeDisk) Zone() (GcloudComputeZone, error) {
	res, ok := s.Cache.Load("zone")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.compute.disk\" failed: no value provided for static field \"zone\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(GcloudComputeZone)
	if !ok {
		return nil, fmt.Errorf("\"gcloud.compute.disk\" failed to cast field \"zone\" to the right type (GcloudComputeZone): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcloudComputeDisk) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.compute.disk].Compute")
	switch name {
	case "id":
		return nil
	case "name":
...
// GcloudComputeZone resource interface
type GcloudComputeZone interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcloudComputeZone for the gcloud.compute.zone resource
type mqlGcloudComputeZone struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcloudComputeZone) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcloud.compute.zone resource
func newGcloudComputeZone(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcloudComputeZone{runtime.NewResource("gcloud.compute.zone")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "projectId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.zone\", its \"projectId\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.zone\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcloud.compute.zone\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcloud.compute.zone with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcloudComputeZone) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("projectId"); !ok {
		return errors.New("Initialized \"gcloud.compute.zone\" resource without a \"projectId\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"gcloud.compute.zone\" resource without a \"name\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcloudComputeZone) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.compute.zone].Register")
	switch name {
	case "projectId":
		return nil
	case "name":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcloud.compute.zone\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcloudComputeZone) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcloud.compute.zone].Field")
	switch name {
	case "projectId":
		return s.ProjectId()
	case "name":
		return s.Name()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcloud.compute.zone\" resource")
	}
}

// ProjectId accessor autogenerated
func (s *mqlGcloudComputeZone) ProjectId() (string, error) {
	res, ok := s.Cache.Load("projectId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.compute.zone\" failed: no value provided for static field \"projectId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.compute.zone\" failed to cast field \"projectId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlGcloudComputeZone) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.compute.zone\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.compute.zone\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcloudComputeZone) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.compute.zone].Compute")
	switch name {
	case "projectId":
		return nil
	case "name":
...
// GcloudBigquery resource interface
type GcloudBigquery interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcloudBigquery for the gcloud.bigquery resource
type mqlGcloudBigquery struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcloudBigquery) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcloud.bigquery resource
func newGcloudBigquery(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcloudBigquery{runtime.NewResource("gcloud.bigquery")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "datasets":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery\", its \"datasets\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcloud.bigquery with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcloudBigquery) Validate() error {
	// required arguments
	// no required fields found
...
// Register accessor autogenerated
func (s *mqlGcloudBigquery) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery].Register")
	switch name {
	case "datasets":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcloud.bigquery\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcloudBigquery) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery].Field")
	switch name {
	case "datasets":
		return s.Datasets()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcloud.bigquery\" resource")
	}
}

// Datasets accessor autogenerated
func (s *mqlGcloudBigquery) Datasets() ([]interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("datasets")
		if !ok {
			return nil, errors.New("\"gcloud.bigquery\" calculated \"datasets\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery\" failed to cast field \"datasets\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcloudBigquery) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery].Compute")
	switch name {
	case "datasets":
...
func (s *mqlGcloudBigquery) ComputeDatasets() error {
	var err error
...
// GcloudBigqueryDataset resource interface
type GcloudBigqueryDataset interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcloudBigqueryDataset for the gcloud.bigquery.dataset resource
type mqlGcloudBigqueryDataset struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcloudBigqueryDataset) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcloud.bigquery.dataset resource
func newGcloudBigqueryDataset(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcloudBigqueryDataset{runtime.NewResource("gcloud.bigquery.dataset")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.dataset\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "projectId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.dataset\", its \"projectId\" argument has the wrong type (expected type \"string\")")
			}
		case "description":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.dataset\", its \"description\" argument has the wrong type (expected type \"string\")")
			}
		case "location":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.dataset\", its \"location\" argument has the wrong type (expected type \"string\")")
			}
		case "labels":
			if _, ok := val.(map[string]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.dataset\", its \"labels\" argument has the wrong type (expected type \"map[string]interface{}\")")
			}
		case "created":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.dataset\", its \"created\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "modified":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.dataset\", its \"modified\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "tags":
			if _, ok := val.(map[string]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.dataset\", its \"tags\" argument has the wrong type (expected type \"map[string]interface{}\")")
			}
		case "defaultEncryptionConfig":
			if _, ok := val.(interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.dataset\", its \"defaultEncryptionConfig\" argument has the wrong type (expected type \"interface{}\")")
			}
		case "tables":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.dataset\", its \"tables\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "models":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.dataset\", its \"models\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "routines":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.dataset\", its \"routines\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.dataset\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcloud.bigquery.dataset with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcloudBigqueryDataset) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.dataset\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("projectId"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.dataset\" resource without a \"projectId\". This field is required.")
	}
	if _, ok := s.Cache.Load("description"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.dataset\" resource without a \"description\". This field is required.")
	}
	if _, ok := s.Cache.Load("location"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.dataset\" resource without a \"location\". This field is required.")
	}
	if _, ok := s.Cache.Load("labels"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.dataset\" resource without a \"labels\". This field is required.")
	}
	if _, ok := s.Cache.Load("created"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.dataset\" resource without a \"created\". This field is required.")
	}
	if _, ok := s.Cache.Load("modified"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.dataset\" resource without a \"modified\". This field is required.")
	}
	if _, ok := s.Cache.Load("tags"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.dataset\" resource without a \"tags\". This field is required.")
	}
	if _, ok := s.Cache.Load("defaultEncryptionConfig"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.dataset\" resource without a \"defaultEncryptionConfig\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcloudBigqueryDataset) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery.dataset].Register")
	switch name {
	case "id":
		return nil
	case "projectId":
	...
	case "routines":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcloud.bigquery.dataset\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcloudBigqueryDataset) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery.dataset].Field")
	switch name {
	case "id":
		return s.Id()
	case "projectId":
	...
	case "routines":
		return s.Routines()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcloud.bigquery.dataset\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcloudBigqueryDataset) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.dataset\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.dataset\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ProjectId accessor autogenerated
func (s *mqlGcloudBigqueryDataset) ProjectId() (string, error) {
	res, ok := s.Cache.Load("projectId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.dataset\" failed: no value provided for static field \"projectId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.dataset\" failed to cast field \"projectId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Description accessor autogenerated
func (s *mqlGcloudBigqueryDataset) Description() (string, error) {
	res, ok := s.Cache.Load("description")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.dataset\" failed: no value provided for static field \"description\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.dataset\" failed to cast field \"description\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Location accessor autogenerated
func (s *mqlGcloudBigqueryDataset) Location() (string, error) {
	res, ok := s.Cache.Load("location")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.dataset\" failed: no value provided for static field \"location\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.dataset\" failed to cast field \"location\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Labels accessor autogenerated
func (s *mqlGcloudBigqueryDataset) Labels() (map[string]interface{}, error) {
	res, ok := s.Cache.Load("labels")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.dataset\" failed: no value provided for static field \"labels\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(map[string]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.dataset\" failed to cast field \"labels\" to the right type (map[string]interface{}): %#v", res)
	}
	return tres, nil
}

// Created accessor autogenerated
func (s *mqlGcloudBigqueryDataset) Created() (*time.Time, error) {
	res, ok := s.Cache.Load("created")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.dataset\" failed: no value provided for static field \"created\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.dataset\" failed to cast field \"created\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Modified accessor autogenerated
func (s *mqlGcloudBigqueryDataset) Modified() (*time.Time, error) {
	res, ok := s.Cache.Load("modified")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.dataset\" failed: no value provided for static field \"modified\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.dataset\" failed to cast field \"modified\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Tags accessor autogenerated
func (s *mqlGcloudBigqueryDataset) Tags() (map[string]interface{}, error) {
	res, ok := s.Cache.Load("tags")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.dataset\" failed: no value provided for static field \"tags\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(map[string]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.dataset\" failed to cast field \"tags\" to the right type (map[string]interface{}): %#v", res)
	}
	return tres, nil
}

// DefaultEncryptionConfig accessor autogenerated
func (s *mqlGcloudBigqueryDataset) DefaultEncryptionConfig() (interface{}, error) {
	res, ok := s.Cache.Load("defaultEncryptionConfig")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.dataset\" failed: no value provided for static field \"defaultEncryptionConfig\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.dataset\" failed to cast field \"defaultEncryptionConfig\" to the right type (interface{}): %#v", res)
	}
	return tres, nil
}

// Tables accessor autogenerated
func (s *mqlGcloudBigqueryDataset) Tables() ([]interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("tables")
		if !ok {
			return nil, errors.New("\"gcloud.bigquery.dataset\" calculated \"tables\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.dataset\" failed to cast field \"tables\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Models accessor autogenerated
func (s *mqlGcloudBigqueryDataset) Models() ([]interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("models")
		if !ok {
			return nil, errors.New("\"gcloud.bigquery.dataset\" calculated \"models\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.dataset\" failed to cast field \"models\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Routines accessor autogenerated
func (s *mqlGcloudBigqueryDataset) Routines() ([]interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("routines")
		if !ok {
			return nil, errors.New("\"gcloud.bigquery.dataset\" calculated \"routines\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.dataset\" failed to cast field \"routines\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcloudBigqueryDataset) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery.dataset].Compute")
	switch name {
	case "id":
		return nil
	case "projectId":
...
func (s *mqlGcloudBigqueryDataset) ComputeTables() error {
	var err error
...
func (s *mqlGcloudBigqueryDataset) ComputeModels() error {
	var err error
...
func (s *mqlGcloudBigqueryDataset) ComputeRoutines() error {
	var err error
...
// GcloudBigqueryTable resource interface
type GcloudBigqueryTable interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcloudBigqueryTable for the gcloud.bigquery.table resource
type mqlGcloudBigqueryTable struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcloudBigqueryTable) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcloud.bigquery.table resource
func newGcloudBigqueryTable(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcloudBigqueryTable{runtime.NewResource("gcloud.bigquery.table")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "location":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"location\" argument has the wrong type (expected type \"string\")")
			}
		case "description":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"description\" argument has the wrong type (expected type \"string\")")
			}
		case "fullQualifiedName":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"fullQualifiedName\" argument has the wrong type (expected type \"string\")")
			}
		case "labels":
			if _, ok := val.(map[string]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"labels\" argument has the wrong type (expected type \"map[string]interface{}\")")
			}
		case "useLegacySQL":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"useLegacySQL\" argument has the wrong type (expected type \"bool\")")
			}
		case "useStandardSQL":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"useStandardSQL\" argument has the wrong type (expected type \"bool\")")
			}
		case "requirePartitionFilter":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"requirePartitionFilter\" argument has the wrong type (expected type \"bool\")")
			}
		case "created":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"created\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "modified":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"modified\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "numBytes":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"numBytes\" argument has the wrong type (expected type \"int64\")")
			}
		case "numLongTermBytes":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"numLongTermBytes\" argument has the wrong type (expected type \"int64\")")
			}
		case "numRows":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"numRows\" argument has the wrong type (expected type \"int64\")")
			}
		case "type":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"type\" argument has the wrong type (expected type \"string\")")
			}
		case "expirationTime":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"expirationTime\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.table\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcloud.bigquery.table with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcloudBigqueryTable) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("location"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"location\". This field is required.")
	}
	if _, ok := s.Cache.Load("description"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"description\". This field is required.")
	}
	if _, ok := s.Cache.Load("fullQualifiedName"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"fullQualifiedName\". This field is required.")
	}
	if _, ok := s.Cache.Load("labels"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"labels\". This field is required.")
	}
	if _, ok := s.Cache.Load("useLegacySQL"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"useLegacySQL\". This field is required.")
	}
	if _, ok := s.Cache.Load("useStandardSQL"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"useStandardSQL\". This field is required.")
	}
	if _, ok := s.Cache.Load("requirePartitionFilter"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"requirePartitionFilter\". This field is required.")
	}
	if _, ok := s.Cache.Load("created"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"created\". This field is required.")
	}
	if _, ok := s.Cache.Load("modified"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"modified\". This field is required.")
	}
	if _, ok := s.Cache.Load("numBytes"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"numBytes\". This field is required.")
	}
	if _, ok := s.Cache.Load("numLongTermBytes"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"numLongTermBytes\". This field is required.")
	}
	if _, ok := s.Cache.Load("numRows"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"numRows\". This field is required.")
	}
	if _, ok := s.Cache.Load("type"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"type\". This field is required.")
	}
	if _, ok := s.Cache.Load("expirationTime"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.table\" resource without a \"expirationTime\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcloudBigqueryTable) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery.table].Register")
	switch name {
	case "name":
		return nil
	case "location":
	...
	case "expirationTime":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcloud.bigquery.table\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcloudBigqueryTable) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery.table].Field")
	switch name {
	case "name":
		return s.Name()
	case "location":
	...
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcloud.bigquery.table\" resource")
	}
}

// Name accessor autogenerated
func (s *mqlGcloudBigqueryTable) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Location accessor autogenerated
func (s *mqlGcloudBigqueryTable) Location() (string, error) {
	res, ok := s.Cache.Load("location")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"location\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"location\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Description accessor autogenerated
func (s *mqlGcloudBigqueryTable) Description() (string, error) {
	res, ok := s.Cache.Load("description")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"description\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"description\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// FullQualifiedName accessor autogenerated
func (s *mqlGcloudBigqueryTable) FullQualifiedName() (string, error) {
	res, ok := s.Cache.Load("fullQualifiedName")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"fullQualifiedName\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"fullQualifiedName\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Labels accessor autogenerated
func (s *mqlGcloudBigqueryTable) Labels() (map[string]interface{}, error) {
	res, ok := s.Cache.Load("labels")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"labels\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(map[string]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"labels\" to the right type (map[string]interface{}): %#v", res)
	}
	return tres, nil
}

// UseLegacySQL accessor autogenerated
func (s *mqlGcloudBigqueryTable) UseLegacySQL() (bool, error) {
	res, ok := s.Cache.Load("useLegacySQL")
	if !ok || !res.Valid {
		return false, errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"useLegacySQL\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"useLegacySQL\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// UseStandardSQL accessor autogenerated
func (s *mqlGcloudBigqueryTable) UseStandardSQL() (bool, error) {
	res, ok := s.Cache.Load("useStandardSQL")
	if !ok || !res.Valid {
		return false, errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"useStandardSQL\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"useStandardSQL\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// RequirePartitionFilter accessor autogenerated
func (s *mqlGcloudBigqueryTable) RequirePartitionFilter() (bool, error) {
	res, ok := s.Cache.Load("requirePartitionFilter")
	if !ok || !res.Valid {
		return false, errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"requirePartitionFilter\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"requirePartitionFilter\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// Created accessor autogenerated
func (s *mqlGcloudBigqueryTable) Created() (*time.Time, error) {
	res, ok := s.Cache.Load("created")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"created\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"created\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Modified accessor autogenerated
func (s *mqlGcloudBigqueryTable) Modified() (*time.Time, error) {
	res, ok := s.Cache.Load("modified")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"modified\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"modified\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// NumBytes accessor autogenerated
func (s *mqlGcloudBigqueryTable) NumBytes() (int64, error) {
	res, ok := s.Cache.Load("numBytes")
	if !ok || !res.Valid {
		return 0, errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"numBytes\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"numBytes\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// NumLongTermBytes accessor autogenerated
func (s *mqlGcloudBigqueryTable) NumLongTermBytes() (int64, error) {
	res, ok := s.Cache.Load("numLongTermBytes")
	if !ok || !res.Valid {
		return 0, errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"numLongTermBytes\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"numLongTermBytes\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// NumRows accessor autogenerated
func (s *mqlGcloudBigqueryTable) NumRows() (int64, error) {
	res, ok := s.Cache.Load("numRows")
	if !ok || !res.Valid {
		return 0, errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"numRows\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"numRows\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// Type accessor autogenerated
func (s *mqlGcloudBigqueryTable) Type() (string, error) {
	res, ok := s.Cache.Load("type")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"type\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"type\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ExpirationTime accessor autogenerated
func (s *mqlGcloudBigqueryTable) ExpirationTime() (*time.Time, error) {
	res, ok := s.Cache.Load("expirationTime")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.table\" failed: no value provided for static field \"expirationTime\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.table\" failed to cast field \"expirationTime\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcloudBigqueryTable) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery.table].Compute")
	switch name {
	case "name":
		return nil
	case "location":
...
// GcloudBigqueryModel resource interface
type GcloudBigqueryModel interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcloudBigqueryModel for the gcloud.bigquery.model resource
type mqlGcloudBigqueryModel struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcloudBigqueryModel) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcloud.bigquery.model resource
func newGcloudBigqueryModel(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcloudBigqueryModel{runtime.NewResource("gcloud.bigquery.model")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.model\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "datasetId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.model\", its \"datasetId\" argument has the wrong type (expected type \"string\")")
			}
		case "projectId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.model\", its \"projectId\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.model\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "location":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.model\", its \"location\" argument has the wrong type (expected type \"string\")")
			}
		case "description":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.model\", its \"description\" argument has the wrong type (expected type \"string\")")
			}
		case "fullQualifiedName":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.model\", its \"fullQualifiedName\" argument has the wrong type (expected type \"string\")")
			}
		case "labels":
			if _, ok := val.(map[string]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.model\", its \"labels\" argument has the wrong type (expected type \"map[string]interface{}\")")
			}
		case "created":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.model\", its \"created\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "modified":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.model\", its \"modified\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "type":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.model\", its \"type\" argument has the wrong type (expected type \"string\")")
			}
		case "expirationTime":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.model\", its \"expirationTime\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.model\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcloud.bigquery.model with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcloudBigqueryModel) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.model\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("datasetId"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.model\" resource without a \"datasetId\". This field is required.")
	}
	if _, ok := s.Cache.Load("projectId"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.model\" resource without a \"projectId\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.model\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("location"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.model\" resource without a \"location\". This field is required.")
	}
	if _, ok := s.Cache.Load("description"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.model\" resource without a \"description\". This field is required.")
	}
	if _, ok := s.Cache.Load("fullQualifiedName"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.model\" resource without a \"fullQualifiedName\". This field is required.")
	}
	if _, ok := s.Cache.Load("labels"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.model\" resource without a \"labels\". This field is required.")
	}
	if _, ok := s.Cache.Load("created"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.model\" resource without a \"created\". This field is required.")
	}
	if _, ok := s.Cache.Load("modified"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.model\" resource without a \"modified\". This field is required.")
	}
	if _, ok := s.Cache.Load("type"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.model\" resource without a \"type\". This field is required.")
	}
	if _, ok := s.Cache.Load("expirationTime"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.model\" resource without a \"expirationTime\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcloudBigqueryModel) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery.model].Register")
	switch name {
	case "id":
		return nil
	case "datasetId":
	...
	case "expirationTime":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcloud.bigquery.model\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcloudBigqueryModel) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery.model].Field")
	switch name {
	case "id":
		return s.Id()
	case "datasetId":
	...
	case "expirationTime":
		return s.ExpirationTime()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcloud.bigquery.model\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcloudBigqueryModel) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.model\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.model\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// DatasetId accessor autogenerated
func (s *mqlGcloudBigqueryModel) DatasetId() (string, error) {
	res, ok := s.Cache.Load("datasetId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.model\" failed: no value provided for static field \"datasetId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.model\" failed to cast field \"datasetId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ProjectId accessor autogenerated
func (s *mqlGcloudBigqueryModel) ProjectId() (string, error) {
	res, ok := s.Cache.Load("projectId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.model\" failed: no value provided for static field \"projectId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.model\" failed to cast field \"projectId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlGcloudBigqueryModel) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.model\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.model\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Location accessor autogenerated
func (s *mqlGcloudBigqueryModel) Location() (string, error) {
	res, ok := s.Cache.Load("location")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.model\" failed: no value provided for static field \"location\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.model\" failed to cast field \"location\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Description accessor autogenerated
func (s *mqlGcloudBigqueryModel) Description() (string, error) {
	res, ok := s.Cache.Load("description")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.model\" failed: no value provided for static field \"description\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.model\" failed to cast field \"description\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// FullQualifiedName accessor autogenerated
func (s *mqlGcloudBigqueryModel) FullQualifiedName() (string, error) {
	res, ok := s.Cache.Load("fullQualifiedName")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.model\" failed: no value provided for static field \"fullQualifiedName\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.model\" failed to cast field \"fullQualifiedName\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Labels accessor autogenerated
func (s *mqlGcloudBigqueryModel) Labels() (map[string]interface{}, error) {
	res, ok := s.Cache.Load("labels")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.model\" failed: no value provided for static field \"labels\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(map[string]interface{})
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.model\" failed to cast field \"labels\" to the right type (map[string]interface{}): %#v", res)
	}
	return tres, nil
}

// Created accessor autogenerated
func (s *mqlGcloudBigqueryModel) Created() (*time.Time, error) {
	res, ok := s.Cache.Load("created")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.model\" failed: no value provided for static field \"created\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.model\" failed to cast field \"created\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Modified accessor autogenerated
func (s *mqlGcloudBigqueryModel) Modified() (*time.Time, error) {
	res, ok := s.Cache.Load("modified")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.model\" failed: no value provided for static field \"modified\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.model\" failed to cast field \"modified\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Type accessor autogenerated
func (s *mqlGcloudBigqueryModel) Type() (string, error) {
	res, ok := s.Cache.Load("type")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.model\" failed: no value provided for static field \"type\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.model\" failed to cast field \"type\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ExpirationTime accessor autogenerated
func (s *mqlGcloudBigqueryModel) ExpirationTime() (*time.Time, error) {
	res, ok := s.Cache.Load("expirationTime")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.model\" failed: no value provided for static field \"expirationTime\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.model\" failed to cast field \"expirationTime\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcloudBigqueryModel) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery.model].Compute")
	switch name {
	case "id":
		return nil
	case "datasetId":
...
// GcloudBigqueryRoutine resource interface
type GcloudBigqueryRoutine interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlGcloudBigqueryRoutine for the gcloud.bigquery.routine resource
type mqlGcloudBigqueryRoutine struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlGcloudBigqueryRoutine) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the gcloud.bigquery.routine resource
func newGcloudBigqueryRoutine(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGcloudBigqueryRoutine{runtime.NewResource("gcloud.bigquery.routine")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.routine\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "datasetId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.routine\", its \"datasetId\" argument has the wrong type (expected type \"string\")")
			}
		case "projectId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.routine\", its \"projectId\" argument has the wrong type (expected type \"string\")")
			}
		case "language":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.routine\", its \"language\" argument has the wrong type (expected type \"string\")")
			}
		case "description":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.routine\", its \"description\" argument has the wrong type (expected type \"string\")")
			}
		case "created":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.routine\", its \"created\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "modified":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.routine\", its \"modified\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "type":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.routine\", its \"type\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"gcloud.bigquery.routine\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized gcloud.bigquery.routine with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGcloudBigqueryRoutine) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.routine\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("datasetId"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.routine\" resource without a \"datasetId\". This field is required.")
	}
	if _, ok := s.Cache.Load("projectId"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.routine\" resource without a \"projectId\". This field is required.")
	}
	if _, ok := s.Cache.Load("language"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.routine\" resource without a \"language\". This field is required.")
	}
	if _, ok := s.Cache.Load("description"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.routine\" resource without a \"description\". This field is required.")
	}
	if _, ok := s.Cache.Load("created"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.routine\" resource without a \"created\". This field is required.")
	}
	if _, ok := s.Cache.Load("modified"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.routine\" resource without a \"modified\". This field is required.")
	}
	if _, ok := s.Cache.Load("type"); !ok {
		return errors.New("Initialized \"gcloud.bigquery.routine\" resource without a \"type\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGcloudBigqueryRoutine) Register(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery.routine].Register")
	switch name {
	case "id":
		return nil
	case "datasetId":
	...
	case "type":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"gcloud.bigquery.routine\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGcloudBigqueryRoutine) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery.routine].Field")
	switch name {
	case "id":
		return s.Id()
	case "datasetId":
	...
	case "type":
		return s.Type()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"gcloud.bigquery.routine\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGcloudBigqueryRoutine) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.routine\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.routine\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// DatasetId accessor autogenerated
func (s *mqlGcloudBigqueryRoutine) DatasetId() (string, error) {
	res, ok := s.Cache.Load("datasetId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.routine\" failed: no value provided for static field \"datasetId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.routine\" failed to cast field \"datasetId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ProjectId accessor autogenerated
func (s *mqlGcloudBigqueryRoutine) ProjectId() (string, error) {
	res, ok := s.Cache.Load("projectId")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.routine\" failed: no value provided for static field \"projectId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.routine\" failed to cast field \"projectId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Language accessor autogenerated
func (s *mqlGcloudBigqueryRoutine) Language() (string, error) {
	res, ok := s.Cache.Load("language")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.routine\" failed: no value provided for static field \"language\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.routine\" failed to cast field \"language\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Description accessor autogenerated
func (s *mqlGcloudBigqueryRoutine) Description() (string, error) {
	res, ok := s.Cache.Load("description")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.routine\" failed: no value provided for static field \"description\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.routine\" failed to cast field \"description\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Created accessor autogenerated
func (s *mqlGcloudBigqueryRoutine) Created() (*time.Time, error) {
	res, ok := s.Cache.Load("created")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.routine\" failed: no value provided for static field \"created\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.routine\" failed to cast field \"created\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Modified accessor autogenerated
func (s *mqlGcloudBigqueryRoutine) Modified() (*time.Time, error) {
	res, ok := s.Cache.Load("modified")
	if !ok || !res.Valid {
		return nil, errors.New("\"gcloud.bigquery.routine\" failed: no value provided for static field \"modified\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"gcloud.bigquery.routine\" failed to cast field \"modified\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Type accessor autogenerated
func (s *mqlGcloudBigqueryRoutine) Type() (string, error) {
	res, ok := s.Cache.Load("type")
	if !ok || !res.Valid {
		return "", errors.New("\"gcloud.bigquery.routine\" failed: no value provided for static field \"type\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"gcloud.bigquery.routine\" failed to cast field \"type\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGcloudBigqueryRoutine) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[gcloud.bigquery.routine].Compute")
	switch name {
	case "id":
		return nil
	case "datasetId":
