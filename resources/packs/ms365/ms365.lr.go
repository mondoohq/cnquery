...
func (s *mqlMsgraphDomaindnsrecord) Properties() (interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("properties")
		if !ok {
			return nil, errors.New("\"msgraph.domaindnsrecord\" calculated \"properties\" but didn't find its value in cache.")
		}
...
func (s *mqlMsgraphDomaindnsrecord) ComputeProperties() error {
	var err error
...
func (s *mqlMsgraphDevicemanagementDeviceconfiguration) Properties() (interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("properties")
		if !ok {
			return nil, errors.New("\"msgraph.devicemanagement.deviceconfiguration\" calculated \"properties\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "properties")
	}
	if res.Error != nil {
...
// ComputeProperties computer autogenerated
func (s *mqlMsgraphDevicemanagementDeviceconfiguration) ComputeProperties() error {
	var err error
	if _, ok := s.Cache.Load("properties"); ok {
		return nil
	}
...
func (s *mqlMsgraphDevicemanagementDevicecompliancepolicy) Properties() (interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("properties")
		if !ok {
			return nil, errors.New("\"msgraph.devicemanagement.devicecompliancepolicy\" calculated \"properties\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "properties")
	}
	if res.Error != nil {
...
// ComputeProperties computer autogenerated
func (s *mqlMsgraphDevicemanagementDevicecompliancepolicy) ComputeProperties() error {
	var err error
	if _, ok := s.Cache.Load("properties"); ok {
		return nil
	}
