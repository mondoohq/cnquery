...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("os.base.group", newOsBaseGroup)
...
// Compute accessor autogenerated
func (s *mqlOsBase) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[os.base].Compute")
	switch name {
	case "name":
		return s.ComputeName()
	case "env":
...
// OsBaseGroup resource interface
type OsBaseGroup interface {
	MqlResource() (*resources.Resource)
	Compute(string) error
	Field(string) (interface{}, error)
	Register(string) error
...
// mqlOsBaseGroup for the os.base.group resource
type mqlOsBaseGroup struct {
	*resources.Resource
}

// MqlResource to retrieve the underlying resource info
func (s *mqlOsBaseGroup) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the os.base.group resource
func newOsBaseGroup(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlOsBaseGroup{runtime.NewResource("os.base.group")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"os.base.group\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "gid":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"os.base.group\", its \"gid\" argument has the wrong type (expected type \"int64\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"os.base.group\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized os.base.group with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlOsBaseGroup) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("gid"); !ok {
		return errors.New("Initialized \"os.base.group\" resource without a \"gid\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlOsBaseGroup) Register(name string) error {
	log.Trace().Str("field", name).Msg("[os.base.group].Register")
	switch name {
	case "name":
		return nil
	case "gid":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"os.base.group\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlOsBaseGroup) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[os.base.group].Field")
	switch name {
	case "name":
		return s.Name()
	case "gid":
		return s.Gid()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"os.base.group\" resource")
	}
}

// Name accessor autogenerated
func (s *mqlOsBaseGroup) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		if err := s.ComputeName(); err != nil {
			return "", err
		...
		res, ok = s.Cache.Load("name")
		if !ok {
			return "", errors.New("\"os.base.group\" calculated \"name\" but didnt find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "name")
	}
	if res.Error != nil {
	...
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"os.base.group\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Gid accessor autogenerated
func (s *mqlOsBaseGroup) Gid() (int64, error) {
	res, ok := s.Cache.Load("gid")
	if !ok || !res.Valid {
		return 0, errors.New("\"os.base.group\" failed: no value provided for static field \"gid\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"os.base.group\" failed to cast field \"gid\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlOsBaseGroup) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[os.base.group].Compute")
	switch name {
	case "name":
		return s.ComputeName()
	case "gid":
...
// ComputeName computer autogenerated
func (s *mqlOsBaseGroup) ComputeName() error {
	var err error
	if _, ok := s.Cache.Load("name"); ok {
		return nil
	}
	...
	for name, val := range *args {
		...
		case "base":
			if _, ok := val.(OsBase); !ok {
				return nil, errors.New("Failed to initialize \"os.linux\", its \"base\" argument has the wrong type (expected type \"OsBase\")")
			}
		case "iptables":
...
func (s *mqlOsLinux) Base() (resources.ResourceType, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("base")
		if !ok {
			return nil, errors.New("\"os.linux\" calculated \"base\" but didnt find its value in cache.")
		}
	...
	if !ok {
		return nil, fmt.Errorf("\"os.linux\" failed to cast field \"base\" to the right type (OsBase): %#v", res)
	}
	return tres, nil
}
...
// Compute accessor autogenerated
func (s *mqlOsLinux) Compute(name string) error {
	log.Trace().Str("field", name).Msg("[os.linux].Compute")
	switch name {
	case "base":
...
func (s *mqlOsLinux) ComputeBase() error {
	var err error
