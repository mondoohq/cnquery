...
func newK8sNamespace(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "apiVersion":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"k8s.namespace\", its \"apiVersion\" argument has the wrong type (expected type \"string\")")
			}
		case "kind":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"k8s.namespace\", its \"kind\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
		...
		case "labels":
			if _, ok := val.(map[string]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"k8s.namespace\", its \"labels\" argument has the wrong type (expected type \"map[string]interface{}\")")
			}
		case "annotations":
			if _, ok := val.(map[string]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"k8s.namespace\", its \"annotations\" argument has the wrong type (expected type \"map[string]interface{}\")")
			}
		case "created":
...
func (s *mqlK8sNamespace) Validate() error {
	...
	if _, ok := s.Cache.Load("apiVersion"); !ok {
		return errors.New("Initialized \"k8s.namespace\" resource without a \"apiVersion\". This field is required.")
	}
	if _, ok := s.Cache.Load("kind"); !ok {
		return errors.New("Initialized \"k8s.namespace\" resource without a \"kind\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
...
func (s *mqlK8sNamespace) ApiVersion() (string, error) {
	res, ok := s.Cache.Load("apiVersion")
	if !ok || !res.Valid {
		return "", errors.New("\"k8s.namespace\" failed: no value provided for static field \"apiVersion\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"k8s.namespace\" failed to cast field \"apiVersion\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Kind accessor autogenerated
func (s *mqlK8sNamespace) Kind() (string, error) {
	res, ok := s.Cache.Load("kind")
	if !ok || !res.Valid {
		return "", errors.New("\"k8s.namespace\" failed: no value provided for static field \"kind\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"k8s.namespace\" failed to cast field \"kind\" to the right type (string): %#v", res)
	}
	return tres, nil
}
...
// Labels accessor autogenerated
func (s *mqlK8sNamespace) Labels() (map[string]interface{}, error) {
	res, ok := s.Cache.Load("labels")
	if !ok || !res.Valid {
		if err := s.ComputeLabels(); err != nil {
			return nil, err
		...
		res, ok = s.Cache.Load("labels")
		if !ok {
			return nil, errors.New("\"k8s.namespace\" calculated \"labels\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "labels")
	}
	if res.Error != nil {
	...
	tres, ok := res.Data.(map[string]interface{})
	if !ok {
		return nil, fmt.Errorf("\"k8s.namespace\" failed to cast field \"labels\" to the right type (map[string]interface{}): %#v", res)
	}
	return tres, nil
}

// Annotations accessor autogenerated
func (s *mqlK8sNamespace) Annotations() (map[string]interface{}, error) {
	res, ok := s.Cache.Load("annotations")
	if !ok || !res.Valid {
		if err := s.ComputeAnnotations(); err != nil {
			return nil, err
		...
		res, ok = s.Cache.Load("annotations")
		if !ok {
			return nil, errors.New("\"k8s.namespace\" calculated \"annotations\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "annotations")
	}
	if res.Error != nil {
	...
	tres, ok := res.Data.(map[string]interface{})
	if !ok {
		return nil, fmt.Errorf("\"k8s.namespace\" failed to cast field \"annotations\" to the right type (map[string]interface{}): %#v", res)
	}
	return tres, nil
}
...
// ComputeLabels computer autogenerated
func (s *mqlK8sNamespace) ComputeLabels() error {
	var err error
	if _, ok := s.Cache.Load("labels"); ok {
		return nil
	}
...
// ComputeAnnotations computer autogenerated
func (s *mqlK8sNamespace) ComputeAnnotations() error {
	var err error
	if _, ok := s.Cache.Load("annotations"); ok {
		return nil
	}
...
func newK8sDeployment(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "test":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"k8s.deployment\", its \"test\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
func (s *mqlK8sDeployment) Validate() error {
	...
	if _, ok := s.Cache.Load("test"); !ok {
		return errors.New("Initialized \"k8s.deployment\" resource without a \"test\". This field is required.")
	}
...
// Test accessor autogenerated
func (s *mqlK8sDeployment) Test() (string, error) {
	res, ok := s.Cache.Load("test")
	if !ok || !res.Valid {
		return "", errors.New("\"k8s.deployment\" failed: no value provided for static field \"test\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"k8s.deployment\" failed to cast field \"test\" to the right type (string): %#v", res)
	}
	return tres, nil
}
