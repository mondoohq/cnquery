...
func newOciIdentityPolicy(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "lifecycleState":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"oci.identity.policy\", its \"lifecycleState\" argument has the wrong type (expected type \"string\")")
			}
		case "statements":
			if _, ok := val.([]interface{}); !ok {
...
func (s *mqlOciIdentityPolicy) Validate() error {
	...
	if _, ok := s.Cache.Load("lifecycleState"); !ok {
		return errors.New("Initialized \"oci.identity.policy\" resource without a \"lifecycleState\". This field is required.")
	}
...
// LifecycleState accessor autogenerated
func (s *mqlOciIdentityPolicy) LifecycleState() (string, error) {
	res, ok := s.Cache.Load("lifecycleState")
	if !ok || !res.Valid {
		return "", errors.New("\"oci.identity.policy\" failed: no value provided for static field \"lifecycleState\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"oci.identity.policy\" failed to cast field \"lifecycleState\" to the right type (string): %#v", res)
	}
	return tres, nil
}
...
func newOciComputeImage(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "lifecycleState":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"oci.compute.image\", its \"lifecycleState\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
func (s *mqlOciComputeImage) Validate() error {
	...
	if _, ok := s.Cache.Load("lifecycleState"); !ok {
		return errors.New("Initialized \"oci.compute.image\" resource without a \"lifecycleState\". This field is required.")
	}
...
// LifecycleState accessor autogenerated
func (s *mqlOciComputeImage) LifecycleState() (string, error) {
	res, ok := s.Cache.Load("lifecycleState")
	if !ok || !res.Valid {
		return "", errors.New("\"oci.compute.image\" failed: no value provided for static field \"lifecycleState\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"oci.compute.image\" failed to cast field \"lifecycleState\" to the right type (string): %#v", res)
	}
	return tres, nil
}
...
func newOciNetworkVcn(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "lifecycleState":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"oci.network.vcn\", its \"lifecycleState\" argument has the wrong type (expected type \"string\")")
			}
		case "cidrBlock":
			if _, ok := val.(string); !ok {
...
func (s *mqlOciNetworkVcn) Validate() error {
	...
	if _, ok := s.Cache.Load("lifecycleState"); !ok {
		return errors.New("Initialized \"oci.network.vcn\" resource without a \"lifecycleState\". This field is required.")
	}
...
// LifecycleState accessor autogenerated
func (s *mqlOciNetworkVcn) LifecycleState() (string, error) {
	res, ok := s.Cache.Load("lifecycleState")
	if !ok || !res.Valid {
		return "", errors.New("\"oci.network.vcn\" failed: no value provided for static field \"lifecycleState\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"oci.network.vcn\" failed to cast field \"lifecycleState\" to the right type (string): %#v", res)
	}
	return tres, nil
}
...
func newOciNetworkSecurityList(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "lifecycleState":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"oci.network.securityList\", its \"lifecycleState\" argument has the wrong type (expected type \"string\")")
			}
...
func (s *mqlOciNetworkSecurityList) Validate() error {
	...
	if _, ok := s.Cache.Load("lifecycleState"); !ok {
		return errors.New("Initialized \"oci.network.securityList\" resource without a \"lifecycleState\". This field is required.")
	}
...
// LifecycleState accessor autogenerated
func (s *mqlOciNetworkSecurityList) LifecycleState() (string, error) {
	res, ok := s.Cache.Load("lifecycleState")
	if !ok || !res.Valid {
		return "", errors.New("\"oci.network.securityList\" failed: no value provided for static field \"lifecycleState\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"oci.network.securityList\" failed to cast field \"lifecycleState\" to the right type (string): %#v", res)
	}
	return tres, nil
}
