...
func TestParseAndCompare(t *testing.T) {
	cases := []struct {
		...
		// custom tests
		{"1:4.2-3.2ubuntu2", LESS, "1:4.5-1ubuntu1"},
		{"4.89-2+deb9u1", LESS, "4.89-2+deb9u3"},
		{"1.12.1+dfsg-19+deb8u5", LESS, "1.15-1+deb9u1"},
		{"2.9.4+dfsg1-2.2+deb9u1", LESS, "2.9.4+dfsg1-2.2+deb9u2"},
		{"3.16.2-5+deb9u1", GREATER, "3.8.7.1-1+deb8u3"},
		{"232-25+deb9u8", GREATER, "232-25+deb9u6"},
		{"5.24.1-3+deb9u3", LESS, "5.24.1-3+deb9u5"},
	}
...
func Test(t *testing.T) {
	...
	var p Parser
	cmp, err := p.Compare(affected, installed)
	assert.Nil(t, err)
