...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("file.context", newFileContext)
...
// FileContext resource interface
...
// MqlResource to retrieve the underlying resource info
func (s *mqlFileContext) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the file.context resource
func newFileContext(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlFileContext{runtime.NewResource("file.context")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "file":
			if _, ok := val.(File); !ok {
				return nil, errors.New("Failed to initialize \"file.context\", its \"file\" argument has the wrong type (expected type \"File\")")
			}
		case "range":
			if _, ok := val.([]byte); !ok {
				return nil, errors.New("Failed to initialize \"file.context\", its \"range\" argument has the wrong type (expected type \"[]byte\")")
			}
		case "content":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"file.context\", its \"content\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"file.context\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized file.context with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlFileContext) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("file"); !ok {
		return errors.New("Initialized \"file.context\" resource without a \"file\". This field is required.")
	}
	if _, ok := s.Cache.Load("range"); !ok {
		return errors.New("Initialized \"file.context\" resource without a \"range\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlFileContext) Register(name string) error {
	log.Trace().Str("field", name).Msg("[file.context].Register")
	switch name {
	case "file":
		return nil
	case "range":
	...
	case "content":
		...
		if err = s.MotorRuntime.WatchAndCompute(s, "range", s, "content"); err != nil {
			return err
		}
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"file.context\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlFileContext) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[file.context].Field")
	switch name {
	case "file":
		return s.File()
	case "range":
	...
	case "content":
		return s.Content()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"file.context\" resource")
	}
}

// File accessor autogenerated
func (s *mqlFileContext) File() (File, error) {
	res, ok := s.Cache.Load("file")
	if !ok || !res.Valid {
		return nil, errors.New("\"file.context\" failed: no value provided for static field \"file\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	...
	if !ok {
		return nil, fmt.Errorf("\"file.context\" failed to cast field \"file\" to the right type (File): %#v", res)
	}
	return tres, nil
}

// Range accessor autogenerated
func (s *mqlFileContext) Range() ([]byte, error) {
	res, ok := s.Cache.Load("range")
	if !ok || !res.Valid {
		return nil, errors.New("\"file.context\" failed: no value provided for static field \"range\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]byte)
	if !ok {
		return nil, fmt.Errorf("\"file.context\" failed to cast field \"range\" to the right type ([]byte): %#v", res)
	}
	return tres, nil
}

// Content accessor autogenerated
func (s *mqlFileContext) Content() (string, error) {
	res, ok := s.Cache.Load("content")
	if !ok || !res.Valid {
		return "", resources.NotReadyError{}
	}
	...
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"file.context\" failed to cast field \"content\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlFileContext) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[file.context].MqlCompute")
	switch name {
	case "file":
		return nil
	case "range":
...
// ComputeContent computer autogenerated
func (s *mqlFileContext) ComputeContent() error {
	var err error
	vargFile, err := s.File()
	if err != nil {
		if _, ok := err.(resources.NotReadyError); ok {
	...
	vres, err := s.GetContent(vargFile, vargRange)
	if _, ok := err.(resources.NotReadyError); ok {
		return err
	}
	s.Cache.Store("content", &resources.CacheEntry{Data: vres, Valid: true, Error: err, Timestamp: time.Now().Unix()})
