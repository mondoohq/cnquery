...
var TLS10_CIPHERS = map[string]string{
	...
	// We do not include the next cipher by default, because it may trigger the
	// renegotiation request. See https://datatracker.ietf.org/doc/html/rfc5746
